...
public class MrwrConfigurationImportObject extends ImportObject<MrwrConfiguration> {

    public static final String NAME = MrwrConfiguration.NAME;

    public MrwrConfigurationImportObject(MrwrConfiguration object) {
        super(object, "MRWR Configuration");
    }

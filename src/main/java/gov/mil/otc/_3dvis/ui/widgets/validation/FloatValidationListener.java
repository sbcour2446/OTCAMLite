 ...
 */
public class FloatValidationListener extends NumberValidationListener<Float, String> {
     ...
     */
    public FloatValidationListener(TextField textField, float minimumValue, float maximumValue) {
    ...
    public void onChanged(ObservableValue<? extends String> observable, String oldValue, String newValue) {
        ...
        // Try and create a number and check the ranges
            ...
            try {
                var valueOf = Float.parseFloat(newValue);

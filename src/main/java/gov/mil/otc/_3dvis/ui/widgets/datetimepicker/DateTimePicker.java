package gov.mil.otc._3dvis.ui.widgets.datetimepicker;
...
public class DateTimePicker extends DatePicker {
    ...
    private final ObjectProperty<TimeSelector> timeSelector = new SimpleObjectProperty<>(TimeSelector.SLIDER);
    private final ObjectProperty<Boolean> minutesSelector = new SimpleObjectProperty<>(TRUE);
    private final ObjectProperty<String> format = new SimpleObjectProperty<>() {
        @Override
        public void set(String newValue) {
            super.set(newValue);
            formatter = DateTimeFormatter.ofPattern(newValue);
            LocalDateTime currentValue = dateTimeValue.getValue();
            dateTimeValue.set(LocalDateTime.MIN);
            dateTimeValue.set(currentValue);
        }
    };

...
/**
 * A class that validates a text field for integer content that represents a range.
 */
public class IntegerValidationListener extends NumberValidationListener<Integer, String> {
     ...
     */
    public IntegerValidationListener(TextField textField, int minimumValue, int maximumValue) {
    ...
    /**
     * Constructor with optional listener registration.
     *
     * @param textField The text field to validate content against.
     * @param minimumValue The minimum value (inclusive) in the range of supported values.
     * @param maximumValue The maximum value (inclusive) in the range of supported values.
     * @param listener The validation state listener to register during constructor.
     */
    public IntegerValidationListener(TextField textField, int minimumValue, int maximumValue,
                                     IValidationStateListener listener) {
        this(textField, minimumValue, maximumValue);
    ...
    public void onChanged(ObservableValue<? extends String> observable, String oldValue, String newValue) {
        ...
        // Try and create a number and check the ranges
            ...
            try {
                var valueOf = Integer.parseInt(newValue);

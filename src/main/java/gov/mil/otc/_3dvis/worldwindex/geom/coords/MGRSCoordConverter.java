 ...
 */
package gov.mil.otc._3dvis.worldwindex.geom.coords;
...
/**
 * Converter used to translate MGRS coordinate strings to and from geodetic
...
/**
 * Ported to Java from the NGA GeoTrans mgrs.c and mgrs.h code. Contains
 * routines to convert from Geodetic to MGRS and the other direction.
 *
...
public class MGRSCoordConverter {
    ...
    /**
     * The function setMGRSParameters receives the ellipsoid parameters and sets
    ...
    /**
     * The function ConvertMGRSToGeodetic converts an MGRS coordinate string to
     * Geodetic (latitude and longitude) coordinates according to the current
     ...
     * its component parts. Updates last_error.
     *
     * @param MGRSString the MGRS coordinate string
     *
     * @return the corresponding <code>MGRSComponents</code> or
     * <code>null</code>.
     */
     ...
     * given, MGRS_NO_ERROR is returned. Otherwise, MGRS_NOZONE_WARNING. is
     * returned.
     *
     * @param MGRSString the MGRS coordinate string.
     *
     ...
     * for that latitude band letter. Updates min_northing.
     *
     ...
     * that latitude band letter. Updates north and south.
     *
    ...
    /**
     * The function convertMGRSToUTM converts an MGRS coordinate string to UTM
     * projection (zone, hemisphere, easting and northing) coordinates according
     * to the current ellipsoid parameters. Updates last_error if any errors
     * occured.
     *
     * @param MGRSString the MGRS coordinate string
     *
     * @return the corresponding <code>UTMComponents</code> or
     * <code>null</code>.
     */
    ...
    /* Convert_MGRS_To_UTM */
    /**
     * The function convertGeodeticToMGRS converts Geodetic (latitude and
     ...
     * returned by the function, otherwise MGRS_NO_ERROR is returned.
     *
     * @param Hemisphere Hemisphere either,
     * {@link AVKey#NORTH} or {@link
     *                   AVKey#SOUTH}.
...
//                false_northing = UPS_Constant_Table.get((int) letters[0]).false_northing;
     ...
     * the utm zone.
     * <p>
     * Key values that are set in this function include: ltr2_low_value,
     * ltr2_high_value, and false_northing.
     *
     * @param zone Zone number
     */

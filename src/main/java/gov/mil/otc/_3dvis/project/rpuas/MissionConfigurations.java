...
public class MissionConfigurations {
    ...
    private final List<DeviceInformation> deviceInformationList = new ArrayList<>();
    ...
    public DeviceInformation getDeviceInformation(String deviceId) {
        for (DeviceInformation deviceInformation : deviceInformationList) {
            if (deviceInformation.getDeviceId().equalsIgnoreCase(deviceId)) {

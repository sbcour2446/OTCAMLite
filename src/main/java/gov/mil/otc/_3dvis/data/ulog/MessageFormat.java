...
public class MessageFormat {
    ...
    public void parseNestedTypes(final Map<String, MessageFormat> messageFormats) {
        ...
        ArrayList<FieldFormat> newFields = new ArrayList<>(fields.size());
    ...
    public List<String> getFields() {
        List<String> field_names = new ArrayList<>(fields.size());
        for (FieldFormat field : fields) {
    ...
    public String toString() {
        return String.format("FORMAT: name=%s, fields=%s", name, Collections.singletonList(fields));
    }
}

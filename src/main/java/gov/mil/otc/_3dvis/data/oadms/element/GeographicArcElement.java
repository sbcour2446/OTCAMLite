...
public class GeographicArcElement {

    public static final String ELEMENT_NAME = "geographicArc";
    private static final String ARC_ANGLE = "arcAngle";
    private static final String CENTERLINE = "centerline";
    private static final String RADIUS = "radius";

    public static GeographicArcElement parse(Node node) {
        ...
        if (arcAngle != null && centerline != null && position != null && radius != null) {
            return new GeographicArcElement(arcAngle, centerline, position, radius);
        }
        return null;
    }
    ...
    private GeographicArcElement(double arcAngle, double centerline, Position position, double radius) {

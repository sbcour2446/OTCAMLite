...
/**
 * Implementation of Battle Position graphics. This class implements the
 * following graphics:
 * <ul> <li>Battle Position (2.X.2.4.3.1)</li> <li>Battle Position, Prepared But
 * Not Occupied (2.X.2.4.3.1.1)</li>
 * </ul>
 * <p>
 * The Echelon label (field B) will be placed between the first and second
 * control points.
 *
 * @author pabercrombie
...
public class BattlePosition extends BasicArea {
     ...
     * Prepared but not Occupied area.
     */
    ...
    /**
     * {@inheritDoc} Overridden to determine the position of the echelon label
     * as well as the identity labels.
     */
    @Override

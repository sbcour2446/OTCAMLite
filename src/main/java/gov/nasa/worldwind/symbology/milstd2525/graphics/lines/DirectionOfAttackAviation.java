 ...
 *
 * @author pabercrombie
 * @version $Id: DirectionOfAttackAviation.java 545 2012-04-24 22:29:21Z
 * pabercrombie $
 */
public class DirectionOfAttackAviation extends DirectionOfAttack {
    ...
    /**
     * Default length of the bow tie part of the graphic, as a fraction of the
     * graphic's total length.
     */
    public final static double DEFAULT_BOW_TIE_LENGTH = 0.05;
    /**
     * Default width of the bow tie part of the graphic, as a fraction of the
     * length of the bow tie.
     */
    ...
    /**
     * Length of the bow tie part of the graphic, as a fraction of the graphic's
     * total length.
     */
    protected double bowTieLength = DEFAULT_BOW_TIE_LENGTH;
    /**
     * Width of the bow tie part of the graphic, as a fraction of the length of
     * the bow tie.
     */
    protected double bowTieWidth = DEFAULT_BOW_TIE_WIDTH;
    /**
     * Angle that controls the curve of the line. A large angle results in a
     * more pronounced curve. An angle of zero results in a straight line.
     */
     ...
     * More intervals results in a smoother curve.
     *
     ...
     * More intervals will result in a smoother looking curve.
     *
    ...
    /**
     * Indicates the length of the bow tie part of the graphic, as a fraction of
     * the graphic's total length.
     *
     * @return Length of the bow tie as a fraction of the total length of the
     * graphic.
     */
    ...
    /**
     * Specifies the length of the bow tie part of the graphic, as a fraction of
     * the graphic's total length.
     *
     * @param bowTieLength Length of the bow tie as a fraction of the total
    ...
    /**
     * Indicates the width of the bow tie part of the graphic, as a fraction of
     * the length of the bow tie.
     *
    ...
    /**
     * Specifies the width of the bow tie part of the graphic, as a fraction of
     * the length of the bow tie.
     *
     * @param bowTieWidth Width of the bow tie as a fraction of the length of
     * the bow tie.
     */
    ...
    /**
     * Indicates the angle that determines the curvature of the line. A large
     * angle results in a more pronounced curve. An angle of zero results in a
     * straight line.
     *
    ...
    /**
     * Specifies the angle that determines the curvature of the line. A large
     * angle results in a more pronounced curve. An angle of zero results in a
     * straight line.
     *
    ...
    /**
     * Compute a point along a Hermite curve defined by two control point and
     * tangent vectors at those points.
     * <p>
     * This function implements the Hermite curve equation from "Mathematics for
     * 3D Game Programming and Computer Graphics, Second Edition" by Eric
     * Lengyel (equation 15.15, pg. 457).
     * <p>
     * H(t) = (1 - 3t<sup>2</sup> + 2t<sup>3</sup>)P<sub>1</sub> +
     * t<sup>2</sup>(3 - 2t)P<sub>2</sub> + t(t - 1)<sup>2</sup>T<sub>1</sub> +
     * t<sup>2</sup>(t - 1)T<sub>2</sub>
     *

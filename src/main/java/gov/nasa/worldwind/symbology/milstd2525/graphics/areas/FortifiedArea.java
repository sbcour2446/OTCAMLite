...
public class FortifiedArea extends BasicArea {
     ...
     * positions necessary to draw the square wave.
     */
    protected List<Position> computedPositions;

    /**
     * Indicates the wavelength of the square wave that forms the graphic's
     * border.
     */
    ...
    /**
     * Indicates the wavelength of the square wave that forms the graphic's
     * boundary. This is the length from the start of one square "tooth" to the
     * start of the next.
     * <pre>
     *    __    __
     * __|  |__|  |__
    ...
    /**
     * Specifies the wavelength of the square wave that forms the graphic's
    ...
    /**
     * Generate the positions required to draw the polygon with a square wave
     * boundary.
     *

 ...
 *
 * @author pabercrombie
 * @version $Id: AbstractMilStd2525TacticalGraphic.java 1171 2013-02-11
 * 21:45:02Z dcollins $
 */
public abstract class AbstractMilStd2525TacticalGraphic extends AbstractTacticalGraphic
    ...
    /**
     * Factor applied to the stipple pattern used to draw graphics in present
     * state.
     */
    protected static final int OUTLINE_STIPPLE_FACTOR_PRESENT = 0;
    /**
     * Factor applied to the stipple pattern used to draw graphics in
     * anticipated state.
     */
    ...
    /**
     * Indicates whether or not the graphic must display the hostile/enemy
     * indicator, if the graphic supports the indicator.
     *
     * @return true if {@link #isShowHostileIndicator()} is true, and the
     * graphic represents a hostile entity.
     */
    ...
    /**
     * Indicates the factor applied to the stipple pattern used to draw dashed
     * lines when the graphic is "anticipated". This value is not used when the
     * graphic is "present".
     *
    ...
    /**
     * Indicates the stipple pattern used to draw dashed lines when the graphic
     * is "anticipated".
     *
     * @return Factor applied to the stipple pattern.
     *
     ...
     *
     * @return The default material, determined by the graphic's standard
     * identity.
     */

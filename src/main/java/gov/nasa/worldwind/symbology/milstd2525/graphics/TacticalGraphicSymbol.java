...
/**
 * Implementation of TacticalSymbol to render point graphics defined by
 * MIL-STD-2525C Appendix B (Tactical Graphics). This class implements the logic
 * for rendering tactical point graphics, but actually implements the
 * TacticalSymbol interface.
 * <p>
 * This class is not meant to be used directly by applications. Instead, apps
 * should use {@link MilStd2525PointGraphic}, which implements the
 * {@link TacticalGraphic} interface. (MilStd2525PointGraphic uses
 * TacticalGraphicSymbol internally to render the point graphic.)
 *
 * @author pabercrombie
...
public class TacticalGraphicSymbol extends AbstractTacticalSymbol {
    ...
    /**
     * Object that provides the default offset for each point graphic. Most
     * graphics are centered on their position, but some require a different
     * offset.
     */
     ...
     * identifier depends on the symbol set to which this graphic belongs. For
    ...
    /**
     * Symbol identifier with fields that do not influence the type of graphic
     * replaced with hyphens. See {@link
    ...
    /**
     * Indicates the current value of graphic's Status/Operational Condition
     * field.
     *
    ...
    /**
     * Specifies this graphic's Status/Operational Condition field. A graphic's
     ...
     * Additionally, a graphic's Status can define its operational condition.
     * The recognized values depend on the graphic's scheme:
     * <p>
    ...
    //////////////////////////////////////////////
    /**
     * Add a hyphen to the first element in a list of dates to indicate a date
     * range. This method only modifiers the date list if exactly two dates are
     * displayed in the graphic.
     *
     * @param value Iterable of date modifiers.
     * @param offsets Layouts for the date modifiers.
     *
     * @return Iterable of modified dates. This may be a new, modified list, or
     * the same list as {@code value} if no modification was required.
     */
    ...
    /**
     * Indicates whether or not this graphic supports the direction of movement
     * indicator. Only chemical, biological, radiological, and nuclear point
     * graphics support this modifier (see MIL-STD-2525C, table XI, pg. 38).
     *
     * @return True if the graphic is chemical, biological, radiological, or
     * nuclear.
     */

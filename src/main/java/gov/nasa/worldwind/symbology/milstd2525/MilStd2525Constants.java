...
public interface MilStd2525Constants {
    ...
    /**
     * The default location that MIL-STD-2525 tactical symbols and tactical
     * point graphics retrieve their icons from:
    ...
    /**
     * Default material used to color tactical graphics that represent friendly
     * entities.
     */
    Material MATERIAL_FRIEND = Material.BLACK;
    /**
     * Default material used to color tactical graphics that represent hostile
     * entities.
     */
    Material MATERIAL_HOSTILE = new Material(new Color(255, 48, 49));
    /**
     * Default material used to color tactical graphics that represent neutral
     * entities.
     */
    Material MATERIAL_NEUTRAL = new Material(new Color(0, 226, 0));
    /**
     * Default material used to color tactical graphics that represent unknown
     * entities.
     */
    Material MATERIAL_UNKNOWN = new Material(new Color(255, 255, 0));
    /**
     * Default material used to color tactical graphics that represent
     * obstacles.
     */

...
/**
 * Implementation of the irregular Fire Support area graphics. This class
 * implements the following graphics:
 * <ul> <li>Area Target (2.X.4.3.1)</li> <li>Bomb (2.X.4.3.1.5)</li>
 * <li>Airspace Coordination Area (ACA), Irregular (2.X.4.3.2.2.1)</li> <li>Free
 * Fire Area (FFA), Irregular (2.X.4.3.2.3.1)</li> <li>Restrictive Fire Area
 * (RFA), Irregular (2.X.4.3.2.5.1)</li> <li>Terminally Guided Munitions
 * Footprint</li> <li>Sensor Zone, Irregular</li>
 * <li>Dead Space Area, Irregular</li> <li>Zone of Responsibility,
 * Irregular</li> <li>Target Build-up Area, Irregular</li> <li>Target Value
 * Area, Irregular</li> <li>Artillery Target Intelligence Zone, Irregular (
 * 2.X.4.3.3.1.1)</li> <li>Call For Fire Zone, Irregular (2.X.4.3.3.2.1)</li>
 * <li>Censor Zone, Irregular (2.X.4.3.3.4.1)</li> <li>Critical Friendly Zone,
 * Irregular (2.X.4.3.3.6.1)</li> </ul>
 *
 * @author pabercrombie
 * @version $Id: IrregularFireSupportArea.java 1171 2013-02-11 21:45:02Z
 * dcollins $
 */
public class IrregularFireSupportArea extends BasicArea {
    ...
    /**
     * Indicates the function IDs of rectangular Fire Support area graphics that
     * display a date/time range as a separate label at the left side of the
     * rectangle. Whether or not a graphic supports this is determined by the
     * graphic's template in MIL-STD-2525C.
     *
     * @return A Set containing the function IDs of graphics that support a
     * date/time label separate from the graphic's main label.
     */
    ...
    /**
     * Determine the position of the time range label. This label is placed at
     * the North-West corner of the polygon.
     *
     * @param dc Current draw context.
     *
     * @return Position for the time range label, or null if the position cannot
     * be determined.
     */
     ...
     *
     * @return Alignment for the main label. One of AVKey.CENTER, AVKey.LEFT, or
     * AVKey.RIGHT.
     */
    @Override
    ...
    /**
     * Indicates whether or not the polygon must be filled with a diagonal line
     * pattern.
     *

...
/**
 * Implementation of the aviation route graphics. This class implements the
 * following graphics: <ul> <li>Air Corridor (2.X.2.2.2.1)</li> <li>Minimum Risk
 * Route (2.X.2.2.2.2)</li> <li>Standard Flight Route (2.X.2.2.2.3)</li>
 * <li>Unmanned Aircraft Route (2.X.2.2.2.4)</li> <li>Low Level Transit Route
 * (2.X.2.2.2.5)</li> </ul>
 *
 * @author pabercrombie
...
public class Route extends AbstractMilStd2525TacticalGraphic implements TacticalRoute, PreRenderable {
     ...
     *
     * @return If the SymbologyConstants.DISTANCE modifier set, and is a Double,
     * returns the value of this modifier. Otherwise returns a default width.
     */
    ...
    /**
     * Specifies the width of the route. Calling this method is equivalent to
     * calling <code>setModifier(SymbologyConstants.DISTANCE, value)</code>.
     *
     ...
     *
     * @return The string the determines the type of route, such as "AC" for
     * "Air Corridor".
     */
    ...
    /**
     * Compute the position for the area's main label. This position indicates
     * the position of the first line of the label. If there are more lines,
     * they will be arranged South of the first line. This method places the
     * label between the first to control points on the route, and to the side
     * of the route.
     *
     * @param dc Current draw context.
     */
    ...
    /**
     * Compute the position of the graphic's main label. This label is
     * positioned to the side of the first segment along the route.
     *
     * @param dc Current draw context.

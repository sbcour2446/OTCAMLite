...
/**
 * Implementation of circular Fire Support graphics. This class implements the
 * following graphics:
 * <ul> <li>Circular Target (2.X.4.3.1.2)</li> <li>Fire Support Area, Circular
 * (2.X.4.3.2.1.3)</li> <li>Free Fire Area (FFA), Circular (2.X.4.3.2.3.3)</li>
 * <li>Restrictive Fire Area (RFA), Circular (2.X.4.3.2.5.3)</li> <li>Airspace
 * Coordination Area (ACA), Circular (2.X.4.3.2.2.3)</li> <li>Sensor Zone,
 * Circular</li> <li>Dead Space Area, Circular</li> <li>Zone of Responsibility,
 * Circular</li> <li>Target Build-up Area, Circular</li> <li>Target Value Area,
 * Circular</li> </ul>
 *
 * @author pabercrombie
...
public class CircularFireSupportArea extends AbstractCircularGraphic {
    ...
    /**
     * Indicates the function IDs of circular Fire Support area graphics that
     * display a date/time range as a separate label at the left side of the
     * circle. Whether or not a graphic supports this is determined by the

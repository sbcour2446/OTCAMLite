...
/**
 * Implementation of TacticalSymbol that renders a symbol inside a pentagon, for
 * the Limited Access Area graphic.
 *
 * @author pabercrombie
...
public class LimitedAccessSymbol extends AbstractTacticalSymbol {
    ...
    static class IconRetriever extends MilStd2525IconRetriever {
         ...
         * exists and is of type java.awt.Color. Returns null if the parameter
         * list is null, if there is no value for key AVKey.COLOR, or if the
        ...
        /**
         * Indicates the color to apply to a graphic based on the graphic's
         * standard identity.
         *
         * @param code Symbol code that identifies the graphic.
         *
         * @return Color to apply based on the standard identity. (Red for
         * hostile entities, black for friendly, etc.)
         */

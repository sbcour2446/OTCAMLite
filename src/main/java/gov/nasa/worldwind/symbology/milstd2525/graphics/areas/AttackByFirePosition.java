...
public class AttackByFirePosition extends AbstractMilStd2525TacticalGraphic {
     ...
     *
     * @return The length of the legs of the base, as a fraction of the distance
     * between the control points that define the base.
     */
     ...
     *
     * @param legLength Length of the legs of the graphic's base, as a fraction
    ...
    /**
     * Determine the positions that make up the base of the graphic (a trapezoid
     * missing one side).
     *
     * @param dc Current draw context.
     ...
     * @param orientationPos A point on the arrow head side of the graphic. The
     * legs of the base will point away from this position.
     *

...
/**
 * Implementation of rectangular Fire Support graphics. This class implements
 * the following graphics:
 * <ul> <li>Free Fire Area (FFA), Rectangular (2.X.4.3.2.3.2)</li>
 * <li>Restrictive Fire Area (RFA), Rectangular (2.X.4.3.2.5.2)</li>
 * <li>Airspace Coordination Area (ACA), Rectangular (2.X.4.3.2.2.2)</li>
 * <li>Sensor Zone, Rectangular</li> <li>Dead Space Area, Rectangular</li>
 * <li>Zone of Responsibility, Rectangular</li> <li>Target Build-up Area</li>
 * <li>Target Value Area, Rectangular</li> <li>Artillery Target Intelligence
 * Zone, Rectangular (2.X.4.3.3.1.2)</li> <li>Call For Fire Zone, Rectangular
 * (2.X.4.3.3.2.2)</li> <li>Censor Zone, Rectangular (2.X.4.3.3.4.2)</li>
 * <li>Critical Friendly Zone, Rectangular (2.X.4.3.3.6.2)</li> </ul>
 *
 * @author pabercrombie
 * @version $Id: RectangularFireSupportArea.java 1171 2013-02-11 21:45:02Z
 * dcollins $
 */

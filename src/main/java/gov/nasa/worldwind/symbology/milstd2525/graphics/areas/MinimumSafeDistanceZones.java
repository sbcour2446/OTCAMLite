...
/**
 * Implementation of the Minimum Safe Distance Zone graphic (2.X.3.4.1). This
 * graphic requires four control points. The first point defines the center of
 * the circle, and the other three define the radius of the rings. See the
 * graphic template in MIL-STD-2525C, pg. 613. Note that MIL-STD-2525C numbers
 * the radius points as points one, two, and three, but does not assign a number
 * to the center point. This implementation requires the center point to be the
 * first point in the list.
 *
 * @author pabercrombie
 * @version $Id: MinimumSafeDistanceZones.java 1171 2013-02-11 21:45:02Z
 * dcollins $
 */
public class MinimumSafeDistanceZones extends AbstractMilStd2525TacticalGraphic implements PreRenderable {

    /**
     * Default angle used to position the graphic's labels. This default angle
     * (60 degrees) is chosen to match the graphic template defined by
     * MIL-STD-2525C, pg. 613.
     */
    ...
    /**
     * Position the labels along a line radiating out from the center of the
     * circle at this angle from North.
     */
    ...
    /**
     * Indicates the angle used to position this graphic's labels. The labels
     * are positioned along a line radiating out from the center of the circle,
     * and at this bearing from North.
     *
    ...
    /**
     * Specifies the angle used to position this graphic's labels. The labels
     * are positioned along a line radiating out from the center of the circle,
     * and at this bearing from North.
     *

 ...
 * The offset is used to align a point on the graphic with the graphic's
 * geographic position. This class automatically populates the map with values
 ...
 * @see
 * gov.nasa.worldwind.symbology.AbstractTacticalSymbol#setOffset(gov.nasa.worldwind.render.Offset)
 */
public class DefaultOffsets {
    ...
    /**
     * Offset to align a point 25% up from the bottom edge with the geographic
     * position.
     */
    ...
    /**
     * Offset for the Antitank Mine with Anti-handling Device graphic
     * (2.X.3.1.5.3).
     */

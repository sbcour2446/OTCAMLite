...
/**
 * Implementation of General Command/Special area graphics. This class
 * implements the following graphics:
 * <ul> <li>Area of Operations (2.X.2.6.2.1)</li> <li>Named Area of Interest
 * (2.X.2.6.2.4)</li> <li>Targeted Area of Interest (2.X.2.6.2.5)</li> </ul>
 *
 * @author pabercrombie

...
/**
 * Implementation of the Forward Edge of Battle Area (FEBA) graphic
 * (2.X.2.4.2.1).
 *
 * @author pabercrombie
...
public class ForwardEdgeOfBattleArea extends AbstractMilStd2525TacticalGraphic {
    ...
    /**
     * Implementation of TacticalSymbol to draw a symbol at the end of a FEBA
     * line.
     */
    protected static class FEBASymbol extends AbstractTacticalSymbol {
        ...
        /**
         * Specifies whether the text ("FEBA") will be drawn on the left or
         * right side of the symbol.
         *
         * @param align AVKey.LEFT or AVKey.RIGHT. An alignment of AVKey.LEFT
         * indicates that the left edge of the text aligns with the graphic
         * (which puts the text on the right side of the circle). If the
         * alignment is any value other than AVKey.LEFT or AVKey.RIGHT the
         * alignment is assumed to be AVKey.RIGHT.
         */
        ...
        /**
         * Specifies this graphic's Status/Operational Condition field. A
         * graphic's Status defines whether the represented object exists at the
         * time the symbol was generated, or is anticipated to exist in the
         * future. Additionally, a graphic's Status can define its operational
         * condition. The recognized values are <ul>
         * <li>STATUS_ANTICIPATED</li> <li>STATUS_SUSPECTED</li>
         * <li>STATUS_PRESENT</li> <li>STATUS_KNOWN</li> </ul>.
         *
         * @param status the new value for the Status/Operational Condition
         * field.
         *

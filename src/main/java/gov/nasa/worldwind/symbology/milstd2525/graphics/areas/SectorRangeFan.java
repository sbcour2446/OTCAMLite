 ...
 * The range fans are defined by a center position, list of radii, and list of
 * left and right azimuths. If no azimuths are specified, the fans will be drawn
 * as full circles.
 *
 * @author pabercrombie
...
public class SectorRangeFan extends AbstractMilStd2525TacticalGraphic implements PreRenderable {
    ...
    /**
     * Default length of the Center Of Sector line, as a fraction of the final
     * range fan radius.
     */
    public final static double DEFAULT_CENTER_OF_SECTOR_LENGTH = 1.2;
    /**
     * Default length of the arrowhead, as a fraction of the Center Of Sector
     * line length.
     */
    ...
    /**
     * Azimuth labels are placed to the side of the line that they label. This
     * value specifies a percentage that is multiplied by the maximum radius in
     * the range fan to compute a distance for this offset.
     */
    ...
    /**
     * Length of the arrowhead from base to tip, as a fraction of the Center Of
     * Sector line length.
     */
    ...
    /**
     * Length of the Center Of Sector line, as a fraction of the last range fan
     * radius.
     */
    ...
    /**
     * Azimuths of the range fans. The azimuths are specified in pairs, first
     * the left azimuth, then the right azimuth.
     */
     ...
     *
     * @param arrowAngle The angle of the arrowhead. Must be greater than zero
     ...
     *
     * @return The length of the arrowhead as a fraction of the total line
     * length.
     */
     ...
     *
     * @param arrowLength Length of the arrowhead as a fraction of the total
     * line length. If the arrowhead length is 0.25, then the arrowhead length
     * will be one quarter of the total line length.
     */
     ...
     *
     * @return The length of the Center Of Sector as a fraction of the final
     * range fan radius.
     */
     ...
     *
     * @param centerOfSectorLength Length of the Center Of Sector arrow as a
     * fraction of the final range fan radius.
     */
     ...
     * More intervals will result in a smoother looking arc.
     *
    ...
    /**
     * Indicates the number format applied to azimuth values to create the
     * azimuth labels.
     *
    ...
    /**
     * Specifies the number format applied to azimuth values to create the
     * azimuth labels.
     *
    ...
    /**
     * Indicates the number format applied to radius values to create the radius
     * labels.
     *
    ...
    /**
     * Specifies the number format applied to radius values to create the radius
     * labels.
     *
     ...
     * {@inheritDoc}
     *
     * @param positions Control points. This graphic uses only one control
     * point, which determines the center of the circle.
     */
     ...
     *
     * @return List of radii, in meters. This method never returns null. If
     * there are no rings this returns an empty list.
     */
     ...
     *
     * @param radii List of radii, in meters. A circle will be created for each
     * radius.
     */
    ...
    /**
     * Indicates the left and right azimuths of the fans in this graphic. The
     * list contains pairs of azimuths, first left and then right.
     *
     * @return Left and right azimuths, measured clockwise from North. This
     * method never returns null. If there are no azimuths, returns an empty
     * list.
     */
     ...
     * The provided iterable must specify pairs of azimuths: first left azimuth,
     * first right azimuth, second left, second right, etc.
     *
    ...
    /**
     * Indicates the altitudes of the rings that make up the range fan. Note
     * that the range fan is always drawn on the surface. The altitude strings
     * are displayed as text.
     *
     * @return List of altitude strings. This method never returns null. If
     * there are no altitudes, returns an empty list.
     */
    ...
    /**
     * Specifies the altitudes of the rings that make up the range fan. Note
     * that the range fan is always drawn on the surface. The altitude strings
     * are displayed as text.
     *
     ...
     *
     * @return The identifier of a symbol drawn at the center of the range fan.
     * May be null.
     */
    ...
    /**
     * Specifies a symbol to draw at the center of the range fan. Equivalent to
     * setting the {@link
     * SymbologyConstants#SYMBOL_INDICATOR} modifier. The symbol's position will
     * be changed to match the range fan center position.
     *
     * @param sidc The identifier of a MIL-STD-2525C tactical symbol to draw at
     * the center of the range fan. May be null to indicate that no symbol is
     * drawn.
     */
    ...
    /**
     * Create shapes to draw the Center Of Sector arrow. This arrow bisects the
     * final range fan.
     *
     * @param dc Current draw context.
     ...
     * is computed as the average of the left and right azimuths of the last
     * range fan in the graphic. MIL-STD-2525C does not specify how this angle
     * should be computed, but the graphic template (pg. 693) suggests that the
     * Center Of Sector line should bisect the last range fan arc.
     *
     * @param finalLeftAzimuth Left azimuth of the last range fan in the
     * graphic.
     * @param finalRightAzimuth Right azimuth of the last range fan in the
     * graphic.
     *
    ...
    /**
     * Create positions to draw an arc around the graphic's center position. The
     * arc is described by a radius, left azimuth, and right azimuth. The arc
     * positions are added onto an existing list of positions, in left to right
     * order (the arc draws from the left azimuth to the right azimuth).
     * <p>
     * If the left and right azimuths are equal, then this methods adds a single
     * position to the list at the desired azimuth and radius.
     *
     * @param dc Current draw context.
    ...
    /**
     * Compute an angular offset to apply to a azimuth label. This angle will be
     * added to the azimuth of the label's azimuth in order to place the label a
     * little bit to the side of the line that it applies to.
     *
     * @param radius Radius at which the label will be placed.
     * @param maxRadius Maximum radius in the range fan.
     *
     * @return Angle, in radians, to add to the range fan azimuth in order to
    ...
    /**
     * Determine the position of a range label for a ring in the range fan. The
     * method finds a point to either the left or right of the center line,
     * depending on which has more space for the label.
     *
    ...
    /**
     * Create and configure a SurfacePolygon to render the arrow head on the
     * sector center line.
     *

...
/**
 * Implementation of Linear Target graphics. This class implements the following
 * graphics:
 * <ul> <li>Linear Target (2.X.4.2.1)</li> <li>Linear Smoke Target
 * (2.X.4.2.1.1)</li> <li>Final Protective Fire (FPF) (2.X.4.2.1.2)</li> </ul>
 *
 * @author pabercrombie
...
public class LinearTarget extends AbstractMilStd2525TacticalGraphic {
     ...
     * {@link SymbologyConstants#UNIQUE_DESIGNATION} (additional text is the
     * second value in the iterable).
     */
     ...
     *
     * @return The length of the vertical segments as a fraction of the
     * horizontal segment.
     */
     ...
     *
     * @param length Length of the vertical segments as a fraction of the
     * horizontal segment. If the vertical length is 0.25, then the vertical
     * segments will be one quarter of the horizontal segment length.
     */
     ...
     * @param basePoint Point at which the vertical segment must meet the
     * horizontal segment.

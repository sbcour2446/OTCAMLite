 ...
 *
 * @author pabercrombie
 * @version $Id: AbstractRectangularGraphic.java 1171 2013-02-11 21:45:02Z
 * dcollins $
 */
public class AbstractRectangularGraphic extends AbstractMilStd2525TacticalGraphic implements TacticalQuad, PreRenderable {
     ...
     * {@inheritDoc}
     *
     * @param positions Control points. This graphic uses only two control
     * point, which determine the midpoints of two opposite sides of the quad.
     * See Fire Support Area (2.X.4.3.2.1.2) on pg. 652 of MIL-STD-2525C for an
     * example of how these points are interpreted.
     */

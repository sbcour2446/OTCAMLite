...
/**
 * SIDC constants for graphics in the "Tactical Graphics" scheme (MIL-STD-2525C
 * Appendix B). The constants in this interface are "masked" SIDCs. All fields
 * except Scheme, Category, and Function ID are filled with hyphens. (The other

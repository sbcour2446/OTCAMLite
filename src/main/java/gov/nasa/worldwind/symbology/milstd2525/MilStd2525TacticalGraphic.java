 ...
 * <a href="http://www.assistdocs.com/search/document_details.cfm?ident_number=114934">MIL-STD-2525</a>.
 ...
 * <p>
 * The following table lists the modifiers supported by 2525 graphics. Note that
 * not all graphics support all modifiers.
 * <table> <caption style="font-weight: bold;">2525 Graphics
 * Modifiers</caption><tr><th>Field</th><th>Modifier key</th><th>Data
 * type</th><th>Description</th></tr>
 * <tr><td>A</td><td>SymbologyConstants.SYMBOL</td><td>String</td><td>SIDC for a
 * MIL-STD-2525 Tactical Symbol</td></tr>
 ...
 * <tr><td>H</td><td>SymbologyConstants.ADDITIONAL_INFO</td><td>String</td><td>Additional
 * information</td></tr>
 * <tr><td>Q</td><td>SymbologyConstants.DIRECTION_OF_MOVEMENT</td><td>{@link gov.nasa.worldwind.geom.Angle}</td><td>Direction
 * indicator</td></tr>
 * <tr><td>T</td><td>SymbologyConstants.UNIQUE_DESIGNATION</td><td>String</td><td>Unique
 * designation</td></tr>
 * <tr><td>V</td><td>SymbologyConstants.TYPE</td><td>String</td><td>Type</td></tr>
 ...
 * <tr><td>AM</td><td>SymbologyConstants.DISTANCE</td><td>Double</td><td>Radius,
 * length or width of rectangle.</td></tr>
 * <tr><td>AN</td><td>SymbologyConstants.AZIMUTH</td><td>Angle</td><td>Azimuth</td></tr>
 * </table>
 * <p>
 ...
 * </pre>
 * <p>
 * Some graphics support multiple instances of a modifier. For example, 2525
 * uses the field code W for a date/time modifier. Some graphics support
 * multiple timestamps, in which case the fields are labeled W, W1, W2, etc. An
 * application can pass an {@link Iterable} to <code>setModifier</code> if
 * multiple values are required to specify the modifier. Here's an example of
 * how to specify two timestamps:
 * <pre>
 * String startDate = ...
 * String endData = ...
 *
 ...
 *
 * @author pabercrombie
 * @version $Id: MilStd2525TacticalGraphic.java 555 2012-04-25 18:59:29Z
 * pabercrombie $
 */

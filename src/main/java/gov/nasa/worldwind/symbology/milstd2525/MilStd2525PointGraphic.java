...
/**
 * Implementation of MIL-STD-2525 point graphics. Point graphics are rendered in
 * the same way as tactical symbols: by drawing an icon at constant screen size.
 *
 * @author pabercrombie
 * @version $Id: MilStd2525PointGraphic.java 560 2012-04-26 16:28:24Z
 * pabercrombie $
 */
public class MilStd2525PointGraphic extends AVListImpl implements MilStd2525TacticalGraphic, TacticalPoint, Draggable {
    ...
    /**
     * Indicates whether the object is draggable and provides additional
     * information for dragging about this object.
     */
    ...
    /**
     * Specifies this graphic's altitude mode. Altitude mode defines how the
     * altitude component of this symbol's position is interpreted. Recognized
     * modes are: <ul> <li>WorldWind.CLAMP_TO_GROUND -- this graphic is placed
     * on the terrain at the latitude and longitude of its position.</li>
     * <li>WorldWind.RELATIVE_TO_GROUND -- this graphic is placed above the
     * terrain at the latitude and longitude of its position and the distance
     * specified by its elevation.</li> <li>WorldWind.ABSOLUTE -- this graphic
     * is placed at its specified position.</li> </ul>
     * <p>
     * This graphic assumes the altitude mode WorldWind.ABSOLUTE if the
     * specified mode is not recognized.
     *
     ...
     *
     * @param graphicAttributes Tactical graphic attributes to apply to the
     * tactical symbol.
    ...
    /**
     * Indicates the graphics in MIL-STD-2525C Appendix B supported by this
     * class.
     *
     * @return List of masked SIDC strings that identify graphics that this
     * class supports.

...
/**
 * Icon retriever to retriever modifiers (for example, the Feint/Dummy
 * indicator) for the symbols in the MIL-STD-2525C symbol set.
 *
 * @author dcollins
 * @version $Id: MilStd2525ModifierRetriever.java 1171 2013-02-11 21:45:02Z
 * dcollins $
 */
public class MilStd2525ModifierRetriever extends AbstractIconRetriever {
     ...
     *
     * @param symbolId Identifier for the modifier. This identifier is fields 11
     * and 12 of a MIL-STD-2525C SIDC (see MIL-STD-2525C Table A-I, pg. 51).
     ...
     * the modifier (default is black).
     *
     * @return BufferedImage containing the requested modifier, or null if the
     * modifier cannot be retrieved.
     */
    ...
    /**
     * Indicates whether or not color must be applied to the modifier. Color is
     * applied to all modifiers except for alternate Operational Condition
     * modifiers, which have their own color.
     *

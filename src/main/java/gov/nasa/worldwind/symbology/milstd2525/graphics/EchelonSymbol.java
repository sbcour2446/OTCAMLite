...
/**
 * Tactical symbol implementation to render the echelon modifier as part of a
 * tactical graphic.
 *
 * @author pabercrombie
...
public class EchelonSymbol extends AbstractTacticalSymbol {
     ...
     *
     * @throws IllegalArgumentException if {@code sidc} is null, or does not
     * contain a value for the Echelon field.
     */

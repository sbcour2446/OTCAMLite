...
public class InfiltrationLane extends AbstractMilStd2525TacticalGraphic {
    ...
    /**
     * Determine the point along a Bezier curve that is closest to a line
     * segment.
     *
     ...
     * @param tolerance Numerical tolerance. Smaller values will yield a more
     * accurate answer, but will take more iterations to compute.
     *
     * @return the point on the curve that is closest to the specified line
     * segment.
     */
     ...
     * that looks like the Infiltration Lane graphic in MIL-STD-2525C (pg. 526).
     *
     * @param dc Current draw context.
     * @param start Beginning of the infiltration lane control line.
     * @param end End of the infiltration lane control line.
     * @param numControlPoints Number of control points to generate. More
     * control points result in more "wiggles" in the line.

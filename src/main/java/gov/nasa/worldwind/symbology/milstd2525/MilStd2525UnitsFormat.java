...
/**
 * Units format configured to format locations and altitudes according to the
 * defaults defined by MIL-STD-2525C.
 *
 * @author pabercrombie
 * @version $Id: MilStd2525UnitsFormat.java 482 2012-03-27 01:27:15Z
 * pabercrombie $
 */
public class MilStd2525UnitsFormat extends UnitsFormat {
     ...
     * kilometers and angles in degrees, minutes, seconds.
     */
     ...
     * and angles in degrees, minutes, seconds.
     *
    ...
    /**
     * Format a latitude value. If this format is configured to show degrees,
     * minutes, and seconds then the returned string will use the format
     * "DDMMSS.S".
     *
    ...
    /**
     * Format a longitude value. If this format is configured to show degrees,
     * minutes, and seconds then the returned string will use the format
     * "DDDMMSS.S".
     *
     * @param angle the angle to format.

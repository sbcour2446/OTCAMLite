...
/**
 * Implementation of {@link gov.nasa.worldwind.symbology.TacticalSymbol} that
 * provides support for tactical symbols from the
 * <a href="https://en.wikipedia.org/wiki/NATO_Joint_Military_Symbology#MIL-STD-2525A">MIL-STD-2525</a>
 * symbology set. See the
 ...
 *
 * @author dcollins
 * @version $Id: MilStd2525TacticalSymbol.java 2196 2014-08-06 19:42:15Z
 * tgaskins $
 */
public class MilStd2525TacticalSymbol extends AbstractTacticalSymbol {
     ...
     * 15-character alphanumeric symbol identification code (SIDC). Calculated
     * from the current modifiers at construction and during each call to
     * {@link #setModifier(String, Object)}. Initially <code>null</code>.
     */
    ...
    /**
     * Constructs a tactical symbol for the MIL-STD-2525 symbology set with the
     * specified symbol identifier and position. This constructor does not
     * accept any supplemental modifiers, so the symbol contains only the
     * attributes specified by its symbol identifier. This constructor does not
     * accept any icon retrieval path, so the created symbol retrieves its icons
     * from the default location.
     * <p>
     * The symbolId specifies the tactical symbol's appearance. The symbolId
     * must be a 15-character alphanumeric symbol identification code (SIDC).
     * The symbol's shape, fill color, outline color, and icon are all defined
     * by the symbol identifier. Use the '-' character to specify null entries
     * in the symbol identifier.
     * <p>
     * The position specifies the latitude, longitude, and altitude where the
     * symbol is drawn on the globe. The position's altitude component is
     * interpreted according to the altitudeMode.
     *
     * @param symbolId a 15-character alphanumeric symbol identification code
     * (SIDC).
     * @param position the latitude, longitude, and altitude where the symbol is
     * drawn.
     *
     * @throws IllegalArgumentException if either the symbolId or the position
     * are <code>null</code>, or if the symbolId is not a valid 15-character
    ...
    /**
     * Constructs a tactical symbol for the MIL-STD-2525 symbology set with the
     * specified symbol identifier, position, and list of modifiers. This
     * constructor does not accept any icon retrieval path, so the created
     ...
     * The position specifies the latitude, longitude, and altitude where the
     * symbol is drawn on the globe. The position's altitude component is
     * interpreted according to this symbol's altitudeMode.
     * <p>
     * The modifiers specify supplemental graphic and text attributes as
     * key-value pairs. See the MilStd2525TacticalSymbol class documentation for
     * the list of recognized modifiers. In the case where both the symbol
     * identifier and the modifiers list specify the same attribute, the
     * modifiers list has priority.
     *
     * @param symbolId a 15-character alphanumeric symbol identification code
     * (SIDC).
     * @param position the latitude, longitude, and altitude where the symbol is
     * drawn.
     * @param modifiers an optional list of key-value pairs specifying the
     * symbol's modifiers. May be <code>null</code> to specify that the symbol
     * contains only the attributes in its symbol identifier.
     *
     * @throws IllegalArgumentException if either the symbolId or the position
     * are <code>null</code>, or if the symbolId is not a valid 15-character
     * alphanumeric symbol identification code (SIDC).
    ...
    /**
     * Indicates the current value of symbol's Status/Operational Condition
     * field.
     *
    ...
    /**
     * Specifies this symbol's Status/Operational Condition field. A symbol's
     * Status defines whether the represented object exists at the time the
     * symbol was generated, or is anticipated to exist in the future.
     * Additionally, a symbol's Status can define its operational condition. The
     ...
     * <code>null</code> or is not one of the accepted status values.
     */
    ...
    /**
     * Indicates whether this symbol draws its frame. See
     * {@link #setShowFrame(boolean)} for a description of how this property is
     * used.
     *
     * @return <code>true</code> if this symbol draws its frame, otherwise
     * <code>false</code>.
     */
    ...
    /**
     * Specifies whether to draw this symbol's frame. The showFrame property
     * provides control over this tactical symbol's display option hierarchy as
     * defined by MIL-STD-2525C, section 5.4.5 and table III.
     * <p>
     * When <code>true</code>, this symbol's frame is drawn. This state
     * corresponds to MIL-STD-2525C, table III, row 1.
     * <p>
     * When <code>false</code>, this symbol's frame is not drawn. Instead, only
     * the symbol's internal icon is drawn. This state corresponds to
     * MIL-STD-2525C, table III, row 4.
     *
     * @param showFrame <code>true</code> to draw this symbol's frame, otherwise
     * <code>false</code>.
     */
    ...
    /**
     * Indicates whether this symbol draws its fill. See
     * {@link #setShowFill(boolean)} for a description of how this property is
     * used.
     *
     * @return <code>true</code> if this symbol draws its fill, otherwise
     * <code>false</code>.
     */
    ...
    /**
     * Specifies whether to draw this symbol's fill. The showFill property
     * provides control over this tactical symbol's display option hierarchy as
     * defined by MIL-STD-2525C, section 5.4.5 and table III.
     * <p>
     * When <code>true</code>, this symbol's fill is drawn. This state
     * corresponds to MIL-STD-2525C, table III, row 1.
     * <p>
     * When <code>false</code>, this symbol's fill is not drawn. Instead, only
     * the symbol's frame and internal icon are drawn. This state corresponds to
     * MIL-STD-2525C, table III, row 2.
     *
     * @param showFill <code>true</code> to draw this symbol's fill, otherwise
     * <code>false</code>.
     */
    ...
    /**
     * Indicates whether this symbol draws its internal icon. See
     * {@link #setShowIcon(boolean)} for a description of how this property is
     * used.
     *
     * @return <code>true</code> if this symbol draws its icon, otherwise
     * <code>false</code>.
     */
    ...
    /**
     * Specifies whether to draw this symbol's internal icon. The showIcon
     * property provides control over this tactical symbol's display option
     * hierarchy as defined by MIL-STD-2525C, section 5.4.5 and table III.
     * <p>
     * When <code>true</code>, this symbol's icon is drawn. This state
     * corresponds to MIL-STD-2525C, table III, row 1.
     * <p>
     * When <code>false</code>, this symbol's icon is not drawn. Instead, only
     * the symbol's frame and fill are drawn. This state corresponds to
     * MIL-STD-2525C, table III, row 5.
     *
     * @param showIcon <code>true</code> to draw this symbol's icon, otherwise
     * <code>false</code>.
     */
    ...
    /**
     * Indicates whether or not the symbol should be displayed using the
     * alternate Operational Condition indicator described in MIL-STD-2525C spec
     * Table III-2, pg. 19. The alternate display is always used for symbols in
     * the Emergency Management scheme (see MIL-STD-2525C // spec section
     * G.5.5.14, pg. 1030). It is be used for other symbols if the
     * SymbologyConstants.OPERATIONAL_CONDITION_ALTERNATE modifier is set.
     *
     * @param modifiers Symbol modifiers.
     *
     * @return True if the symbol must use the alternate operational condition
     * indicator.
     */

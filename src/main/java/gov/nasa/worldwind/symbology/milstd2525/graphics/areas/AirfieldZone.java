...
/**
 * Implementation of the Airfield Zone graphic (hierarchy 2.X.2.1.3.11, SIDC:
 * G*GPGAZ---****X).
 *
 * @author pabercrombie
...
public class AirfieldZone extends BasicArea {
    ...
    /**
     * Configure a path in the airfield graphic. Paths are configured to follow
     * terrain and clamp to the ground.
     *

...
public class Ambush extends AbstractMilStd2525TacticalGraphic {
    ...
    /**
     * Default angle of the arc. Control points 2 and 3 define a chord of a
     * circle. This chord and the arc angle fully define the circle, of which
     * the arc is a segment.
     */
    ...
    /**
     * Default length of the legs of the graphic's base, as a fraction of the
     * distance between the control points the define the base.
     */
    ...
    /**
     * Length of the legs on the graphic's base, as a fraction of the distance
     * between the control points that define the base.
     */
    ...
    /**
     * Data required for intermediate calculations while generating the Ambush
     * graphic. This object is created and populated by
     * {@link Ambush#computeArc(gov.nasa.worldwind.render.DrawContext)}.
     */
    protected static class ArcData {
        ...
        Angle startAngle;
        /**
         * Angular length of the arc. Note that this is different than
         * {@link Ambush#arcAngle}: this angle is signed, where as
         * Ambush.arcAngle is unsigned. This angle is calculated such that the
         * end angle of the arc is equal to
         * {@code arcData.arcAngle + arcData.startAngle}.
         */
        Angle arcAngle;
        /**
         * Direction of the arc. This vector points from the center of the
         * circle to the midpoint of the arc.
         */
        Vec4 direction;
    }
    ...
    /**
     * Indicates the angle of this graphic's arc. The arc is drawn as a segment
     * of a circle defined by this angle and the chord formed by control points
     * 2 and 3.
     *
    ...
    /**
     * Specifies the angle of this graphic's arc. The arc is drawn as a segment
     * of a circle defined by this angle and the chord formed by control points
     * 2 and 3. A greater angle makes the arc more curved and a smaller angle
     * makes the arc less curved.
     *
     * @param arcAngle Angle of the circular segment that forms this graphic's
     * arc.
     */
    ...
    /**
     * Indicates how many "legs" stick out of the back side of this graphic's
     * arc.
     *
    ...
    /**
     * Specifies how many "legs" stick out of the back side of this graphic's
     * arc.
     *
     ...
     *
     * @return The length of the legs on the base, as a fraction of the distance
     * between the control points that define the base.
     */
     ...
     *
     * @param legLength Length of the legs on the graphic's base, as a fraction
     * of the distance between the control points that define the base.
     */
    ...
    /**
     * Compute the arc. The arc is a segment of a circle defined by a chord and
     * the arc angle. Control points 2 and 3 define the chord.
     *
     * @param dc Current draw context.
     *
    ...
    /**
     * Create paths for the graphic's "legs". The legs stick out of the back
     * side of the arc.
     *
     * @param dc Current draw context.
     * @param arcData Data that describes the graphic's arc.
     * @param paths Array to receive the new paths.
     * @param startIndex Index into {@code paths} at which to place the first
     * leg path.
     * @param pathCount Number of leg paths to create. The {@code paths} array
     * must have length of at least {@code

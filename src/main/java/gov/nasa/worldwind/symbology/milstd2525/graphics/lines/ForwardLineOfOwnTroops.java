 ...
 *
 * @author pabercrombie
 * @version $Id: ForwardLineOfOwnTroops.java 545 2012-04-24 22:29:21Z
 * pabercrombie $
 */
public class ForwardLineOfOwnTroops extends PhaseLine {
    ...
    /**
     * Indicates wave length (in meters) of the semicircle wave along the
     * graphic boundary.
     */
    ...
    /**
     * Indicates the wavelength of the semicircle wave that forms the graphic's
     * boundary. This is the length from the start of one "tooth" to the start
     * of the next. If not wave length is specified a default wave length will
     * be computed.
     * <pre>
     * /\/\/\/\/\
     * ^ ^
    ...
    protected static class PositionIterator implements Iterator<Position> {
         ...
         * @param interval Generate positions along the control line at this
         * interval.

...
/**
 * Implementation of the Dummy graphic (hierarchy 2.X.2.3.1, SIDC:
 * G*GPPD----****X).
 *
 * @author pabercrombie
...
public class Dummy extends AbstractMilStd2525TacticalGraphic {
     ...
     * {@inheritDoc}
     * <p>
     * The dummy graphic requires exactly three control points. Any positions
     * beyond the first three will be ignored.
     *
     * @throws IllegalArgumentException if less than three control points are
     * provided.
     */

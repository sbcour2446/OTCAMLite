...
/**
 * SIDC constants for graphics in the "Emergency Management" scheme
 * (MIL-STD-2525C Appendix G). The constants in this interface are "masked"
 ...
 * graphic.)
 * <p>
 * Note: this interface only defines constants for tactical graphics in Appendix
 * G.
 *
 * @author pabercrombie
 * @version $Id$

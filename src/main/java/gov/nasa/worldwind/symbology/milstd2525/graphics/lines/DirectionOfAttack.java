 ...
 * <ul> <li>Direction of Main Attack graphic (2.X.2.5.2.2.2.1)</li>
 * <li>Direction of Supporting Attack graphic (2.X.2.5.2.2.2.2)</li> </ul>
 *
 * @author pabercrombie
...
public class DirectionOfAttack extends AbstractMilStd2525TacticalGraphic {
    ...
    /**
     * Indicates the width of the arrowhead when it is drawn outlined. Note that
     * the arrowhead is only drawn outlined when the graphic represents a Main
     * Direction of Attack.
     *
    ...
    /**
     * Specifies the width of the the arrowhead when it is drawn outlined. Note
     * that the arrowhead is only drawn outlined when the graphic represents a
     * Main Direction of Attack.
     *
     * @param outlineWidth Width of the outline as a fraction of the length of
     * the arrowhead.
     */

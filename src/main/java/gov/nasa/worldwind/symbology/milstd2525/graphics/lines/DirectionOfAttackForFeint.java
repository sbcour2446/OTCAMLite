 ...
 *
 * @author pabercrombie
 * @version $Id: DirectionOfAttackForFeint.java 545 2012-04-24 22:29:21Z
 * pabercrombie $
 */
public class DirectionOfAttackForFeint extends DirectionOfAttack {

    /**
     * Offset applied to the label. This offset aligns the bottom edge of the
     * label with the geographic position, in order to keep the label above the
     * graphic as the zoom changes.
     */
    ...
    /**
     * Factor used to compute the distance between the solid and dashed lines in
     * the arrow head. A larger value will move the dashed line farther from the
     * solid line.
     */
    ...
    /**
     * Factor that controls the curve of the line. Valid values are 0 to 1.
     * Larger values result in a more pronounced curve.
     */
    ...
    /**
     * Orientation position for the label. (The label is drawn on a line between
     * this position and {@link
     * #labelPosition}.
     */
     ...
     *
     * @param intervals Number of intervals for drawing the curve. Must at least
     * three.
     */
    ...
    /**
     * Indicates a factor that determines the curvature of the line. Valid
     * values are zero to one. A large value results in a more pronounced curve.
     *
    ...
    /**
     * Specifies a factor that determines the curvature of the line. Valid
     * values are zero to one. A large value results in a more pronounced curve.
     *
    ...
    /**
     * Compute the position of control points that will generate a Bezier curve
     * that looks like the Direction of Attack for Feint graphic in
     * MIL-STD-2525C (pg. 499).
     *
     * @param dc Current draw context.
     * @param start Beginning of the infiltration lane control line.
     * @param end End of the infiltration lane control line.
     * @param curvature Factor that controls the curvature of the line. Valid
     * values are between zero and one. A higher value results in a more
     * pronounced curve.
     *
     * @return Control points for a Bezier curve. The first control point is
     * equal to {@code start}, and the last point is equal to {@code end}.
     */

...
/**
 * Implementation of the Dose Rate Contour Line graphic (2.X.3.4.9). The graphic
 * consists of a polygon defined by three or more points, and a text label. The
 * label is placed at over the first control point.
 *
 * @author pabercrombie

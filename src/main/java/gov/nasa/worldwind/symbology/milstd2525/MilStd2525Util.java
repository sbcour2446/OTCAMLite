...
public class MilStd2525Util {
    ...
    /**
     * Compute screen points required to draw a leader line on a tactical
     * symbol. This method returns two points that will draw a line out from the
    ...
    /**
     * Compute screen points required to draw a leader line on a tactical ground
     * symbol. This method returns three points that will draw a line down from
     * the base of the symbol and then out in the direction of movement.
     *
     * @param dc Current draw context.
     * @param symbolPoint Symbol position in model coordinates.
     * @param heading Direction of movement, as a bearing clockwise from North.
     ...
     * @param length Length of the leader line, in pixels. The computed vector
     * will have magnitude equal to this distance in pixels multiplied by the
     * size of a pixel (in meters) at the position of the symbol relative to the
     * current view.
     *
    ...
    /**
     * Determines a default color to apply to a symbol. MIL-STD-2525C section
     * 5.5.1.1 (pg. 37) states that obstacles should be displayed in green,
     * friendly entities in black or blue, and hostile entities in red. This
     * method return green for obstacles and neutral entities, black for
     * friendly entities, red for hostile entities, and yellow for unknown and
     * pending entities.
     *
    ...
    /**
     * Indicates whether or not a symbol code identifiers an Obstacle. Obstacles
     * defined in the Mobility and Survivability category of MIL-STD-2525C
     * Appendix B.
     *

...
/**
 * Implementation of Fire Support line graphics. This class implements the
 * following graphics:
 * <ul> <li>Fire Support Coordination Line (2.X.4.2.2.1)</li> <li>Coordinated
 * Fire Line (2.X.4.2.2.2)</li>
...
public class FireSupportLine extends AbstractMilStd2525TacticalGraphic {
    ...
    /**
     * Factor applied to the stipple pattern used to draw the dashed line for a
     * Coordinated Fire Line.
     */
    protected static final int CFL_OUTLINE_STIPPLE_FACTOR = 12;

    /**
     * Offset applied to the graphic's upper label. This offset aligns the
     * bottom edge of the label with the geographic position, in order to keep
     * the label above the graphic as the zoom changes.
     */
    protected final static Offset TOP_LABEL_OFFSET = Offset.fromFraction(0.0, 0.1);
    /**
     * Offset applied to the graphic's lower label. This offset aligns the top
     * edge of the label with the geographic position, in order to keep the
     * label above the graphic as the zoom changes.
     */
    protected final static Offset BOTTOM_LABEL_OFFSET = Offset.fromFraction(0.0, -1.1);

    /**
     * The value of an optional second text string for the graphic. This value
     * is equivalent to the "T1" modifier defined by MIL-STD-2525C. It can be
     * set using {@link #setAdditionalText(String)}, or by passing an Iterable
     * to {@link #setModifier(String, Object)} with a key of
     * {@link gov.nasa.worldwind.symbology.SymbologyConstants#UNIQUE_DESIGNATION}
    ...
    /**
     * Indicates an additional text identification for this graphic. This value
     * is equivalent to the "T1" modifier in MIL-STD-2525C (a second Unique
    ...
    /**
     * Indicates an additional text identification for this graphic. Setting
     * this value is equivalent to setting the "T1" modifier in MIL-STD-2525C (a
     * second Unique Designation modifier).
     *
    ...
    /**
     * Indicates whether or not the graphic includes double pairs of top and
     * bottom labels. The Final Support Coordination Line (FSCL) and Restrictive
     * Fire Lines (RFL) include double labels, but the Coordination Fire Line
     * (CFL) does not.
     *
     * @return true if the graphic includes two pairs of top/bottom labels. Both
     * pairs contain the same text content.
     */
     ...
     *
     * @return Text for the bottom label. May return null if there is no bottom
     * label.
     */
    ...
    /**
     * Compute the length of the path, and determine the start and end
     * positions.
     *
     * @param dc Current draw context.
     *
     * @return Returns the path's start position, end position, and length
     * (non-terrain following) as a three element array: [Position start,
     * Position end, Double length].
     */
    ...
    /**
     * {@inheritDoc} Overridden to draw Coordinated Fire Line with dashed
     * pattern.
     */
    @Override

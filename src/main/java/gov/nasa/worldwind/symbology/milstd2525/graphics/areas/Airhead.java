...
public class Airhead extends BasicArea {
    ...
    /**
     * Default offset to apply to the label. The default aligns the top center
     * of the label with the label's geographic position, in order to keep the
     * text South of the area.
     */

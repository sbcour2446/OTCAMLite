...
/**
 * Implementation of the Limited Access Area graphic (2.X.2.1.3.10). This
 * graphic draws a symbol inside of a pentagon. The graphic requires at least
 * one control point, which specifies the position of the vertex of the
 * pentagon. If a second control point is provided, then a line will be drawn
 * from the vertex of the pentagon to this point. Note that the
 * {@link SymbologyConstants#SYMBOL_INDICATOR} modifier must be set or the
 * pentagon will not be rendered.
 *
 * @author pabercrombie
...
public class LimitedAccessArea extends AbstractMilStd2525TacticalGraphic {
     ...
     *
     * @param sidc Identifier for a MIL-STD-2525C symbol to draw at the center
     * of the range fan. May be null to indicate that no symbol is drawn.
     */
    ...
    /**
     * Indicates this graphic's altitude mode. See {@link #setAltitudeMode(int)}
     ...
     * altitude component of this graphic's position is interpreted. Recognized

...
/**
 * Implementation of the Airborne graphic (hierarchy 2.X.2.5.2.1.2, SIDC:
 * G*GPOLAA--****X).
 *
 * @author pabercrombie
...
public class Airborne extends Aviation {
     ...
     * Equivalent to setting the {@link
     * SymbologyConstants#SYMBOL_INDICATOR} modifier. The symbol's position will
     * be set to a position between the first two control points of the Airborne
     * arrow.
     *
     * @param sidc The identifier of a symbol in the MIL-STD-2525C symbology
     * set, or null to indicate that no symbol will be drawn.
     */
    ...
    /**
     * Compute the position of the symbol drawn between the first two control
     * points.
     *

...
/**
 * Implementation of the Aviation offensive graphic (hierarchy 2.X.2.5.2.1.1,
 * SIDC: G*GPOLAV--****X).
 *
 * @author pabercrombie
...
public class Aviation extends AbstractAxisArrow {
    ...
    /**
     * Create a new Aviation graphic, composed of more than one path. This
     * constructor is for use by subclasses that extend the base Aviation
     * graphic by adding additional paths.
     *
     * @param sidc Symbol code the identifies the graphic.

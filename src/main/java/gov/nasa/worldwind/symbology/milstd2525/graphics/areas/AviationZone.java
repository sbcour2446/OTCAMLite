...
/**
 * Implementation of aviation area graphics. This class implements the following
 * graphics:
 * <ul> <li>Restricted Operations Zone (2.X.2.2.3.1)</li> <li>Short Range Air
 * Defense Engagement Zone (2.X.2.2.3.2)</li>
 * <li>High Density Airspace Control Zone (2.X.2.2.3.3)</li> <li>Missile
 * Engagement Zone (2.X.2.2.3.4)</li> <li>Low Altitude Missile Engagement Zone
 * (2.X.2.2.3.4.1)</li> <li>High Altitude Missile Engagement Zone
 * (2.X.2.2.3.4.2)</li>
 * </ul>
 *
 * @author pabercrombie
...
public class AviationZone extends BasicArea {
     ...
     *
     * @param includeAltitude Indicates whether to include altitude information
     * in the label (if the SymbologyConstants.ALTITUDE_DEPTH modifier is set).
     * Not all aviation area graphics support the altitude modifier.
     *

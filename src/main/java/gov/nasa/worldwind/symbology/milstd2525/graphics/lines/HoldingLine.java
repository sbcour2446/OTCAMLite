 ...
 * <ul> <li>Holding Line (2.X.2.6.1.2)</li> <li>Bridgehead (2.X.2.6.1.4)</li>
 * </ul>
 * <p>
 * Note: These graphics require three control points. The first two points
 * define the end points of the graphic, and the third point defines the top of
 * an arc that connects the endpoints. The specification for Holding Line and
 * Bridgehead (MIL-STD-2525C pgs 538 and 540) states that "Additional points can
 * be defined to extend the line". However, the specification is unclear as to
 * how additional control points should be interpreted. This implementation
 * ignores additional control points.
 *
 * @author pabercrombie
...
public class HoldingLine extends AbstractMilStd2525TacticalGraphic {
    ...
    /**
     * Scale factor that determines the curvature of the corners of the arc.
     * Valid values are zero to one, where zero produced square corners.
     */
    ...
    /**
     * Indicates a factor that controls the curvatures of the arcs in this
     * graphic.
     *
    ...
    /**
     * Specifies a factor that determines the curvature of the arcs in this
     * graphic. Valid values are zero to one, where zero creates square corners
     * and one creates extremely rounded corners.
     *
     ...
     * @param distance Distance from the vertex at which the arc should begin
     * and end.

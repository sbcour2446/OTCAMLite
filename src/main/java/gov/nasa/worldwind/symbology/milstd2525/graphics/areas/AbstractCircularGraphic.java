...
public abstract class AbstractCircularGraphic extends AbstractMilStd2525TacticalGraphic
    ...
    /**
     * Invoked when the position or radius of the circle changes. This
     * implementation does nothing, but subclasses can override to invalid state
     * when the graphic is changed.
     */
    ...
    /**
     * {@inheritDoc} Overridden to apply the delegate owner to shapes used to
     * draw the circle.
     */
    @Override

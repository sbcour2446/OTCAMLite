...
/**
 * SIDC constants for graphics in the "Meteorological and Oceanographic" scheme
 * (MIL-STD-2525C Appendix C). The constants in this interface are "masked"
 * SIDCs. All fields except Scheme, Category, and Function ID are filled with
 * hyphens. (The other fields do not identity a type of graphic, they modify the
 * graphic.)
 *
 * @author pabercrombie
...
//    final String AMPHC_STOG_WOSMIC_SUFDRY = "WAS-GND-NCP----";
    ...
    /**
     * Compact or wet snow (with or without ice) covering less than one-half of
     * ground.
     */
    final String AMPHC_STOG_WSMIC_CWSNLH = "WAS-GSSCL-P----";
    /**
     * Compact or wet snow (with or without ice) covering at least one-half
    ...
    /**
     * Loose dry snow covering at least one-half ground, but ground not
     * completely covered.
     */

 ...
 *
 * @author dcollins
 * @version $Id: BasicTacticalSymbolAttributes.java 1171 2013-02-11 21:45:02Z
 * dcollins $
 */
public class BasicTacticalSymbolAttributes implements TacticalSymbolAttributes {
     ...
     * <code>null</code> to use the symbol's default scale. Initially
     * <code>null</code>.
     */
    protected Double scale;
    /**
     * Indicates the material used to draw the symbol's interior, or
     * <code>null</code> to use the symbol's default interior material.
     * Initially <code>null</code>.
     */
    protected Material interiorMaterial;
    /**
     * Indicates the symbol opacity as a floating point number between 0.0 and
     * 1.0 (inclusive), or <code>null</code> to use the symbol's default scale.
     * Initially <code>null</code>.
     */
    protected Double opacity;
    /**
     * Indicates the font used to draw text modifiers, or <code>null</code> to
     * use the symbol's default scale. Initially <code>null</code>.
     */
    protected Font textModifierFont;
    /**
     * Indicates the material used to draw text modifiers, or <code>null</code>
     * to use the symbol's default scale. Initially <code>null</code>.
     */
    ...
    /**
     * Constructs a BasicTacticalSymbolAttributes with the specified scale,
     * interior material, opacity, text modifier font, and text modifier
     * material. The scale specifies the symbol scale as a ratio of the symbol's
     * original size, the opacity specifies the symbol opacity as a floating
     * point number between 0.0 and 1.0 (inclusive). The specified scale must be
     * either <code>null</code> or greater than or equal to 0.0, and the opacity
     * must either <code>null</code> or a value between 0.0 and 1.0 (inclusive).
     * The textModifierFont and textModifierMaterial specify the font and
     ...
     * @param interiorMaterial the interior material. May be <code>null</code>,
     ...
     * @param textModifierFont the text modifier font. May be <code>null</code>,
     * indicating that the default font should be used.
     * @param textModifierMaterial the text modifier material. May be
     * <code>null</code>, indicating that the default material should be used.
     *
     * @throws IllegalArgumentException if the scale is less than 0.0, or if the
     * opacity is less than 0.0 or greater than 1.0.
     */

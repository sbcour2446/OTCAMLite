 ...
 * defines an Air Control Route that is composed of Air Control Points. The
 * route is composed of many tactical graphics, but it is treated as a single
 * graphic. If the route is highlighted all of the control points will also
 * highlight, if the route is set invisible all the control points will be set
 * invisible, etc.
 *
 * @author pabercrombie
 * @version $Id: TacticalRoute.java 1171 2013-02-11 21:45:02Z dcollins $
 * @see TacticalGraphicFactory#createRoute(String, Iterable,

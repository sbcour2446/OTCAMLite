 ...
 * for instructions on using TacticalGraphic in an application. This base class
 * provides functionality for creating and rendering a graphic that is made up
 * of one or more shapes, and text labels.
 * <p>
 ...
 *
 * @author pabercrombie
 * @version $Id: AbstractTacticalGraphic.java 560 2012-04-26 16:28:24Z
 * pabercrombie $
 */
public abstract class AbstractTacticalGraphic extends AVListImpl implements TacticalGraphic, Renderable, Draggable {
    ...
    /**
     * Opacity of label interiors. This value is multiplied by the label text
     * opacity to determine the final interior opacity.
     */
    protected static final double DEFAULT_LABEL_INTERIOR_OPACITY = 0.7;

    /**
     * The graphic's text string. This field corresponds to the
     * {@link SymbologyConstants#UNIQUE_DESIGNATION} modifier. Note that this
     * field is not used if an Iterable is specified as the unique designation.
     */
    ...
    /**
     * Provides additional information for dragging regarding this particular
     * object.
     */
    ...
    /**
     * Indicates whether or not to render the hostile/enemy modifier. This
     * modifier is displayed by default.
     */
    ...
    /**
     * Attributes to apply when the graphic is not highlighted. These attributes
     * override defaults determined by the graphic's symbol code.
     */
    protected TacticalGraphicAttributes normalAttributes;
    /**
     * Attributes to apply when the graphic is highlighted. These attributes
     * override defaults determined by the graphic's symbol code.
     */
    ...
    /**
     * Map of modifiers applied to this graphic. Note that implementations may
     * not store all modifiers in this map. Some modifiers may be handled
     * specially.
     */
    ...
    /**
     * Shape attributes shared by all shapes that make up this graphic. The
     * graphic's active attributes are copied into this attribute bundle on each
     * frame.
     */
    protected ShapeAttributes activeShapeAttributes = new BasicShapeAttributes();

    /**
     * Flag to indicate that labels must be recreated before the graphic is
     * rendered.
     */
    ...
    /**
     * Invoked each frame to apply to the current delegate owner to all
     * renderable objects used to draw the graphic. This base class will apply
     * the delegate owner to Label objects. Subclasses must implement this
     * method to apply the delegate owner to any Renderables that they will draw
     * in order to render the graphic.
     *
    ...
    /**
     * Determine geometry and attributes for this frame. This method only
     * determines attributes the first time that it is called for each frame.
     * Multiple calls in the same frame will have no effect.
     *
     * @param dc Current draw context.
     */
    ...
    /**
     * Render the graphic modifiers. This base class does not render anything,
     * but subclasses may override this method to draw graphic modifiers.
     *
     * @param dc Current draw context.
     */
    ...
    /**
     * Invoked when a modifier is changed. This implementation marks the label
     * text as invalid causing it to be recreated based on the new modifiers.
     */
    ...
    /**
     * Determine the delegate owner for the current frame, and apply the owner
     * to all renderable objects used to draw the graphic.
     */
     ...
     *
     * @return Delegate owner, if specified, or {@code this} if an owner is not
     * specified.
     */
    ...
    /**
     * Compute the opacity for the label interior. By default, the label
     * interior is opacity is computed as 70% of the text opacity.
     *
     * @param textOpacity Opacity of the label text.
     *
     * @return Opacity of the label interior as a floating point number between
     * 0.0 and 1.0.
     */
    ...
    /**
     * Indicates the default offset applied to the graphic's main label. This
     * offset may be overridden by the graphic attributes.
     *
     ...
     *
     * @return Override attributes. Values set in this bundle override defaults
     * specified by the symbol set.
     */
    ...
    /**
     * Get the active shape attributes for this frame. The active attributes are
     * created by applying application specified overrides to the default
     * attributes specified by the symbol set.
     *
    ...
    /**
     * Get the Material that should be used to draw labels. If no override
     * material has been specified, the graphic's outline Material is used for
     * the labels.
     *
     * @return The Material that should be used when drawing labels. May change
     * each frame.
     */
    ...
    /**
     * Apply defaults to the active attributes bundle. The default attributes
     * are determined by the type of graphic. This method is called each frame
     * to reset the active shape attributes to the appropriate default state.
     * Override attributes specified by the application may be applied after the
    ...
    /**
     * Apply override attributes specified in a TacticalGraphicAttributes bundle
     * to the active ShapeAttributes. Any non-null properties of
     * {@code graphicAttributes} will be applied to {@code shapeAttributes}.
     *

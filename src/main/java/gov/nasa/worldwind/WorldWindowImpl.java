...
/**
 * An implementation class for the {@link WorldWindow} interface. Classes
 * implementing <code>WorldWindow</code> can subclass or aggregate this object
 * to provide default <code>WorldWindow</code> functionality.
 *
 * @author Tom Gaskins
...
public abstract class WorldWindowImpl extends WWObjectImpl implements WorldWindow {
     ...
     * cannot be used once this method is called. An OpenGL context for the

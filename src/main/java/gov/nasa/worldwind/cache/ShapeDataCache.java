 ...
 * Typically used to manage per-globe state when the application associates the
 * same shape with multiple {@link gov.nasa.worldwind.WorldWindow}s.
 * <p>
 * This cache limits the amount of time an entry remains in the cache unused.
 * The maximum unused time may be specified. Entries unused within the specified
 * duration are removed from the cache each time {@link
...
public class ShapeDataCache implements Iterable<ShapeDataCache.ShapeDataCacheEntry> {
    ...
    public static class ShapeDataCacheEntry extends AVListImpl {
        ...
        /**
         * Indicates the last time, in milliseconds, the entry was requested or
         * added.
         */
        protected long lastUsed = System.currentTimeMillis();
        /**
         * Identifies the associated globe's state at the time the entry was
         * created.
         */
        protected GlobeStateKey globeStateKey;
        /**
         * Indicates the vertical exaggeration in effect when the entry was
         * cached.
         */
        protected double verticalExaggeration;
        /**
         * Indicates the associated shape's extent, in model coordinates
         * relative to the associated globe.
         */
        protected Extent extent;
        /**
         * Indicates the eye distance of the shape in the globe-relative
         * coordinate system.
         */
        protected double eyeDistance;
        /**
         * Indicates the eye distance current when the cache entry's remaining
         * time was last adjusted.
         */
        protected double timerAdjustedEyeDistance;

        /**
         * Constructs an entry using the globe and vertical exaggeration of a
        ...
        /**
         * Indicates whether this shape data's globe state and vertical
         * exaggeration are the same as that in the current draw context.
         *
        ...
        /**
         * Adjust the timer's expiration time by comparing the cached eye
         * distance to the current eye distance. The remaining expiration time
         * is reduced by 50% each time the eye distance decreases by 50%. This
         * method may be called many times, and the remaining expiration time is
         * reduced only after the eye distance is reduced by 50%. This has no
         * effect if the cached eye distance is unknown, or if the expiration
        ...
        /**
         * Indicates this entry's globe state key, captured when this entry was
         * constructed or when explicitly set.
         *
        ...
        /**
         * Indicates this entry's vertical exaggeration, captured when the entry
         * was constructed or when explicitly set.
         *
    ...
    /**
     * The maximum number of milliseconds an entry may remain in the cache
     * without being used.
     */
     ...
     *
     * @param maxTimeSinceLastUsed the maximum number of milliseconds an entry
     * may remain in the cache without being used.
     */
    ...
    /**
     * Adds a specified entry to the cache or replaces an entry associated with
     * the same globe.
     *
     ...
     * <p>
     * Note: Each time this method is called the cache is cleared of dead
     * entries, as defined by their last-used time relative to this cache's
     * maximum unused time.
     *

...
public final class Sphere implements Extent, Renderable {
     ...
     *
     * @return a <code>Sphere</code> encompassing the given array of
     * <code>Vec4</code>s
     *
     ...
     *
     * @throws IllegalArgumentException if <code>buffer</code> is null or
     * contains fewer than three values.
     */
    ...
    /**
     * Creates a sphere that completely contains a set of Extents. This returns
     * null if the specified Iterable is empty or contains only null elements.
     * Note that this does not compute an optimal bounding sphere. The returned
     * sphere is computed as follows: the center is the mean of all center
     * points in the specified set of Extents, and the radius is smallest value
     * which defines a sphere originating at the computed center point and
     * containing all the specified Extents.
     *
    ...
    /**
     * Creates a new <code>Sphere</code> from a given center and radius.
     * <code>radius</code> must be positive (that is, greater than zero), and
     * <code>center</code> may not be null.
     *
     * @param center the center of the new sphere
     * @param radius the radius of the new sphere
     *
     * @throws IllegalArgumentException if <code>center</code> is null or if
     * <code>radius</code> is non-positive
     */
    ...
    /**
     * Obtains the radius of this <code>Sphere</code>. The radus is the distance
     * from the center to the surface. If an object's distance to this sphere's
     * center is less than or equal to the radius, then that object is at least
    ...
    /**
     * Obtains the diameter of this <code>Sphere</code>. The diameter is twice
     * the radius.
     *
     ...
     *
     * @return the <code>Vec4</code> situated at the center of this
     * <code>Sphere</code>
     */
     ...
     *
     * @return the Cartesian coordinates of the corresponding location on the
     * sphere.
     *
    ...
    /**
     * Obtains the intersections of this sphere with a line. The returned array
     * may be either null or of zero length if no intersections are discovered.
     * It does not contain null elements and will have a size of 2 at most.
     * Tangential intersections are marked as such. <code>line</code> is
     * considered to have infinite length in both directions.
     *
     * @param line the <code>Line</code> with which to intersect this
     * <code>Sphere</code>
     *
     * @return an array containing all the intersections of this
     * <code>Sphere</code> and <code>line</code>
     *
    ...
    /**
     * Calculates a discriminant. A discriminant is useful to determine the
     * number of roots to a quadratic equation. If the discriminant is less than
     * zero, there are no roots. If it equals zero, there is one root. If it is
     ...
     *
     * @return true if the specified frustum intersects this sphere, otherwise
     * false.
     *
     ...
     *
     * @return true if <code>line</code> intersects or makes a tangent with the
     * surface of this <code>Sphere</code>
     *
     * @throws IllegalArgumentException if <code>line</code> is null
     */
     ...
     *
     * @return true if <code>plane</code> intersects or makes a tangent with the
     * surface of this <code>Sphere</code>
     *
    ...
    /**
     * Causes this <code>Sphere</code> to render itself using the
     * <code>DrawContext</code> provided. <code>dc</code> may not be null.
     *

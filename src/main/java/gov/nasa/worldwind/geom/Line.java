...
public final class Line// Instances are immutable
{
     ...
     *
     * @throws IllegalArgumentException if either point is null or they are
     * coincident.
     */
     ...
     *
     * @throws IllegalArgumentException if <code>origin</code> is null, or
     * <code>direction</code> is null or has zero length
     */
    ...
    /**
     * Performs a comparison to test whether this Object is internally identical
     * to the other Object <code>o</code>. This method takes into account both
     * direction and origin, so two lines which may be equivalent may not be
     * considered equal.
     *
...
//    }
     ...
     * <code>Vec4</code>. This method returns a positive distance.
     *
     * @param p the <code>Vec4</code> whose distance from this <code>Line</code>
     * will be calculated
     *
     * @return the distance between this <code>Line</code> and the specified
     * <code>Vec4</code>
     *
    ...
    /**
     * Finds the closest point to a third point of a segment defined by two
     * points.
     *
     * @param p0 The first endpoint of the segment.
     * @param p1 The second endpoint of the segment.
     * @param p The point outside the segment whose closest point on the segment
     * is desired.
     *
     * @return The closest point on (p0, p1) to p. Note that this will be p0 or
     * p1 themselves whenever the closest point on the <em>line</em> defined by
     * p0 and p1 is outside the segment (i.e., the results are bounded by the
     * segment endpoints).
     */
    ...
    /**
     * Clip a line segment to a frustum, returning the end points of the portion
     * of the segment that is within the frustum.
     *
     ...
     * null if the segment does not intersect and the frustum does not fully
     ...
     *
     * @return true if <code>point</code> is behind this <code>Line</code>'s

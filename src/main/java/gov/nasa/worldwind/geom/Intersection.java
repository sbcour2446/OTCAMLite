...
public final class Intersection // Instances are immutable
{
     ...
     *
     * @param intersectionPoint the intersection point
     * @param intersectionLength the parametric length along the intersection
     * geometry. If the geometry was a line, then this value will be the
     * parametric value of the intersection point along the line.
     * @param isTangent true if the intersection is tangent to the object
     * intersected, otherwise false.
     *
     * @throws IllegalArgumentException if <code>intersectionPoint</code> is
     ...
     *
     * @return the intersection position, or null if the position has not been
     * set.
     */
    ...
    /**
     * Specifies the intersection position, which should be a position computed
     ...
     *
     * @return the object associated with the intersection, or null if no object
     * is associated.
     */
    ...
    /**
     * The parametric length along the intersection geometry. If the geometry
     * involved a line, this value is the parametric distance at which the
     * intersection occurred along the line.
     *
     ...
     *
     * @return the merged list of intersections, sorted by increasing distance

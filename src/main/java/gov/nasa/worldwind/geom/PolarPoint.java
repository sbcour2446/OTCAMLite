...
/**
 * Represents a point in space defined by a latitude, longitude and distance
 * from the origin.
 * <p>
...
public class PolarPoint {
    ...
    /**
     * Obtains a <code>PolarPoint</code> from two <code>angles</code> and a
     * radius.
     *
    ...
    /**
     * Obtains a cartesian point equivalent to this <code>PolarPoint</code>,
    ...
    /**
     * Obtains a cartesian point from a given latitude, longitude and distance
     * from center. This method is equivalent to, but may perform faster than
     * <code>Vec4 p = new PolarPoint(latitude, longitude, radius).toCartesian()</code>
     *
     * @param latitude the latitude
     * @param longitude the longitude

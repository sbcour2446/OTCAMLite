...
public class PolarCoordConverter {
 ...
 /* Maximum variance for easting and northing values for WGS 84. */
    ...
    /**
     * The function setPolarStereographicParameters receives the ellipsoid
     ...
     * code(s) are returned by the function, otherwise POLAR_NO_ERROR is
     * returned.
     *
     ...
     * (easting and northing), according to the current ellipsoid and Polar
     * Stereographic projection parameters. If any errors occur, error code(s)
     * are returned by the function, otherwise POLAR_NO_ERROR is returned.
     *
     ...
     * Stereographic coordinates (easting and northing) to geodetic coordinates
     * (latitude and longitude) according to the current ellipsoid and Polar
     * Stereographic projection Parameters. If any errors occur, the code(s) are

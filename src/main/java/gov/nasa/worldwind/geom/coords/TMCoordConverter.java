...
/**
 * Converter used to translate Transverse Mercator coordinates to and from
...
class TMCoordConverter {
 ...
 /* Isometeric to geodetic latitude parameters, default to WGS 84 */
     ...
     * @param Origin_Latitude Latitude in radians at the origin of the
     * projection
     * @param Central_Meridian Longitude in radians at the center of the
     * projection
     ...
     * error code(s) are returned by the function, otherwise TRANMERC_NO_ERROR
     * is returned.
     *

...
/**
 * Converter used to translate UTM coordinates to and from geodetic latitude and
 * longitude.
 *
...
class UTMCoordConverter {
    ...
    /**
     * The function Set_UTM_Parameters receives the ellipsoid parameters and UTM
     * zone override parameter as inputs, and sets the corresponding state
    ...
    /**
     * @return The coordinate hemisphere, either
     ...
     * hemisphere, easting and northing) coordinates to geodetic(latitude and
     * longitude) coordinates, according to the current ellipsoid parameters. If
     * any errors occur, the error code(s) are returned by the function,
     * otherwise UTM_NO_ERROR is returned.
     *
     * @param Zone UTM zone.
     * @param Hemisphere The coordinate hemisphere, either
     * {@link gov.nasa.worldwind.avlist.AVKey#NORTH} or {@link
     *                   gov.nasa.worldwind.avlist.AVKey#SOUTH}.

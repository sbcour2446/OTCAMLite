...
public class UPSCoord {
    ...
    /**
     * Create a set of UPS coordinates from a pair of latitude and longitude for
     * a WGS84 globe.
     *
     ...
     * <code>longitude</code> is null, or the conversion to UPS coordinates
     * fails.
     */
     ...
     * @return the corresponding <code>UPSCoord</code>.
     *
     * @throws IllegalArgumentException if the conversion to UPS coordinates
     * fails.
     */
     ...
     * <code>longitude</code>, or <code>hemisphere</code> is null.
     */

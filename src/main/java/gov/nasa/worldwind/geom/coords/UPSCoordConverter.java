...
/**
 * Ported to Java from the NGA GeoTrans ups.c and ups.h code - Feb 12, 2007
 * 4:52:59 PM
 *
...
public class UPSCoordConverter {
    ...
    /**
     * The function SetUPSParameters receives the ellipsoid parameters and sets
    ...
    /**
     * The function convertGeodeticToUPS converts geodetic (latitude and
     * longitude) coordinates to UPS (hemisphere, easting, and northing)
     * coordinates, according to the current ellipsoid parameters. If any errors
     * occur, the error code(s) are returned by the function, otherwide
     * UPS_NO_ERROR is returned.
     *
    ...
    /**
     * @return Hemisphere, either {@link gov.nasa.worldwind.avlist.AVKey#NORTH}
     * or {@link
     ...
     * and northing) coordinates to geodetic (latitude and longitude)
     * coordinates according to the current ellipsoid parameters. If any errors

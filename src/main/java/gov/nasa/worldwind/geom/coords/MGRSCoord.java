...
/**
 * This class holds an immutable MGRS coordinate string along with the
...
public class MGRSCoord {
     ...
     * <code>Angle</code> with the maximum precision of five digits (one meter).
     *
     ...
     * <code>longitude</code> is null, or the conversion to MGRS coordinates
     * fails.
     */
    ...
    /**
     * Create a WGS84 MGRS coordinate from a pair of latitude and longitude
     * <code>Angle</code> with the given precision or number of digits.
     *
     * @param latitude the latitude <code>Angle</code>.
     * @param longitude the longitude <code>Angle</code>.
     * @param precision the number of digits used for easting and northing (1 to
     * 5).
     * @return the corresponding <code>MGRSCoord</code>.
     * @throws IllegalArgumentException if <code>latitude</code> or
     * <code>longitude</code> is null, or the conversion to MGRS coordinates
     ...
     * @return the corresponding <code>MGRSCoord</code>.
     * @throws IllegalArgumentException if <code>latitude</code> or
     * <code>longitude</code> is null, the <code>globe</code> is null, or the
     * conversion to MGRS coordinates fails.
     */
    ...
    /**
     * Create a MGRS coordinate from a pair of latitude and longitude
     * <code>Angle</code> with the given precision or number of digits (1 to 5).
     *
     * @param latitude the latitude <code>Angle</code>.
     * @param longitude the longitude <code>Angle</code>.
     ...
     * <p>
     * The string will be converted to uppercase and stripped of all spaces
     ...
     * @param globe the <code>Globe</code> - can be null (will use WGS84).
     * @return the corresponding <code>MGRSCoord</code>.
     * @throws IllegalArgumentException if the <code>MGRSString</code> is null
     * or empty, the <code>globe</code> is null, or the conversion to geodetic
     * coordinates fails (invalid coordinate string).
     */
     ...
     * <code>Angle</code> and the corresponding MGRS coordinate string.
     *
     * @param latitude the latitude <code>Angle</code>.
     * @param longitude the longitude <code>Angle</code>.
     * @param MGRSString the corresponding MGRS coordinate string.
     * @throws IllegalArgumentException if <code>latitude</code> or
     * <code>longitude</code> is null, or the MGRSString is null or empty.
     */

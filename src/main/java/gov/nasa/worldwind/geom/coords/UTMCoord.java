...
public class UTMCoord {
    ...
    /**
     * Create a set of UTM coordinates from a pair of latitude and longitude for
     * a WGS84 globe.
     *
     ...
     * <code>longitude</code> is null, or the conversion to UTM coordinates
     * fails.
     */
     ...
     * @param hemisphere the hemisphere, either
     ...
     * @return the corresponding <code>UTMCoord</code>.
     *
     * @throws IllegalArgumentException if the conversion to UTM coordinates
     * fails.
     */
    ...
    /**
     * Convenience method for converting a UTM coordinate to a geographic
     * location.
     *
     * @param zone the UTM zone: 1 to 60.
     * @param hemisphere the hemisphere, either
     ...
     * @param globe the <code>Globe</code>. Can be null (will use WGS84).
     *
     * @return the geographic location corresponding to the specified UTM
     * coordinate.
     */

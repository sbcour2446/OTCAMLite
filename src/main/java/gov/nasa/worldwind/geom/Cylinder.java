 ...
 * <code>Cylinder</code>s are immutable.
 *
 * @author Tom Gaskins
...
public class Cylinder implements Extent, Renderable {
     ...
     *
     * @throws IllegalArgumentException if the radius is zero or the top or
     * bottom point is null or they are coincident.
     */
     ...
     * Provided for use when unit axis is know and computation of it can be
     * avoided.
     *
     * @param bottomCenter the center point of of the cylinder's base.
     * @param topCenter the center point of the cylinders top.
     ...
     *
     * @return a cylinder bounding all the points. The axis of the cylinder is
     * the longest principal axis of the collection. (See
     * {@link WWMath#computePrincipalAxes(Iterable)}.
     *
     * @throws IllegalArgumentException if the point list is null or empty.
     * @see #computeVerticalBoundingCylinder(gov.nasa.worldwind.globes.Globe,
     * double, Sector)
     */
     ...
     * and is oriented such that the cylinder axis is perpendicular to the
     * globe's surface.
     *
    ...
    /**
     * Compute the Cylinder that surrounds the equator, and has height defined
     * by the sector's minumum and maximum latitudes (including maxHeight).
     *
     * @param globe The globe associated with the sector.
     * @param sector the sector to return the bounding cylinder for.
    ...
    /**
     * Returns a cylinder that minimally surrounds the specified height range in
     * the sector.
     *
     * @param globe The globe associated with the sector.
     * @param sector the sector to return the bounding cylinder for.
    ...
    /**
     * Returns a cylinder that surrounds the specified height range in the
     * zero-area sector. The returned cylinder won't be as tight a fit as
     * <code>computeBoundsFromSectorQuadrilateral</code>.
     *
     * @param globe The globe associated with the sector.
     * @param sector the sector to return the bounding cylinder for.
     * @param minHeight the minimum height to include in the bounding cylinder.

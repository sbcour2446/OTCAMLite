...
/**
 * A viewport aligned {@link gov.nasa.worldwind.geom.Frustum} that also stores
 * the 2D screen rectangle that the {@link
...
public class PickPointFrustum extends Frustum {
    ...
    /**
     * Constructs a new PickPointFrustum from another Frustum and screen
     * rectangle
     *
    ...
    /**
     * Returns true if the specified 2D screen {@link java.awt.Rectangle}
     * intersects the space enclosed by this view aligned frustums screen
     * rectangle.
     *
     * @param rect the rectangle to test
     *
     * @return true if the specified Rectangle intersects the space enclosed by
     * this Frustum, and false otherwise.
     *
    ...
    /**
     * Returns true if the specified point is inside the 2D screen rectangle
     * enclosed by this frustum
     *
     * @param x the x coordinate to test.
     * @param y the y coordinate to test.
     *
     * @return true if the specified point is inside the space enclosed by this
     * Frustum, and false otherwise.
     *
    ...
    /**
     * Returns a copy of this PickPointFrustum which is transformed by the
     * specified Matrix.
     *

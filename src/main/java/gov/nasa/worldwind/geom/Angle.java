...
public class Angle implements Comparable<Angle> {
    ...
    /**
     * Obtain an angle from a given number of positive degrees, minutes and
     * seconds.
     *
     ...
     *
     * @return a new angle whose size in degrees is given by
     * <code>degrees</code>, <code>minutes</code> and <code>seconds</code>.
     *
     * @throws IllegalArgumentException if minutes or seconds are outside the
     * 0-60 range or the degrees is negative.
     */
    ...
    /**
     * Obtain an angle from a given number of positive degrees and decimal
     * minutes.
     *
     * @param degrees integer number of degrees, positive.
     * @param minutes double representing the decimal representation of minutes
     * and seconds.
     *
     * @return a new angle whose size in degrees is given by
     * <code>degrees</code> and decimal <code>minutes</code>.
     *
     * @throws IllegalArgumentException if minutes or seconds are outside the
     * 0-60 range or the degrees is negative.
     */
     ...
     * 45 12 30 S
     * 45 12 30 N
     * </pre> For a string containing both a sign and compass direction, the
     * compass direction will take precedence.
     *
     * @param dmsString the degrees, minute and second character string.
     *
     * @return the corresponding angle.
     *
     * @throws IllegalArgumentException if dmsString is null or not properly
     * formated.
     */
     ...
     * <code>a3</code>
     *
     * @throws IllegalArgumentException if <code>a</code> or <code>b</code> is
     * null
     */
     ...
     * <code>a3</code>.
     *
     * @throws IllegalArgumentException if <code>a</code>, <code>b</code> or
     * <code>c</code> is null.
     */
     ...
     * <p>
     * The returned angle is undefined if min &gt; max. Otherwise, this method's
     * return value is equivalent to the following:
     * <ul> <li>min - If value &lt; min</li> <li>max - If value &gt; max</li>
     * <li>value - If min &lt;= value &gt;= max</li> </ul>
     *
    ...
    /**
     * Compares this {@link Angle} with another. Returns a negative integer if
     * this is the smaller angle, a positive integer if this is the larger, and
     * zero if both angles are equal.
     *
     ...
     * {@link Angle}.
     *
     * @param digits the number of digits past the decimal point to include in
     * the string.
     *
     * @return the value of this angle in decimal degrees as a string with the
     * specified number of digits beyond the decimal point. The string is padded
     * with trailing zeros to fill the number of post-decimal point positions
     * requested.
     */
    ...
    /**
     * Obtains a {@link String} representation of this {@link Angle} formatted
     * as degrees, minutes and seconds integer values.
     *
    ...
    /**
     * Obtains a {@link String} representation of this {@link Angle} formatted
     * as degrees and decimal minutes.
     *

...
/**
 * Represents a <code>Plane</code> in Cartesian coordinates, defined by a normal
 * vector to the plane and a signed scalar value proportional to the distance of
 * the plane from the origin. The sign of the value is relative to the direction
 * of the plane normal.
 *
 * @author Tom Gaskins
...
public final class Plane {
    ...
    /**
     * Constructs a plane from a 4-D vector giving the plane normal vector and
     * distance.
     *
     * @param vec a 4-D vector indicating the plane's normal vector and
     * distance. The normal need not be unit length.
     *
    ...
    /**
     * Constructs a plane from four values giving the plane normal vector and
     * distance.
     *
     ...
     *
     * @throws IllegalArgumentException if the normal vector components define
     * the zero vector (all values are zero).
     */
    ...
    /**
     * Returns the plane that passes through the specified three points. The
     * plane's normal is the cross product of the two vectors from
     * <code>pb</code> to <code>pa</code> and <code>pc</code> to
     * <code>pa</code>, respectively. The returned plane is undefined if any of
     * the specified points are colinear.
     *
     ...
     *
     * @throws IllegalArgumentException if <code>pa</code>, <code>pb</code>, or
     * <code>pc</code> is <code>null</code>.
     */
    ...
    /**
     * Returns a normalized version of this plane. The normalized plane's normal
     * vector is unit length and its distance is D/|N| where |N| is the length
     ...
     *
     * @return the intersection point if the line intersects the plane,
     * otherwise null.
     *
     ...
     *
     * @return The parametric value of the point on the line at which it
     * intersects the plane. {@link Double#NaN} is returned if the line does not
     * intersect the plane. {@link Double#POSITIVE_INFINITY} is returned if the
    ...
    /**
     * Test a line segment for intersection with this plane. If it intersects,
     * return the point of intersection.
     *
     * @param pa the first point of the line segment.
     * @param pb the second point of the line segment.
     *
     * @return The point of intersection with the plane. Null is returned if the
     * segment does not instersect this plane.
     ...
     *
     * @return An array of two points both on the positive side of the plane. If
     * the direction of the line formed by the two points is positive with
     * respect to this plane's normal vector, the first point in the array will
     * be the intersection point on the plane, and the second point will be the
     * original segment end point. If the direction of the line is negative with
     * respect to this plane's normal vector, the first point in the array will
     * be the original segment's begin point, and the second point will be the
     * intersection point on the plane. If the segment does not intersect the
     * plane, null is returned. If the segment is coincident with the plane, the
     * input points are returned, in their input order.
     *
     * @throws IllegalArgumentException if either input point is null.
     */
     ...
     * @param pb the second point.
     *
     * @return true if the points are on the same side of the plane, otherwise
     * false.
     *
     ...
     * false.
     *
     * @throws IllegalArgumentException if the points array is null or any point
     * within it is null.
     */
     ...
     *
     * @return the Cartesian coordinates of the intersection, or null if the
     * three planes to not intersect at a point.
     *

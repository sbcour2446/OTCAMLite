...
/**
 * <code>WorldWindowGLCanvas</code> is a lightweight Swing component for
 ...
 * <p>
 * Note: The Java SDK for OpenGL (JOGL) support for the underlying
 * {@link GLJPanel} that this class uses has historically been problematic. It
 * works well on some devices but not on others, and its performance varies much
 * more among devices than that of its heavyweight counterpart,
 * {@link WorldWindowGLCanvas}. It's therefore best to use the heavyweight
 * component if possible. You can find detailed information on this issue in the
 * <em>Heavyweight and Lightweight Issues</em> section of the
 * <a href="http://download.java.net/media/jogl/doc/userguide/">"JOGL User's
 * Guide"</a>
 * <p>
...
public class WorldWindowGLJPanel extends GLJPanel implements WorldWindow, PropertyChangeListener {
    ...
    /**
     * Constructs a new <code>WorldWindowGLJPanel</code> on the default graphics
    ...
    /**
     * Constructs a new <code>WorldWindowGLJPanel</code> that shares graphics
     * resources with another <code>WorldWindow</code> and whose capabilities
     * are chosen via a specified {@link GLCapabilities} object and a

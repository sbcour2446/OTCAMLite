...
public interface AVList {
     ...
     *
     * @throws IllegalArgumentException if either <code>propertyName</code> or
    ...
    /**
     * Adds the specified all-property property change listener that will be
     * called for all list changes.
     *
    ...
    /**
     * Calls all property change listeners associated with the specified key. No
     * listeners are called if <code>odValue</code> and <code>newValue</code>
     * are equal and non-null.
     *
     * @param propertyName the key
     * @param oldValue the value associated with the key before the even causing
     * the firing.
    ...
    /**
     * Calls all registered property change listeners with the specified
     * property change event.
     *
     * @param propertyChangeEvent the event
     *
     * @throws IllegalArgumentException if <code>propertyChangeEvent</code> is
     * null
     * @see java.beans.PropertyChangeSupport
     */

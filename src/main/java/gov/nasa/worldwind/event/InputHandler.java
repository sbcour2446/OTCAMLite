...
public interface InputHandler extends AVList, java.beans.PropertyChangeListener {
     ...
     * Touch screen devices require this so that the current position and
     * selection are updated when the button is pressed. The update occurs
     * naturally on non-touch screen devices because the motion of the mouse
     * prior to the press causes the current position and selection to be
     * updated.
     *
     * @return true if a redraw is forced when a button is pressed, otherwise
     * false.
     */
     ...
     * updated.
     *
     * @param forceRedrawOnMousePressed true to force a redraw on button press,

...
public class BulkRetrievalEvent extends WWEvent {
     ...
     * Creates a new event.
     *
     * @param source the event source, typically either a tiled image layer,
     * elevation model or placename layer.
     * @param eventType indicates success or failure. One of
     * {@link #RETRIEVAL_SUCCEEDED} or {@link #RETRIEVAL_FAILED}.
     * @param item the cache location of the item whose retrieval succeeded or
     * failed.
     *
     * @see gov.nasa.worldwind.retrieve.BulkRetrievable
     */
     ...
     *
     * @return the event source, typically either a tiled image layer, elevation
     * model or placename layer.
     *
     * @see gov.nasa.worldwind.retrieve.BulkRetrievable
     */
    ...
    /**
     * Returns the event type, one of {@link #RETRIEVAL_SUCCEEDED} or
     * {@link #RETRIEVAL_FAILED}.
     *
    ...
    /**
     * Returns the filestore location of the item whose retrieval succeeded or
     * failed.
     *

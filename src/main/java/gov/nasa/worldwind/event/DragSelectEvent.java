...
/**
 * This class is a specialization of {@link SelectEvent} and includes the pick
 * point screen position of the most recent drag event prior to the current one.
 *
 * @author tag
...
public class DragSelectEvent extends SelectEvent {
    ...
    /**
     * Indicates the most screen position of the drag event immediately prior to
     * this one.
     *

...
public class WMSTiledImageLayer extends BasicTiledImageLayer {
    ...
    /**
     * Extracts parameters necessary to configure the layer from an XML DOM
     * element.
     *
     * @param domElement the element to search for parameters.
     * @param params an attribute-value list in which to place the extracted
     * parameters. May be null, in which case a new attribue-value list is
     * created and returned.
     *
     * @return the attribute-value list passed as the second parameter, or the
     * list created if the second parameter is null.
     *
     ...
     * @param params an attribute-value list in which to place the extracted
     * parameters. May be null, in which case a new attribute-value list is
     * created and returned.
     *
     * @return the attribute-value list passed as the second parameter, or the
     * list created if the second parameter is null.
     *
     * @throws IllegalArgumentException if the capabilities document reference
     * is null.
     */
    ...
    //**************************************************************//
    /**
     * Appends WMS tiled image layer configuration elements to the superclass
     * configuration document.
     *
     * @param params configuration parameters describing this WMS tiled image
     * layer.
     *
    ...
    /**
     * Creates an attribute-value list from an xml document containing
     * restorable state for this layer.
     *
     * @param stateInXml an xml document specified in a {@link String}.
     *
     * @return an attribute-value list containing the parameters in the
     * specified restorable state.
     *

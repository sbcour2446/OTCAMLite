...
/**
 * This class provides a means to construct an OGC web service request, such as
 * WMS GetMap or WFS GetCapabilities.
 *
 * @author tag
...
public abstract class Request {
    ...
    /**
     * Constructs a request for the default service, WMS, and a specified
     * server.
     *
     * @param uri the address of the web service. May be null when this
     * constructor invoked by subclasses.
     *
     ...
     * @param service the service name. Common names are WMS, WFS, WCS, etc. May
     * by null when this constructor is invoked by subclasses.
     *
     * @throws URISyntaxException if the web service address is not a valid URI.
     */

...
/**
 * WMSNamespaceContext is an implementation of
 * {@link javax.xml.namespace.NamespaceContext} which provides an XML Namespace
 * context necessary for parsing WMS documents, such as a WMS Capabilities
 * document.
 *
 * @author dcollins
...
public class WMSNamespaceContext extends BasicNamespaceContext {
    ...
    /**
     * Sole constructor for WMSNamespaceContext. In addition to the namespaces
     * configured by the superclass constructor
     * {@link gov.nasa.worldwind.util.BasicNamespaceContext#BasicNamespaceContext()},
     * this configures the following namespaces: <table>

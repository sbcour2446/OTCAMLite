...
/**
 * An interface provided by objects that can be dragged. The {@link DragContext}
 * provided in the {@link
 * Draggable#drag(DragContext)} method includes information on the screen
 * coordinates and the state of the {@link gov.nasa.worldwind.WorldWindow}.
 */
public interface Draggable {
     ...
     *
     * @param enabled <code>true</code> if the object is enabled, else
     * <code>false</code>.
     */

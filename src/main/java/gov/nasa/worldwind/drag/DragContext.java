...
/**
 * Provides information about mouse inputs and {@link WorldWindow} state for use
 * in dragging operations.
 */
public class DragContext {

    /**
     * In accordance with the AWT screen coordinates the top left point of the
     * window is the origin.
     */
    protected Point point;
    /**
     * In accordance with the AWT screen coordinates the top left point of the
     * window is the origin. This point is the previous screen point.
     */
    protected Point previousPoint;
    /**
     * In accordance with the AWT screen coordinates the top left point of the
     * window is the origin. This point refers to the initial point of the drag
     * event.
     */
    ...
    protected View view;
    /**
     * The current drag state, which can be one of the three following values: null     {@link gov.nasa.worldwind.avlist.AVKey#DRAG_BEGIN}, {@link gov.nasa.worldwind.avlist.AVKey#DRAG_CHANGE},
    ...
    /**
     * Returns the current screen point with the origin at the top left corner
     * of the window.
     *
    ...
    /**
     * Returns the previous screen point with the origin at the top left corner
     * of the window.
     *
     ...
     *
     * @param previousPoint the screen point to assign to the previous screen
     * point.
     *
    ...
    /**
     * Returns the initial screen point with the origin at the top left corner
     ...
     *
     * @param initialPoint the screen point to assign to the initial screen
     * point.
     *
     ...
     *
     * @param sceneController the {@link SceneController} to assign to the
     * {@link DragContext}.
     *
    ...
    /**
     * Set the {@link DragContext} drag state, which must be one of the
     * following three states: {@link AVKey#DRAG_BEGIN}
     * , {@link AVKey#DRAG_CHANGE}, or {@link AVKey#DRAG_ENDED}.
     *
     * @param dragState the drag state to assign to the {@link DragContext}.
     *
     * @throws IllegalArgumentException if the drag state is null or not one of
     * the three states defined for dragging.
     */

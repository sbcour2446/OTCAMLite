...
public interface DXTDecompressor {
     ...
     * @param width must be a positive and power of two (4, 8, 16, 32, 64, 128,
     * 512, etc )
     * @param height must be a positive and power of two (4, 8, 16, 32, 64, 128,
     * 512, etc )
     * @return java.awt.image.BufferedImage instance
     * @throws IOException if there is a problem while reading from buffer or
     * decompression
     * @throws IllegalArgumentException if any input parameter is null or
     * invalid
     */

...
/**
 * The <code>DXTCompressor</code> interface will compress an in-memory image
 * using one of the DXT block compression schemes. The details of each block
 * compression scheme is handled by the implementation.
 *
 * @author dcollins
...
public interface DXTCompressor {
    ...
    /**
     * Encodes the specified <code>image</code> image into a compressed DXT
     * codec, and writes the compressed bytes to the specified
     * <code>buffer</code>. The buffer should be allocated with enough space to
     * hold the compressed output. The correct size should be computed by
     * calling <code>getCompressedSize(image, attributes)</code>.
     *
     ...
     *
     * @see #getCompressedSize(java.awt.image.BufferedImage,
     * DXTCompressionAttributes)
     * @throws IllegalArgumentException if any of <code>image</code>,
     * <code>attributes</code>, or <code>buffer</code> are null.
     */

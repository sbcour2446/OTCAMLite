...
public class DDSDecompressor {
    ...
    /**
     * Reconstructs image raster from a DDS source. The source type may be one
     * of the following: <ul><li>{@link java.net.URL}</li> <li>{@link
     ...
     * @param params The AVList is a required parameter, Cannot be null.
     * Requires AVK.Sector to be present.
     * @return MipMappedBufferedImageRaster if the DDS source contains mipmaps,
     * otherwise returns a BufferedImageRaster

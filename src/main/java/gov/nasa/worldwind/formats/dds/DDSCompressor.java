...
/**
 * DDSCompressor converts in-memory images into a DDS file encoded with one of
 * the DXT block compression algorithms. If the caller wants to encode using a
 * certain type of DXT compression, DDSCompressor provides the appropriate
 * methods to do that. Otherwise, DDSCompressor chooses the DXT compression
 * scheme that best suits the source image.
 * <p>
 * Each compression method accepts a reference to a
 * {@link gov.nasa.worldwind.formats.dds.DXTCompressionAttributes}. This
 * compressor performs the appropriate actions according to the attributes, such
 * as building mip maps and converting the source image to a premultiplied alpha
 * format.
 *
 * @author dcollins
...
public class DDSCompressor {
    ...
    /**
     * Convenience method to convert the specified image <code>stream</code> to
     * DDS according to the specified compression <code>attributes</code>. The
     * <code>stream</code> must be readable by {@link
     * javax.imageio.ImageIO#read(java.io.InputStream)}. Once the
     * <code>stream</code> is read, this is equivalent to calling
     * {#compressImage(java.awt.image.BufferedImage,
     * gov.nasa.worldwind.formats.dds.DXTCompressionAttributes)} with the
     * BufferedImage created by ImageIO and the specified
     * <code>attributes</code>. This returns null if the <code>stream</code> is
     * not in a format understood by ImageIO.
     *
     ...
     * or null if the <code>stream</code> is not in a format understood by
     * ImageIO.
     *
     * @throws java.io.IOException if <code>stream</code> is in a format
     * understood by ImageIO, but the image data cannot be read by ImageIO.
     * @throws IllegalArgumentException if either the <code>stream</code> or the
     * <code>attributes</code> are null.
     */
    ...
    /**
     * Convenience method to convert the specified image <code>stream</code> to
     * DDS according to the default attributes. The <code>stream</code> must be
     * readable by {@link javax.imageio.ImageIO#read(java.io.InputStream)}. Once
     * the <code>stream</code> is read, this is equivalent to calling
     * {#compressImage(java.awt.image.BufferedImage)} with the BufferedImage
     * created by ImageIO. This returns null if the <code>stream</code> is not
    ...
    /**
     * Convenience method to convert the specified <code>imageBuffer</code> to
     * DDS according to the specified compression <code>attributes</code>. The
     * bytes in <code>imageBuffer</code> must be readable by {@link
     * javax.imageio.ImageIO#read(java.io.InputStream)}. Once the image data is
     * read, this is equivalent to calling
     * {#compressImage(java.awt.image.BufferedImage,
     * gov.nasa.worldwind.formats.dds.DXTCompressionAttributes)} with the
     * BufferedImage created by ImageIO and the specified
     * <code>attributes</code>. This returns null if the bytes in
     ...
     *
     * @return little endian ordered ByteBuffer containing the DDS file bytes,
     * or null if the <code>imageBuffer</code> is not in a format understood by
     * ImageIO.
     *
     * @throws java.io.IOException if the bytes in <code>imageBuffer</code> are
     * in a format understood by ImageIO, but the image data cannot be read by
     * ImageIO.
     * @throws IllegalArgumentException if either <code>imageBuffer</code> or
     * <code>attributes</code> are null.
     */
    ...
    /**
     * Convenience method to convert the specified <code>imageBuffer</code> to
     * DDS according to the default attributes. The bytes in
     * <code>imageBuffer</code> must be readable by
     * {@link javax.imageio.ImageIO#read(java.io.InputStream)}. Once the image
     * data is read, this is equivalent to calling
     * {#compressImage(java.awt.image.BufferedImage)} with the BufferedImage
     * created by ImageIO. This returns null if the bytes
     * in<code>imageBuffer</code> are not in a format understood by ImageIO.
     *
     * @param imageBuffer image file data to convert to the DDS file format.
     *
     * @return little endian ordered ByteBuffer containing the DDS file bytes,
    ...
    /**
     * Convenience method to convert the specified image <code>file</code> to
     * DDS according to the specified compression <code>attributes</code>. The
     * <code>file</code> must be readable by
     * {@link javax.imageio.ImageIO#read(java.io.File)}. Once the file is read,
     * this is equivalent to calling
     * {#compressImage(java.awt.image.BufferedImage,
     * gov.nasa.worldwind.formats.dds.DXTCompressionAttributes)} with the
     * BufferedImage created by ImageIO and the specified
     * <code>attributes</code> This returns null if the <code>file</code> is not
     * in a format understood by ImageIO.
     *
     ...
     *
     * @return little endian ordered ByteBuffer containing the DDS file bytes,
     * or null if the <code>file</code> is not in a format understood by
     * ImageIO.
     *
     * @throws java.io.IOException if <code>file</code> is in a format
     * understood by ImageIO, but the image data cannot be read by ImageIO.
     * @throws IllegalArgumentException if either the <code>file</code> or the
     * <code>attributes</code> are null, if the file does not exist, or if read
     * permission is not allowed on the <code>file</code>.
     */
    ...
    /**
     * Convenience method to convert the specified image <code>file</code> to
     * DDS according to the default attributes. The <code>file</code> must be
     * readable by {@link javax.imageio.ImageIO#read(java.io.File)}. Once the
     * file is read, this is equivalent to calling
     * {#compressImage(java.awt.image.BufferedImage)} with the BufferedImage
     * created by ImageIO. This returns null if the <code>file</code> is not in
     ...
     * @throws java.io.IOException if <code>file</code> is in a format
     * understood by ImageIO, but the image data cannot be read by ImageIO.
     * @throws IllegalArgumentException if <code>file</code> is null, does not
     * exist, or read permission is not allowed on the <code>file</code>.
     */
    ...
    /**
     * Convenience method to convert the specified image <code>url</code> to DDS
     * according to the specified compression <code>attributes</code>. The
     * <code>url</code> must be readable by
     * {@link javax.imageio.ImageIO#read(java.net.URL)}. Once the
     * <code>url</code> is read, this is equivalent to calling
     * {#compressImage(java.awt.image.BufferedImage,
     * gov.nasa.worldwind.formats.dds.DXTCompressionAttributes)} with the
     * BufferedImage created by ImageIO and the specified
     * <code>attributes</code> This returns null if the <code>url</code> is not
     * in a format understood by ImageIO.
     *
     ...
     *
     * @return little endian ordered ByteBuffer containing the DDS file bytes,
     * or null if the <code>url</code> is not in a format understood by ImageIO.
     *
     * @throws java.io.IOException if <code>url</code> is in a format understood
     * by ImageIO, but the image data cannot be read by ImageIO.
     * @throws IllegalArgumentException if either the <code>url</code> or the
     * <code>attributes</code> are null.
     */
    ...
    /**
     * Convenience method to convert the specified image <code>url</code> to DDS
     * according to the default attributes. The <code>url</code> must be
     * readable by {@link javax.imageio.ImageIO#read(java.net.URL)}. Once the
     * <code>url</code> is read, this is equivalent to calling
     * {#compressImage(java.awt.image.BufferedImage)} with the BufferedImage
     * created by ImageIO. This returns null if the <code>url</code> is not in a
    ...
    /**
     * Convenience method to convert the specified <code>image</code> to DDS
     * according to the default attributes. This chooses the DXT compression
     * format best suited for the image type.
     *
    ...
    /**
     * Returns the default compression attributes. The default DXT compression
     * attributes are defined as follows:
     * <table> <caption style="font-weight: bold;">Default
     * Attributes</caption><tr><th>Attribute</th><th>Value</th></tr>
     * <tr><td>Build Mipmaps</td><td>true</td></tr>
     * <tr><td>Premultiply Alpha</td><td>true</td></tr> <tr><td>DXT
     * Format</td><td>Let DDSCompressor choose optimal format.</td></tr>
     * <tr><td>Enable DXT1 Alpha</td><td>false</td></tr> <tr><td>DXT1 Alpha
     * Threshold</td><td>128</td></tr> <tr><td>Compression
     * Algorithm</td><td>Euclidean Distance</td></tr> </table>
     *
    ...
    /**
     * Converts the specified <code>image</code> to DDS according to the
     * <code>attributes</code>. If the caller specified a DXT format in the
     * attributes, then we return a compressor matching that format. Otherwise,
     * we choose one automatically from the image type. If no choice can be made
     * from the image type, we default to using a DXT3 compressor.
     *
     * @param image image to convert to the DDS file format.
     * @param attributes attributes that control the compression.
     *
     * @return buffer little endian ordered ByteBuffer containing the dds file
     * bytes.
     *
     * @throws IllegalArgumentException if either <code>image</code> or
     * <code>attributes</code> are null, or if <code>image</code> has non power
     * of two dimensions.
     */
    ...
    /**
     * Converts the specified <code>image</code> to DDS using the DXT1 codec,
     * and otherwise according to the <code>attributes</code>.
     *
     * @param image image to convert to the DDS file format using the DXT1
     * codec.
     * @param attributes attributes that control the compression.
     *
     * @return buffer little endian ordered ByteBuffer containing the dds file
    ...
    /**
     * Converts the specified <code>image</code> to DDS using the DXT3 codec,
     * and otherwise according to the <code>attributes</code>.
     *
     * @param image image to convert to the DDS file format using the DXT3
     * codec.
     * @param attributes attributes that control the compression.
     *
     * @return buffer little endian ordered ByteBuffer containing the dds file

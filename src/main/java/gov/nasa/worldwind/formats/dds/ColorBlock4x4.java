...
public class ColorBlock4x4 {
    ...
    /**
     * The 4x4 color values stored as an array of length 16. This property is
     * publicly exposed, so its contents are mutable. It is declared final to
     * prevent a caller form reassigning the array reference.
     */
    public final Color32[] color = new Color32[16];

    /**
     * Creates a 4x4 color block with the color values initialized to non-null
     * references. Initially all color values are set to 0.
     */

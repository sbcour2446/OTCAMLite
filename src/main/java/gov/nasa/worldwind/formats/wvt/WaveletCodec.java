...
public class WaveletCodec {
     ...
     * The specified resolution must be a power of two, and must be less than or
     * equal to the resolution of the encoding.
     *
    ...
    /**
     * Creates a wavelet encoding from the given BufferedImage. The image must
     * have dimensions that are a power of 2. If the incoming image has at least
     * 3 bands, the first three are assumed to be RGB channels. If only
     * one-band, it is assumed to be grayscale. The SampleModel component-type
     * must be BYTE.
     *

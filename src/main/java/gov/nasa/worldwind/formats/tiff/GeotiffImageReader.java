    ...
    *
    ...
    private void readIFD(long offset) throws IIOException {
        try {
            ...
            /**
             * **** TODO: UNCOMMENT; IN GENERAL, THERE CAN BE MORE THAN ONE IFD
             * IN A TIFF FILE long nextIFDOffset = theStream.readUnsignedInt();
             * if (nextIFDOffset > 0) readIFD(nextIFDOffset);
             */
        } catch (Exception ex) {

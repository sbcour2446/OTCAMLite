...
public class VPFBasicFeatureFactory implements VPFFeatureFactory {
    ...
    /**
     * Constructs an instance of a VPFBasicFeatureFactory which will construct
     * feature data for the specified {@link
     * gov.nasa.worldwind.formats.vpf.VPFTile} and
     * {@link gov.nasa.worldwind.formats.vpf.VPFPrimitiveData}. The primitive
     * data must contain information for at least those features found in the
     * specified tile.
     *
     * @param tile the tile which defines the geographic region to construct
     * features for.
     * @param primitiveData the primitive data describing feature information
     * for the geographic region defined by the tile.
     */

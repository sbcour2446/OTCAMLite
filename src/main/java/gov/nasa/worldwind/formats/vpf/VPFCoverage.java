...
/**
 * DIGEST Part 2, Annex C.2.2.2.3:<br>A coverage is composed of features whose
 * primitives maintain topological relationships according to a level of
 * topology (level 0, 1, 2, or 3) defined for the coverage. All of the file
 * structures that make up a coverage are stored in a directory or
...
public class VPFCoverage extends AVListImpl {
     ...
     * This initializes the Coverage's Feature Class Schema table, the Feature
     * Class Attribute table, the Character Value Description table, the Integer
     * Value Descrption table, and the Symbol Related Attribute table.
     *
     * @param library the Library which the Coverage resides in.
     * @param name the Coverage's name.
     *
     * @return a new Coverage from the specified Library with the specified
     * name.
     *
     * @throws IllegalArgumentException if the library is null, or if the name
     * is null or empty.
     */

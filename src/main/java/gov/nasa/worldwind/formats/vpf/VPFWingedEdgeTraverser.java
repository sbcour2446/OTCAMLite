...
/**
 * Encapsulation of the Wiged-Edge Algorithm for VPF ring primitives, described
 * in DIGEST Part 2, Annex C2.4.3. Given a row from the ring primitive table,
 * navigate the ring and edge primitive tables to construct the edge information
...
public class VPFWingedEdgeTraverser {
    ...
    /**
     * Implementation of the Wiged-Edge Algorithm for ring primitives, described
     * in DIGEST Part 2, Annex C2.4.3.Given a row from the ring primitive table,
     * navigate the ring and edge primitive tables to construct the edge
     * information associated with the specified ring.
     *

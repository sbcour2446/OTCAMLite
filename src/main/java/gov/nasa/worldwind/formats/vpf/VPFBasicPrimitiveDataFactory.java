...
/**
 * @author dcollins
 * @version $Id: VPFBasicPrimitiveDataFactory.java 1171 2013-02-11 21:45:02Z
 * dcollins $
 */
public class VPFBasicPrimitiveDataFactory implements VPFPrimitiveDataFactory {
    ...
    /**
     * Constructs an instance of a VPFBasicPrimitiveDataFactory which will
     * construct primiitve data for the specified
    ...
    //**************************************************************//
    /**
     * Given a row from the ring primitive table, navigate the ring and edge
     * primitive tables to construct a new {@link

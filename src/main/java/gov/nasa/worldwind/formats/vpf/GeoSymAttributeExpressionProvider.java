...
/**
 * @author dcollins
 * @version $Id: GeoSymAttributeExpressionProvider.java 1171 2013-02-11
 * 21:45:02Z dcollins $
 */
public class GeoSymAttributeExpressionProvider {
     ...
     * <p>
     * Parses the specified queue of logical expression components according to
     * the precendence rules specified in MIL-HDBK-857A, returning a reference
     * to a a live Expression which may be evaluated against any set of
     * attribute values.
     *
     * @param queue the queue of logical expression
     *
     * @return a live Expression which may be evaluated against any set of
     * attribute values.
     */

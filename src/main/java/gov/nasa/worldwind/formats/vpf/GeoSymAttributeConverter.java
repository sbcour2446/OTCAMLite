...
/**
 * The GeoSymAttributeConverter application converts GeoSym line attributes,
 * area attributes, and area patterns into a form usable by WorldWind VPF
 * shapes. Outputs to "gsac-out" a comma-separated-value (CSV) file containing
 * line and area attributes for VPF line and area shapes, and PNG images
 * containing area patterns for VPF area shapes.
 * <p>
 * GeoSymAttributeConverter is used to build the VPF symbol JAR file
 * <code>vpf-symbols.jar</code>. For instructions on how to build
 * <code>vpf-symbols.jar</code>, see the file <code>VPF_README.txt</code>, which
 * is distributed in each WorldWind release.
 * <p>
 ...
 *
 * @author dcollins
 * @version $Id: GeoSymAttributeConverter.java 1171 2013-02-11 21:45:02Z
 * dcollins $
 */

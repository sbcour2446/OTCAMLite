...
/**
 * DIGEST Part 2, Annex C.2.2.2.5 and C.2.3.6: <br>A database is a collection of
 * related libraries and additional tables. The library attribute table acts as
 * a table of contents for the database. Database information is contained in a
 * database header table. Database level data quality information can be
 * maintained in the data quality table.
 *
 * @author dcollins
...
public class VPFDatabase extends AVListImpl {
    ...
    /**
     * Constructs a VPF Database from a path to the Database Header table. This
     * initializes the Database Header Table and the Library Attribute Table.
     *
    ...
    /**
     * Returns the number of Libraries associated with this Database. If this
     * Database is not associated with any Library, this returns 0.
     *

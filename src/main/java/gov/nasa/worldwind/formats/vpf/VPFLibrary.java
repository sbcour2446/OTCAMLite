...
public class VPFLibrary extends AVListImpl {
    ...
    /**
     * Constructs a VPF Library from the specified VPF Database and library
     * name. This initializes the Library Header Table, the Coverage Attribute
     * Table, and the Geographic Reference Table.
     *
     * @param database the Database which the Library resides in.
     * @param name the Library's name.
     *
     * @return a new Library from the specified Database with the specified
     * name.
     *
     * @throws IllegalArgumentException if the database is null, or if the name
     * is null or empty.
     */
    ...
    /**
     * Returns the number of Coverages associated with this Library. If this
     * Library is not associated with any Coverage, this returns 0.
     *

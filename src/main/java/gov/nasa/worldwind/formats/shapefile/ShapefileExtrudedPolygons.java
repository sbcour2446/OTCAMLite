...
/**
 * @author dcollins
 * @version $Id: ShapefileExtrudedPolygons.java 2324 2014-09-17 20:25:35Z
 * dcollins $
 */
public class ShapefileExtrudedPolygons extends ShapefileRenderable implements OrderedRenderable {
    ...
    /**
     * Creates a new ShapefileExtrudedPolygons with the specified shapefile. The
     * normal attributes and the highlight attributes for each
     ...
     * attributes during construction, use {@link
    ...
    /**
     * Compute the intersections of a specified line with the geometry
     * corresponding to this shapefile's records. Each record's geometry is
     * created relative to the specified terrain rather than the terrain used
     * during rendering, which may be at lower level of detail than required for
     * accurate intersection determination.
     *
     * @param line the line to intersect.
     * @param terrain the {@link Terrain} to use when computing each record's
     * geometry.
     *
     * @return a list of intersections identifying where the line intersects
     * this shapefile's records, or null if the line does not intersect any
     * record.
     *

...
public class ShapefilePolylines extends ShapefileRenderable implements OrderedRenderable, PreRenderable {
    ...
    /**
     * Creates a new ShapefilePolylines with the specified shapefile. The normal
     ...
     * attributes during construction, use {@link #ShapefilePolylines(gov.nasa.worldwind.formats.shapefile.Shapefile,

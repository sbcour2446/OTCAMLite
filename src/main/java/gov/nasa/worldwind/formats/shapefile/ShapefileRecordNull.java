...
/**
 * Represents a Shapefile record with a <strong>null</strong> shape type. Null
 * shape records may have attributes but have no geometric data, and are
 * therefore typically used as placeholders.
 *
 * @author tag

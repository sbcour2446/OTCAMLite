...
public class NmeaTrackPoint implements TrackPoint {
     ...
     * @throws IllegalArgumentException if <code>words</code> is null or has
     * length less than 1
     */
     ...
     * @throws IllegalArgumentException if <code>latitude</code> is less than
     ...
     * @throws IllegalArgumentException if <code>longitude</code> is less than

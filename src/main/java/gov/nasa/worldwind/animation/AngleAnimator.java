 ...
 */
/**
 * Animates angles, via an interpolator. {@link #begin} and {@link #end} values
 * can be reset once the animation is already in motion.
 */
public class AngleAnimator extends BasicAnimator {
    ...
    protected Angle end;
    /**
     * The @link gov.nasa.worldwind.util.PropertyAccessor used to modify the
     * data value being animated.
     */
     ...
     * @param propertyAccessor The
     * {@link gov.nasa.worldwind.util.PropertyAccessor} used to modify the data
     * value being animated.
     */
    ...
    /**
     * Get the {@link gov.nasa.worldwind.util.PropertyAccessor} in use by this
     * animation
     *
     * @return the {@link gov.nasa.worldwind.util.PropertyAccessor} in use by
     * this animation
     */
     ...
     * {@link gov.nasa.worldwind.util.PropertyAccessor} using the passed
     * interpolant. This implementation just does a straight liner interpolation
     * between the {@link #begin} and {@link #end} values.
     *
     * @param interpolant the interpolant used to generate the next value that
     * will be set by the {@link gov.nasa.worldwind.util.PropertyAccessor}
     */

...
/**
 * A group of two or more {@link Animator}s. Can be used to animate more than
 * one value at a time, driven by a single {@link Interpolator}.
 *
 * @author jym
...
public class CompoundAnimator extends BasicAnimator {
     ...
     *
     * @param interpolator the {@link Interpolator} to use to drive the
     * animation.
     */
    ...
    /**
     * Construct a CompoundAnimator with the given {@link Interpolator}, and the
     * given {@link Animator}s.
     *
     * @param interpolator The {@link Interpolator} to use to drive the
     * {@link Animator}s
     * @param animators The {@link Animator}s that will be driven by this
     * {@link CompoundAnimator}
     */
     ...
     *
     * @param animators the {@link Animator}s to be driven by this
     * {@link CompoundAnimator}
     */
    ...
    /**
     * Set the values attached to each of the {@link Animator}s using the given
     * interpolant.
     *

...
public class AnimationSupport {
    ...
    /**
     * Calcualte a scaled time based on the great circle distance between two
     * points. The time is calulated by interpolating between the
     * <code>minLengthMillis</code> and the <code>maxLengthMillis</code> using
     * the ratio of the spherical distance between the given positions over 180
     * degrees.
     *
    ...
    /**
     * Calculate a scaled tiome based on the ratio of the angular distance
     * between the <code>begin</code> and <code>end</code> angles over the max
     * value.
     *
     ...
     * <code>beginZoom</code> and <code>endZoom</code> distances over the larger
     * of the beginZoom and endZoom.
     *

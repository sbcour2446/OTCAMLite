 ...
 */
/**
 * The <code>Animator</code> interface provides a way to iterate through a
 * series of values. It can be used with a simple interpolation function, or
 * something more elaborate. The <code>PropertyAccessor</code> class and its
...
public interface Animator {
     ...
     * next value to the property it is attached to.
     */
    void next();

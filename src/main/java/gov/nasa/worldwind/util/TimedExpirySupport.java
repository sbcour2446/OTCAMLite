...
/**
 * Handles expiration after some interval of time has passed. Expiration time is
 * computed as a random value between a specified minimum and a specified
...
public class TimedExpirySupport {
    ...
    /**
     * Constructs an instance with minimum expiry interval of 1 second and a max
     * of 2 seconds.
     */
    ...
    /**
     * Constructs an instance with specified minimum and maximum expiry
     * intervals. An interval is set to 0 if its specified value is less than 0.
     *
     * @param minExpiryTime the minimum interval allowed to pass before
     * expiration, in milliseconds.
     * @param maxExpiryTime the maximum interval allowed to pass before
     * expiration, in milliseconds.
     */
    ...
    /**
     * Indicates the current expiration time, which is a random value between
    ...
    /**
     * Sets the current expiration time to a specified value. This method
     * ignores the configured minimum and maximum expiry times.
     *
    ...
    /**
     * Specifies the minimum and maximum expiration intervals. An interval is
     * set to 0 if its specified value is less than 0.
     *
     * @param minExpiryTime the minimum interval allowed to pass before
     * expiration, in milliseconds.
     * @param maxExpiryTime the maximum interval allowed to pass before
     ...
     *
     * @return true if this timer has expired relative to the frame time,
     * otherwise false.
     *
     ...
     * Indicates whether this timer has expired.
     *
     * @param now the time to relate this timer's expiration time to. The timer
     * is considered expired if this timer's expiry time is less than this
     * value.
     *
     * @return true if this timer has expired relative to system time, otherwise
     * false.
     */

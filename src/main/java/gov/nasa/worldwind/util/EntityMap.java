...
public class EntityMap {
     ...
     *
     * @return the input string with all entities and references resolved. The
     * input string is returned as-is if it contains no entities or references.
     */
     ...
     *
     * @return The entity that was matched, or {@code null} if no entity could
     * be matched.
     */
     ...
     *
     * @return the Java equivalent of the input, or null if the input string
     * does not identify a known entity or character reference.
     */

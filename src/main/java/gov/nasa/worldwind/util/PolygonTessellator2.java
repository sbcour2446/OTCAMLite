...
/**
 * TODO: Combine these capabilities into PolygonTessellator with support for
 * pattern used by ShapefileExtrudedPolygons. TODO: Keep the combined class in
 * package gov.nasa.worldwind.util.
 *
 * @author dcollins
...
public class PolygonTessellator2 {
    ...
    /**
     * Computes a 4-bit code indicating the vertex's location in the 9 cell grid
     * defined by the clip bounds and the eight adjacent spaces defined by
     * extending the min/max boundaries to infinity.0 indicates that the vertex
     * is inside the clip bounds.
     *

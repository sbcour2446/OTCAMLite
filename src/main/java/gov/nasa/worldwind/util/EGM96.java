 ...
 * <p>
 * A file with the offset grid must be passed to the constructor. This file must
 * have 721 rows of 1440 2-byte integer values. Each row corresponding to a
 * latitude, with the first row corresponding to +90 degrees (90 North). The
 * integer values must be in centimeters.
 * <p>
 * Once constructed, the instance can be passed to
 * {@link gov.nasa.worldwind.globes.EllipsoidalGlobe#applyEGMA96Offsets(String)}
...
public class EGM96 {
     ...
     * See the class description above for a description of the file.

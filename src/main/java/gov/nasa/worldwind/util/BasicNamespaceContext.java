...
public class BasicNamespaceContext implements NamespaceContext {
    ...
    /**
     * Sole constructor for BasicNamespaceContext. This configures the following
     * namespaces:
    ...
    /**
     * Adds a namepsace binding to this XML namespace context. The specified URI
     * is bound to the specified prefix.
     *
     * @param prefix the namespace prefix.
     * @param namespaceURI the namespace URI.
     *
     * @throws IllegalArgumentException if either the prefix or the namepsace
     * URI are null.
     */

...
public class WWBufferUtil {
    ...
    /**
     * Allocates a new direct {@link java.nio.ByteBuffer} of the specified size,
     * in chars.
     *
    ...
    /**
     * Allocates a new direct {@link java.nio.ShortBuffer} of the specified
     * size, in chars.
     *
    ...
    /**
     * Allocates a new direct {@link java.nio.IntBuffer} of the specified size,
     * in chars.
     *
    ...
    /**
     * Allocates a new direct {@link java.nio.FloatBuffer} of the specified
     * size, in chars.
     *
    ...
    /**
     * Allocates a new direct {@link java.nio.DoubleBuffer} of the specified
     * size, in chars.
     *
    ...
    /**
     * Allocates a new direct {@link java.nio.CharBuffer} of the specified size,
     * in chars.
     *
    ...
    /**
     * Allocates a new {@link BufferWrapper} of the specified size, in bytes.
     * The BufferWrapper is backed by a Buffer of bytes.
     *
    ...
    /**
     * Allocates a new {@link BufferWrapper} of the specified size, in shorts.
     * The BufferWrapper is backed by a Buffer of shorts.
     *
     * @param size the new BufferWrapper's size.
     * @param allocateDirect true to allocate and return a direct buffer, false
     * to allocate and return a non-direct buffer.
    ...
    /**
     * Allocates a new {@link BufferWrapper} of the specified size, in ints. The
     * BufferWrapper is backed by a Buffer of ints.
     *
     * @param size the new BufferWrapper's size.
     * @param allocateDirect true to allocate and return a direct buffer, false
     * to allocate and return a non-direct buffer.
    ...
    /**
     * Allocates a new {@link BufferWrapper} of the specified size, in floats.
     * The BufferWrapper is backed by a Buffer of floats.
     *
     * @param size the new BufferWrapper's size.
     * @param allocateDirect true to allocate and return a direct buffer, false
     * to allocate and return a non-direct buffer.
    ...
    /**
     * Allocates a new {@link BufferWrapper} of the specified size, in doubles.
     * The BufferWrapper is backed by a Buffer of doubles.
     *
     * @param size the new BufferWrapper's size.
     * @param allocateDirect true to allocate and return a direct buffer, false
     * to allocate and return a non-direct buffer.
    ...
    /**
     * Returns a copy of the specified buffer, with the specified new size. The
     * new size must be greater than or equal to the specified buffer's size. If
     * the new size is greater than the specified buffer's size, this returns a
     * new buffer which is partially filled with the contents of the specified
     * buffer.The returned buffer is a direct ByteBuffer if and only if the
     * specified buffer is direct.
     *
     ...
     *
     * @throws IllegalArgumentException if the buffer is null, if the new size
     * is negative, or if the new size is less than the buffer's remaing
     * elements.
     */
     ...
     * the new size is greater than the specified buffer's size, this returns a
     * new buffer which is partially filled with the contents of the specified
     * buffer. The returned buffer is a backed by a direct ByteBuffer if and
     * only if the specified buffer is direct.
     *
     * @param buffer the buffer to copy.
     ...
     * the new size is greater than the specified buffer's size, this returns a
     * new buffer which is partially filled with the contents of the specified
     * buffer.The returned buffer is a backed by a direct ByteBuffer if and only
     * if the specified buffer is direct.
     *
     * @param buffer the buffer to copy.
    ...
    /**
     * Returns the size in bytes of the specified primitive data type, or -1 if
     * the specified type is unrecognized. Recognized primitive types are as
     * follows: <ul> <li>{@link gov.nasa.worldwind.avlist.AVKey#INT8} <li>{@link
     * gov.nasa.worldwind.avlist.AVKey#INT16}
     * <li>{@link gov.nasa.worldwind.avlist.AVKey#INT32} <li>{@link
     * gov.nasa.worldwind.avlist.AVKey#FLOAT32}
     * <li>{@link gov.nasa.worldwind.avlist.AVKey#FLOAT64} </ul>
     *
    ...
    /**
     * Returns the minimum and maximum floating point values in the specified
     * buffer. Values equivalent to the specified <code>missingDataSignal</code>
     ...
     * @param missingDataSignal the number indicating a specific floating point
     * value to ignore.
     *
     * @return an array containing the minimum value in index 0 and the maximum
     * value in index 1, or null if the buffer is empty or contains only missing
     * values.
     *
    ...
    /**
     * Returns the minimum and maximum floating point values in the specified
     * buffer. Values equivalent to <code>Double.NaN</code> are ignored. This
     * returns null if the buffer is empty or contains only NaN values.
     *
     * @param buffer the buffer to search for the minimum and maximum values.
     *
     * @return an array containing the minimum value in index 0 and the maximum
     * value in index 1, or null if the buffer is empty or contains only NaN
     * values.
     *
     * @throws IllegalArgumentException if the buffer is null.
     */
    ...
    /**
     * Copies a specified array of vertices to a specified vertex buffer. This
     * method calls {@link
     * java.nio.FloatBuffer#flip()} prior to returning.
     *
     * @param array the vertices to copy.
     * @param buffer the buffer to copy the vertices to. Must have enough
     * remaining space to hold the vertices.
     *

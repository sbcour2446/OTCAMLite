...
/**
 * This class of static methods provides the interface to logging for WorldWind
 * components. Logging is performed via {@link java.util.logging.Logger}. The
 * default logger name is <code>gov.nasa.worldwind</code>. The logger name is
...
public class Logging {
    ...
    /**
     * Returns a specific logger. Does not access
     * {@link gov.nasa.worldwind.Configuration} to determine the configured
     * WorldWind logger.
     * <p>
     * This is needed by {@link gov.nasa.worldwind.Configuration} to avoid calls
     * back into itself when its singleton instance is not yet instantiated.
     *
    ...
    /**
     * Retrieves a message from the WorldWind message resource bundle formatted
     * with a single argument. The argument is inserted into the message via
     * {@link java.text.MessageFormat}.
     *
     * @param property the property identifying which message to retrieve.
     * @param arg the single argument referenced by the format string identified
     * <code>property</code>.
     *
     ...
     *
     * @param property the property identifying which message to retrieve.
     * @param args the arguments referenced by the format string identified
     * <code>property</code>.
     *
    ...
    /**
     * Indicates the maximum number of times the same log message should be
     * repeated when generated in the same context, such as within a loop over
     * renderables when operations in the loop consistently fail.
     *

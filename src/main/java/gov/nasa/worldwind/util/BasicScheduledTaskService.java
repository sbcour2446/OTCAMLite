 ...
 *
 * @author pabercrombie
 * @version $Id: BasicScheduledTaskService.java 1171 2013-02-11 21:45:02Z
 * dcollins $
 */
public class BasicScheduledTaskService extends WWObjectImpl
    ...
    /**
     * Create a new scheduled task service. The thread pool size is from the
     * WorldWind configuration file property {@link AVKey#TASK_POOL_SIZE}.
     */

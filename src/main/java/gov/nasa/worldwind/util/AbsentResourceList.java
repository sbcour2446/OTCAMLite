...
/**
 * Maintains a list of missing resources. Once added, a resource is considered
 * absent until a specified time interval elapses. If marked absent a specified
 * number of times, the resource is considered permanently absent until a second
 * time interval expires -- the try-again interval -- at which time the resource
 * is considered not absent, indicating that the caller may attempt to find the
 * resource again. If the resource is subsequently marked absent, the cycle
 * repeats.
 *
 * @author tag
...
public class AbsentResourceList {
    ...
    /**
     * The default number of times a resource is marked as absent before being
     * marked as permanently absent.
     */
    protected static final int DEFAULT_MAX_ABSENT_RESOURCE_TRIES = 3;
    /**
     * The default interval to wait before indicating the resource is not
     * absent.
     */
    protected static final int DEFAULT_MIN_ABSENT_RESOURCE_CHECK_INTERVAL = 10000;
    /**
     * The default interval at which a resources is marked as not absent after
     * having been marked permanently absent.
     */
    protected static final int DEFAULT_TRY_AGAIN_INTERVAL = (int) 60e3; // seconds

    /**
     * The maximum number of times a resource is marked as absent before being
     * marked as permanently absent.
     */
    protected int maxTries = DEFAULT_MAX_ABSENT_RESOURCE_TRIES;
    /**
     * The interval to wait, in milliseconds, before indicating the resource is
     * not absent.
     */
    protected int minCheckInterval = DEFAULT_MIN_ABSENT_RESOURCE_CHECK_INTERVAL;
    /**
     * The interval at which a resource is marked as not absent after having
     * been marked as permanently absent.
     */
    ...
    protected static class AbsentResourceEntry {
        ...
        /**
         * The maximum number of times the resource is marked as absent beyond
         * which the resource is considered permanently absent.
         */
        int numTries;
    }
    ...
    /**
     * Construct an absent-resource list with default values for max tries (3),
     * check interval (10 seconds) and try-again interval (60 seconds).
     */
    public AbsentResourceList() {
    }

    /**
     * Construct an absent-resource list with a specified number of maximum
     * tries and a check interval.
     *
     * @param maxTries the number of max tries. Must be greater than 0.
     * @param minCheckInterval the check interval. Must be greater than or equal
     * to 0.
     *
     * @throws IllegalArgumentException if max-tries is less than 1 or the
     * minimum check interval is less than 0.
     */
    ...
    /**
     * Construct an absent-resource list with a specified number of maximum
     * tries, a check interval and a retry interval.
     *
     * @param cacheSize the maximum number of absent resources the list may
     * hold. If this limit is exceeded, the oldest entries in the list are
     * ejected and the resources they refer to are subsequently not considered
     * to be absent resources.
     * @param maxTries the number of max tries. Must be greater than 0.
     * @param minCheckInterval the check interval. Must be greater than or equal
     * to 0.
     * @param tryAgainInterval the try-again interval. Must be greater than or
     * equal to 0.
     *
     * @throws IllegalArgumentException if max-tries is less than 1 or if either
     * the minimum check interval or try-again interval is less than 0.
     */
    ...
    /**
     * Indicates the maximum number of times a resource is marked as absent
     * before being marked as permanently absent.
     *
    ...
    /**
     * Specifies the maximum number of times a resource is marked as absent
     * before being marked as permanently absent.
     *
     * @param maxTries the number of max tries. Must be greater than 0.
     *
    ...
    /**
     * Indicates the time interval that must elapse before the resource is
     * considered not absent if its max-tries has not been reached.
     *
    ...
    /**
     * Specifies the time interval that must elapse before the resource is
     * considered absent if its max-tries has not been reached.
     *
     * @param minCheckInterval the check interval. Must be greater than or equal
     * to 0.
     *
     * @throws IllegalArgumentException if the minimum check interval is less
     * than 0.
     */
    ...
    /**
     * Indicates the time interval that must elapse before a resource marked as
     * permanently absent is again considered not absent. This effectively
     * expires the absent state of the resource.
     *
     * @return the interval, in milliseconds.
     */
    ...
    /**
     * Specifies the time interval that must elapse before a resource marked as
     * permanently absent is again considered not absent. This effectively
     * expires the absent state of the resource.
     *
     * @param tryAgainInterval the try-again interval. Must be greater than or
     * equal to 0.
     *
     * @throws IllegalArgumentException if the try-again interval is less than
     * 0.
     */
    ...
    /**
     * Mark a specified resource as absent. If the resource is already marked as
     * absent, its max-tries value is incremented.
     *
    ...
    /**
     * Mark the resource as not-absent, effectively removing it from this
    ...
    /**
     * Remove a resource from this absent-resource list if the resource is

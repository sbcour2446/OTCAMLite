...
public class ElevationsUtil {
    ...
    /**
     * Checks if the <code>value</code> is one of the well-known "nodata" value
     * used in digital elevation model files to specify missing areas / voids.
     *
     * @param value a value to check
     * @return <code>TRUE</code>, if the value is one of the well known "nodata"
     * values
     *
     */
    ...
    /**
     * Rectify elevation raster. For best performance each elevation raster must
     * have correct parameters and values set. The <code>rectify()</code>
     * operation validates that correct Elevation min and max values are set or
     * calculated. All values that beyond min/max and voids, must be marked with
     * "Missing Signal" (aka "nodata" value).
     *

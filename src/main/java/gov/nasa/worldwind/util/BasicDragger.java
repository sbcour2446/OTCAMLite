...
/**
 * Interprets mouse input via the {@link DragSelectEvent} for notifying picked
 * objects implementing the {@link Draggable} interface. This version uses the
 * {@link Draggable} interface for dragging but retains the original behavior of
 * the BasicDragger when the {@link gov.nasa.worldwind.pick.PickedObject}
 * implements either the {@link Movable} or {@link Movable2} interface.
 * <p>
 * For objects not yet implementing the {@link Draggable} interface the legacy
 * dragging functionality will be used.
 */
public class BasicDragger implements SelectListener {

    /**
     * The {@link WorldWindow} this dragger will utilize for the
     * {@link Globe}, {@link View}, and {@link SceneController} objects.
     */
    ...
    /**
     * The {@link DragContext} for dragging operations. Initialized on
     * {@link AVKey#DRAG_BEGIN}.
     */
    protected DragContext dragContext;

    /**
     * Creates a dragging controller which converts {@link SelectEvent}s to the
     * {@link Draggable} interface.
     *
     * @param wwd the {@link WorldWindow} this drag controller should be
     * associated with.
     *
     * @throws IllegalArgumentException if the provided {@link WorldWindow} is
     * null.
     */
    ...
    /**
     * Ignores the useTerrain argument as it has been deprecated and utilizes
     * the single parameter constructor.
     *
     * @param wwd The world window.
     * @param useTerrain Unused.
     * @deprecated the useTerrain property has been deprecated in favor of the
     * {@link Draggable} interface which allows the object to define the drag
     * behavior.
     */
    @Deprecated
     ...
     * @deprecated the {@link Draggable} provides the object being dragged
     ...
     * @param useTerrain Unused.
     *
     * @deprecated definition of dragging behavior now defined by the object in
     * the {@link Draggable} interface.
     */
    @Deprecated
     ...
     *
     * @param dragEvent the {@link DragContext} to deliver to the selected
     * object.
     *

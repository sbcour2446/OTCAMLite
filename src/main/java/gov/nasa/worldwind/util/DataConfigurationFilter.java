...
/**
 * An implementation of {@link FileStoreFilter} which accepts XML configuration
 * documents. Accepted document types are:
 * <ul> <li>Layer configuration documents</li> <li>ElevationModel configuration
 * documents</li> <li>Installed data configuration documents</li> <li>WorldWind
 * .NET LevelSet documents</li> </ul>
 *
 * @author dcollins
...
public class DataConfigurationFilter implements java.io.FileFilter, FileStoreFilter {
    ...
    /**
     * Returns true if the specified file can be opened as an XML document, and
     * calling {@link
    ...
    /**
     * Returns true if the specified {@link java.net.URL} can be opened as an
     * XML document, and calling {@link
     * #accept(org.w3c.dom.Document)} returns true.
     *
    ...
    /**
     * Returns true if the specified {@link java.io.InputStream} can be opened
     * as an XML document, and calling {@link
     * #accept(org.w3c.dom.Document)} returns true.
     *
    ...
    /**
     * Returns true if the specified file store path can be opened as an XML
     * document, and calling {@link
     * #accept(org.w3c.dom.Document)} returns true.
     *
     ...
     *
     * @throws IllegalArgumentException if either the file store or the file
     * name are null.
     */
    ...
    /**
     * Returns true if the specified DOM Document should be accepted as a
    ...
    /**
     * Returns true if the specified DOM {@link org.w3c.dom.Element} should be
     * accepted as a configuration document.
     *

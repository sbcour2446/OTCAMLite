...
public class WWUtil {
    ...
    /**
     * Converts a specified string to an integer value. Returns null if the
     * string cannot be converted.
     *
     * @param s the string to convert.
     *
     * @return integer value of the string, or null if the string cannot be
     * converted.
     *
    ...
    /**
     * Converts a specified string to a floating point value. Returns null if
     * the string cannot be converted.
     *
     * @param s the string to convert.
     *
     * @return floating point value of the string, or null if the string cannot
     * be converted.
     *
     * @throws IllegalArgumentException if the string is null.
     */
    ...
    /**
     * Converts a specified string to a long integer value. Returns null if the
     * string cannot be converted.
     *
     * @param s the string to convert.
     *
     * @return long integer value of the string, or null if the string cannot be
     * converted.
     *
     * @throws IllegalArgumentException if the string is null.
     */
    ...
    /**
     * Converts a specified string to a boolean value. Returns null if the
     * string cannot be converted.
     *
     * @param s the string to convert.
     *
     * @return boolean value of the string, or null if the string cannot be
     * converted.
     *
     * @throws IllegalArgumentException if the string is null.
     */
    ...
    /**
     * Parses a string to an integer value if the string can be parsed as a
     * integer. Does not log a message if the string can not be parsed as an
     * integer.
     *
     * @param s the string to parse.
     *
     * @return the integer value parsed from the string, or null if the string
     ...
     * Does not log a message if the string can not be parsed as a long.
     *
     * @param s the string to parse.
     *
     * @return the long value parsed from the string, or null if the string
    ...
    /**
     * Parses a string to a double value using the current locale if the string
     * can be parsed as a double. Does not log a message if the string can not
     * be parsed as a double.
     *
     * @param s the string to parse.
     *
     * @return the double value parsed from the string, or null if the string
    ...
    /**
     * Parses a string to a double value if the string can be parsed as a
     * double. Does not log a message if the string can not be parsed as a
     * double.
     *
     * @param s the string to parse.
     *
    ...
    /**
     * Returns a sub sequence of the specified {@link CharSequence}, with
     * leading and trailing whitespace omitted. If the CharSequence has length
     * zero, this returns a reference to the CharSequence. If the CharSequence
     * represents and empty character sequence, this returns an empty
     * CharSequence.
     *
     ...
     * use is white.
     *
     * @param color the color to generate a random color from. If null, the
     * color white (0x000000aa) is used.
     *
     ...
     * @param color the color to generate a random color from. If null, the
     * color white (0x000000aa) is used.
     * @param darkestColor the darkest color allowed. If any of the generated
     * color's components are less than the corresponding component in this
     * color, new colors are generated until one satisfies this requirement, up
     * to the specified maximum number of attempts.
     * @param maxAttempts the maximum number of attempts to create a color
     * lighter than the specified darkestColor. If this limit is reached, the
     * last color generated is returned.
     *
     * @return a new color with random red, green and blue components.
     */
    ...
    /**
     * Returns the component-wise linear interpolation of <code>color1</code>
     * and <code>color2</code>. Each of the RGBA components in the colors are
     * interpolated according to the function: <code>(1 - amount) * c1 + amount *
     * c2</code>, where c1 and c2 are components of <code>color1</code> and
     * <code>color2</code>, respectively. The interpolation factor
     ...
     *
     * @return this returns the linear interpolation of <code>color1</code> and
     * <code>color2</code> if &lt;amount&gt; is between 0 and 1, a color
     * equivalent to color1 if <code>amount</code> is 0 or less, or a color
     * equivalent to <code>color2</code> if <code>amount</code> is 1 or more.
     *
     * @throws IllegalArgumentException if either <code>color1</code> or
     * <code>color2</code> are <code>null</code>.
     */
    ...
    /**
     * Creates a hexadecimal string representation of a {@link Color} in the
     * form 0xrrggbbaa.
     *
    ...
    /**
     * Decodes a hexadecimal string in the form <i>rrggbbaa</i>, <i>rrggbbaa</i>
     * or <i>#rrggbbaa</i> to a color.
     *
    ...
    /**
     * Decodes a hexadecimal string in the form <i>aabbggrr</i>,
     * <i>0xaabbggrr</i> or <i>#aabbggrr</i> to a color.
     *
     * @param encodedString String to decode.
     *
     * @return the decoded color, or null if the string cannot be decoded.
    ...
    /**
     * Determine whether an object reference is null or a reference to an empty
     * string.
     *
    ...
    /**
     * Creates a two-element array of default min and max values, typically used
     * to initialize extreme values searches.
     *
     * @return a two-element array of extreme values. Entry 0 is the maximum
     * double value; entry 1 is the negative of the maximum double value;
     */
    ...
    /**
     * Converts the specified buffer of UTM tuples to geographic coordinates,
     * according to the specified UTM zone and hemisphere. The buffer must be
     * organized as pairs of tightly packed UTM tuples in the order <code>(easting,
     * northing)</code>. Each UTM tuple is replaced with its corresponding
     * geographic location in the order <code>(longitude, latitude)</code>.
     * Geographic locations are expressed in degrees. Tuples are replaced
     * starting at the buffer's position and ending at its limit.
     *
     ...
     * range 1-60, if <code>hemisphere</code> is null, if
     * <code>hemisphere</code> is not one of
     * {@link gov.nasa.worldwind.avlist.AVKey#NORTH} or
     * {@link gov.nasa.worldwind.avlist.AVKey#SOUTH}, if <code>buffer</code> is
     * null, or if the number of remaining elements in <code>buffer</code> is
    ...
    /**
     * Normalizes the specified buffer of geographic tuples. The buffer must be
     * organized as pairs of tightly packed geographic tuples in the order
     * <code>(longitude, latitude)</code>. Each geographic tuple is normalized
     * to the range +-90 latitude and +-180 longitude and replaced with its
     * normalized values. Geographic locations are expressed in degrees. Tuples
     * are replaced starting at the buffer's position and ending at its limit.
     *
     * @param buffer the buffer of geographic tuples to convert.
     *
     * @throws IllegalArgumentException if <code>buffer</code> is null, or if
     * the number of remaining elements in <code>buffer</code> is not a multiple
     * of two.
     */
    ...
    /**
     * Uses reflection to invoke a <i>set</i> method for a specified property.
     * The specified class must have a method named "set" + propertyName, with
     * either a single <code>String</code> argument, a single
     * <code>double</code> argument, a single <code>int</code> argument or a
     * single <code>long</code> argument. If it does, the method is called with
     * the specified property value argument.
     *
     * @param parent the object on which to set the property.
     * @param propertyName the name of the property.
     * @param propertyValue the value to give the property. Specify double, int
     * and long values in a <code>String</code>.
     *
     * @return the return value of the <i>set</i> method, or null if the method
     * has no return value.
     *
     * @throws IllegalArgumentException if the parent object or the property
     * name is null.
     * @throws NoSuchMethodException if no <i>set</i> method exists for the
     * property name.
     * @throws InvocationTargetException if the <i>set</i> method throws an
     * exception.
     * @throws IllegalAccessException if the <i>set</i> method is inaccessible
    ...
    /**
     * Copies only values of the specified <code>keys</code >from
     * <code>srcList</code> to another <code>destList</code>. The
     * <code>forceOverwrite</code> controls what to do if the destination list
     * already contains values for specified <code>keys</code >. If
     * <code>forceOverwrite</code> is set to true, the existing value wills be
     * overwritten.
     *
     * @param srcList The source list. May not be <code>null</code>.
     * @param destList The destination list. May not be <code>null</code>.
     * @param forceOverwrite Allow overwrite existing values in the destination
     * list
    ...
    /**
     * Eliminates all white space in a specified string. (Applies the regular
     * expression "\\s+".)
     *
     * @param inputString the string to remove white space from.
     *
     * @return the string with white space eliminated, or null if the input
     * string is null.
     */
    ...
    /**
     * Strips leading period from a string (Example: input -&gt; ".ext", output
     * -&gt; "ext")
     *
    ...
    /**
     * Parse a date/time string and return its equivalent in milliseconds (using
     * same time coordinate system as System.currentTimeMillis()). The following
     * formats are recognized and conform to those defined in KML version 2.2:
     * "1997", "1997-07", "1997-07-16", "1997-07-16T07:30:15Z",
     * "1997-07-16T07:30:15+03:00" and "1997-07-16T07:30:15+0300".
     *
     * @param timeString the date/time string to parse.
     *
     * @return the number of milliseconds since 00:00:00 1970 indicated by the
     * date/time string, or null if the input string is null or the string is
    ...
    /**
     * Compares two version strings, e.g., 1.3.0, and returns 0 if they match,
     * -1 if the first string is less than the second, and 1 if the first string
     * is greater than the second. The strings can be arbitrary length but the
     * components must be separated by ".". A missing component maps to 0, e.g.
     * 1.3 will match 1.3.0.
     *
     * @param va the first version string
     * @param vb the second version string
     *
     * @return -1 if the first string is less than the second, 0 if the strings
     * match, 1 if the first string is greater than the second string.
     */
     ...
     * @param indices the indices identifying the triangle strip from the
     * specified vertices.
     * @param normals a buffer to accept the output normals. The buffer must be
     * allocated and all its values must be initialized to 0. The buffer's size
     * limit must be at least as large as that of the specified vertex buffer.
     *
     * @throws IllegalArgumentException if any of the specified buffers are null
     * or the limit of the normal buffer is less than that of the vertex buffer.
     */

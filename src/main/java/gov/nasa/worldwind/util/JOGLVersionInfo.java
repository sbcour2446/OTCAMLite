 ...
 * Bindings for OpenGL (R) implementation found in the CLASSPATH. This
 * information is also found in the manifest for jogl-all.jar, and this program
 * uses the java.lang.Package class to retrieve it programmatically.
 *

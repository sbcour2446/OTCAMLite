...
public class Range {
     ...
     * @param length The number of items in the range. May be 0 to indicate an
     * empty range.
     */
    ...
    /**
     * Returns a boolean value indicating whether or not the specified location
     * is in this range. The location is in this range if it's greater than or
     * equal to <code>this.location</code> and less than <code>this.location +
     * this.length</code>.
     *

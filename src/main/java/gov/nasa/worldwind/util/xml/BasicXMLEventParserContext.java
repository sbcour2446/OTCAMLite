 ...
 * {@link gov.nasa.worldwind.util.xml.XMLEventParserContext}. This class is
 * meant to be the base class for schema-specific parsers.
 *
 * @author tag
 * @version $Id: BasicXMLEventParserContext.java 1981 2014-05-08 03:59:04Z
 * tgaskins $
 */
public class BasicXMLEventParserContext extends AVListImpl implements XMLEventParserContext {
    ...
    /**
     * Construct an instance. Invokes {@link #initializeParsers()} and
     * {@link #initialize()}.
     */
    ...
    /**
     * Construct an instance for a specified event reader. Invokes
     * {@link #initializeParsers()} and {@link
     * #initialize()}.
     *
     ...
     * Invokes {@link #initializeParsers()} and {@link #initialize()}.
     *
     * @param eventReader the event reader to use for XML parsing.
    ...
    /**
     * Initializes the parser table with the default parsers for the strings,
     * integers, etc., qualified for the default namespace.
     */
     ...
     * gov.nasa.worldwind.util.xml.UnrecognizedXMLEventParser}, and may be
     * replaced by calling {@link
     * #registerParser(javax.xml.namespace.QName, XMLEventParser)} and

...
/**
 * @author tag
 * @version $Id: StringListXMLEventParser.java 2061 2014-06-19 19:59:40Z
 * tgaskins $
 */
public class StringListXMLEventParser extends AbstractXMLEventParser implements Iterable<String> {
    ...
    /**
     * Create a parser. All sub-elements of a specified name are parsed as
     * strings and retained.
     *
     * @param namespaceURI the namespace URI to attach to this parser. May be
     * null.

...
public class MeasureToolController extends MouseAdapter
    ...
    /**
     * Set the <code>MeasureTool</code> that this controller will be operating
     * on.
     *
     * @param measureTool the <code>MeasureTool</code> that this controller will
     * be operating on.
     */
     ...
     *
     * @return the <code>MeasureTool</code> that this controller is operating
     * on.
     */
    ...
    /**
     * Returns true if this controller is using rubber band during shape
     * creation. When using rubber band, new control points are added by first
     * pressing the left mouse button, then dragging the mouse toward the proper
     * position, then releasing the mouse button. Otherwise new control point
     * are added for each new click of the mouse.
     *
     * @return true if this controller is using rubber band during shape
     * creation.
     */
     ...
     * When using rubber band, new control points are added by first pressing
     * the left mouse button, then dragging the mouse toward the proper
     * position, then releasing the mouse button. Otherwise new control point
     * are added for each new click of the mouse.
     *
     * @param state true if this controller should use rubber band during shape
     * creation.
     */
     ...
     * while using rubber band mode.
     *
     * @return true if free hand drawing of path and polygons in rubber band
     * mode.
     */
    ...
    /**
     * Set whether this controller allows free hand drawing of path and polygons
     * while using rubber band mode.
     *
     * @param state true to allow free hand drawing of path and polygons in
     * rubber band mode.
     */
    ...
    /**
     * Get the minimum distance in meters between two control points for free
     * hand drawing.
     *
     * @return the minimum distance in meters between two control points for
     * free hand drawing.
     */
    ...
    /**
     * Set the minimum distance in meters between two control points for free
     * hand drawing.
     *
     * @param distance the minimum distance in meters between two control points
    ...
    /**
     * Returns true if the controller is in the middle of a rubber band
     * operation.
     *
     * @return true if the controller is in the middle of a rubber band
     * operation.
     */

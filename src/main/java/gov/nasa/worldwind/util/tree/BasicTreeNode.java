...
public class BasicTreeNode extends WWObjectImpl implements TreeNode {
    ...
    /**
     * Flag to indicate that any part of the sub-tree rooted at this node is
     * selected. This value is computed on demand and cached.
     */
     ...
     *
     * @param text Node text.
     * @param imageSource Image source for the node icon. May be a String, URL,
     * or BufferedImage.
     */
     ...
     * not in memory this method will request that it be loaded.
     */

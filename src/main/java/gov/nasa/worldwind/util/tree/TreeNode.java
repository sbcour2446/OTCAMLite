...
/**
 * Describes a node in a {@link Tree}. A node must have a string of text. It may
 * also have an icon.
 *
 * @author pabercrombie
...
public interface TreeNode extends WWObject {
    ...
    /**
     * Set the node description. The description can hold any extra text
    ...
    /**
     * Get the node's parent. Each node in the tree has a parent, except for the
     * root node. The parent of the root node is {@code null}.
     *
     ...
     *
     * @return Child nodes, or an empty iterator if the node does not have
     * children.
     *
    ...
    /**
     * Set the node to enabled or not enabled. A node that is not enabled will
     ...
     *
     * @return
     * {@link #SELECTED}, {@link #NOT_SELECTED}, {@link #PARTIALLY_SELECTED}.
     */
    ...
    /**
     * Set the node to visible or not visible. If the node is not visible it
     * will not be drawn by the tree layout.
     *
     ...
     * greater than the number of children already in the list.
     */
     ...
     *
     * @return Image source of the icon. {@code null} if the node does not have
     * an icon.
     */
     ...
     * Set the node's icon.
     *
     * @param imageSource New icon source. May be a String, URL, or
     * BufferedImage.
     */
    void setImageSource(Object imageSource);

    /**
     * Does this node have an icon? This method returns true if an image source
     * has been set. The method returns true even if the image has not been
     * fully loaded.
     *

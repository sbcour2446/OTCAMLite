...
/**
 * A path to a node in a {@link Tree}. The path is expressed as a list of
 * strings.
 *
 * @author tag
...
public class TreePath extends ArrayList<String> {
    ...
    /**
     * Retrieves the a sub-section of this path from the first element to the
     * second to last element.
     *
     * @return a new TreePath that contains the entries in this path, excluding
     * the final entry.
     */
     ...
     *
     * @return A new path made up of path elements between {@code start} and
     * {@code end}.
     */
     ...
     *
     * @return {@code true} if {@code path} contains no entries, {@code path} is
     * {@code null}, or if the first entry of {@code path} is {@code null} or an
     * empty string.
     */

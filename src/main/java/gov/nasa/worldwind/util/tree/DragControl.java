...
public abstract class DragControl extends TreeHotSpot {
     ...
     *
     * @param parent The screen area that contains this drag control. Input
     * events that cannot be handled by this object will be passed to the
     * parent. May be null.
     */
     ...
     * {@link #endDrag} as appropriate. Subclasses may override this method if
     * they need to handle events other than drag events.
     *
    ...
    /**
     * Called when a drag begins. This implementation saves the first drag point
     * to {@link #dragRefPoint}.
     *

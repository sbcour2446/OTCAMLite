...
public interface FrameAttributes {
    ...
    /**
     * Returns a new FrameAttributes instance of the same type as this
     * FrameAttributes, who's properties are configured exactly as this
     * FrameAttributes.
     *
    ...
    /**
     * Copies the specified FrameAttributes' properties into this object's
     * properties. This does nothing if the specified attributes is null.
     *
    ...
    /**
     * Get the amount of space, in pixels, to leave between an icon in the frame
     * and surrounding text and shapes.
     *
    ...
    /**
     * Set the amount of space, in pixels, to leave between an icon in the frame
     * and surrounding text and shapes.
     *
     ...
     *
     * @return Two element array containing the colors in the background
     * gradient.
     *
     ...
     *
     * @return Two element array containing the colors in the title bar
     * gradient.
     *
     ...
     *
     * @return Two element array containing the colors in the scroll bar
     * gradient.
     *
    ...
    /**
     * Get the color of the minimize button drawn in the upper right corner of
     * the frame.
     *
    ...
    /**
     * Set the color of the minimize button drawn in the upper right corner of
     * the frame.
     *
    ...
    /**
     * Get the radius of the frame corners. A value of {@code zero} means square
     * corners.
     *
     ...
     *
     * @param cornerRadius New radius, in pixels. A value of {@code zero} means
     * square corners.
     */

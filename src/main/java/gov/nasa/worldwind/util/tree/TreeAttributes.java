...
/**
 * Attributes to control how a {@link Tree} is rendered. The class captures a
 * set of attributes found in a typical tree layout, but some layouts may not
 * use all of these properties.
 *
 * @author pabercrombie
...
public interface TreeAttributes {
    ...
    /**
     * Returns a new TreeAttributes instance of the same type as this
     * TreeAttributes, who's properties are configured exactly as this
     * TreeAttributes.
     *
    ...
    /**
     * Copies the specified TreeAttributes' properties into this object's
     ...
     * The checkboxes are drawn as a gradient of two colors.
     *
     * @return two element array of the colors that make up the checkbox
     * gradient.
     */
    ...
    /**
     * Get the size of each icon in the tree. If the icon images do not match
     * this size, they will be scaled to fit.
     *
     * @return Icon size.
     *
    ...
    /**
     * Get the amount of space, in pixels, to leave between an icon in the tree
    ...
    /**
     * Set the amount of space, in pixels, to leave between an icon in the tree
     * and surrounding text and shapes.
     *

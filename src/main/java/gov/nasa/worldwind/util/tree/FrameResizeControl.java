...
/**
 * A screen control for resizing a frame. This class handles the resize input
 * events, but does does not actually draw the resize control.
 *
 * @author pabercrombie
...
public class FrameResizeControl extends AbstractResizeHotSpot {
    ...
    /**
     * Forwards mouse wheel events to the frame, so that the contents can be
     * scrolled when the mouse is over the resize area.
     *

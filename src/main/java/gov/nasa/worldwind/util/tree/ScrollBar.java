...
/**
 * A scrollbar component. The scrollable range is defined by four values: min,
 * max, value, and extent. {@code value} is the current position of the scroll
 * bar. {@code extent} represents the visible region. The four values must
 * always satisfy this relationship:
 * <pre>
...
public class ScrollBar implements Renderable {
    ...
    /**
     * The minimum size of the scroll knob. The size of the knob will adjust to
     * the scroll extent, but will never get smaller than this size. This
     * prevents the knob from shrinking to a single pixels if the scroll range
     * is very large.
     */
    ...
    /**
     * Bounds of the scroll track part of the scroll bar. This is the region in
     * which the scroll knob moves, and excludes the scroll up and down arrows.
     */
    ...
    /**
     * Scroll bar orientation, either {@link AVKey#HORIZONTAL} or
     * {@link AVKey#VERTICAL}.
     */
    ...
    /**
     * Delay in milliseconds between each step in auto-scroll operation is
     * effect. When auto-scrolling the bar will scroll by the
     * {@link #autoScrollIncrement} every {@code autoScrollDelay} milliseconds.
     */
    protected int autoScrollDelay = DEFAULT_AUTO_SCROLL_DELAY;
    /**
     * Indicates whether an auto-scroll operation is active (such as when the
     * user has clicked and held the mouse on the scroll arrow).
     */
    protected boolean autoScrolling;
    /**
     * The amount and direction that the bar scrolls while auto-scrolling. One
     * of {@link #UNIT_UP}, {@link #UNIT_DOWN},
     ...
     *
     * @param parent The screen component that contains the scroll bar. Input
     * events that cannot be handled by the scroll bar will be passed to this
     ...
     *
     * @param orientation Either {@link AVKey#VERTICAL} or
     * {@link AVKey#HORIZONTAL}.
     * @param parent The screen component that contains the scroll bar. Input
     * events that cannot be handled by the scroll bar will be passed to this
     * component. May be null.
     */
     ...
     *
     * @return Current value. The value is clamped to the range [minValue :
     * maxValue - extent].
     */
    public int getValue() {
        return this.value;
    ...
    /**
     * Set the value of the scroll bar. The value is clamped to the range
    ...
    /**
     * Get the unit increment. This is the amount that the scroll bar scrolls by
     * when one of the arrow controls is clicked.
     *
    ...
    /**
     * Get the block increment. This is the amount that the scroll bar scrolls
     * by when the bar is clicked above or below the knob.
     *
     * @return The block increment. This implementation returns the extent, so
     * the scroll bar will adjust by a full visible page.
     */
     ...
     *
     * @return The scroll bar orientation, either {@link AVKey#VERTICAL} or
     * {@link AVKey#HORIZONTAL}.
     */
     ...
     *
     * @param orientation The scroll bar orientation, either
    ...
    /**
     * Get the extent. The extent the amount of the scrollable region that is
     * visible.
     *
     * @return The extent.
     *
    ...
    /**
     * Set the extent. The extent the amount of the scrollable region that is
     * visible. This method may change the value of the scroll bar to maintain
     * the relationship:
     * <pre>
     *   min &lt;= value &lt;= value + extent &lt;= max
     * </pre>
     *
     * @param extent New extent. If {@code extent} is greater than the range of
     * the scroll bar (max - min), then the extent will be set to the maximum
     * valid value.
     *
     * @see #getExtent()
     */
    ...
    /**
     * Get the height of the scroll arrow controls at the top and bottom of the
     * scroll bar.
     *
    ...
    /**
     * Get the color used to draw the lines of the scroll bar boundary and the
     * scroll arrows.
     *
    ...
    /**
     * Set the color of the lines of the scroll bar boundary. This color is also
     * used for the arrows in the scroll controls.
     *
    ...
    /**
     * Set the color of scroll knob. The knob is drawn with a gradient made up
     * of two colors.
     *
    ...
    /**
     * Get the color of scroll knob. The knob is drawn with a gradient made up
     * of two colors.
     *
     * @return Two element array containing the two colors that form the
     * gradient.
     *
     * @see #setKnobColor(java.awt.Color, java.awt.Color)
     * @see #getLineColor()
    ...
    /**
     * Indicates how frequently the scrollbar updates while one of the scroll
     * arrows is pressed.
     *
    ...
    /**
     * Specifies how often the scrollbar will update itself when one of the
     * scroll arrows is pressed.
     *
     * @param delay Delay in milliseconds between scrollbar updates. A smaller
     * number makes the scrollbar scroll faster, a larger number makes it scroll
     * slower. The delay may not be negative.
     */
     ...
     *
     * @param amount Amount to add to the current value. A positive value
     * indicates a scroll down; a negative value indicates a scroll up.
     */
     ...
     *
     * @param amount One of
     * {@link #UNIT_UP}, {@link #UNIT_DOWN}, {@link #BLOCK_UP}, or
     * {@link #BLOCK_DOWN}.
     */
    ...
    /**
     * Start an auto-scroll operation. During auto-scroll, the scroll bar will
     * adjust its value and repaint continuously until the auto-scroll is
     * stopped.
     *
    ...
    //**************************************************************//
    /**
     * Draw the scroll bar. The scroll will not draw its bounds are too small to
     ...
     *
     * @return {@code true} if the scroll bar is able to draw within the bounds,
     * or {@code false} if the bounds are too small to draw without distortion.
     */
    ...
    /**
     * Draw a filled quad in a unique pick color. This method must be called
     * between {@code glBegin(GL.GL_QUADS)} and {@code glEnd()}.
     *
     * @param dc Current draw context.
    ...
    /**
     * Draw the vertices of a quadrilateral. This method must be called between
     * {@code glBegin(GL.GL_QUADS)} and {@code
     * glEnd()}.
     *
     * @param dc Current draw context.
     * @param bounds Bounds of the quad.
     ...
     * @param rotation Rotation to apply to the triangle. 0 rotation produces a
     * triangle pointing to the right. Rotation must be one of: 0, 90, -90, or
     * 180.
     * @param bounds The bounds of the scroll control. The arrow must be drawn
    ...
    //**************************************************************//
    /**
     * Control for the scroll arrows and areas of the scroll bar above and below
     * the knob.
     */
    public class ScrollControl extends TreeHotSpot {
         ...
         * {@inheritDoc}
         * <p>
         * Overridden to stop autoscroll operations when the scrollbar becomes
         * inactive.
         *
         * @param active {@code true} if the scrollbar is being activated,
         * {@code false} if the scrollbar is being deactivated.
         */
        @Override

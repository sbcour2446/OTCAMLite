...
/**
 * SurfaceTileDrawContext defines a context for rendering into off-screen
 * surface tiles. SurfaceTileDrawContext is defined by a geographic sector, a
 * screen viewport, and a collection of pick candidates. The sector maps
 * geographic coordinates to pixels in an abstract off-screen tile. The pick
 * candidates provide registration of picked objects drawn into the surface
 * tile.
 *
 * @author dcollins
...
public class SurfaceTileDrawContext {
    ...
    /**
     * Creates a new SurfaceTileDrawContext from the specified tile and
     * collection of pick candidates. The tile defines this context's geographic
     * extent and screen viewport. The pick candidate collection is used to
     * register picked objects drawn into the surface tile.
     *
    ...
    /**
     * Returns a Matrix mapping geographic coordinates to pixels in the
     * off-screen tile.
     *
    ...
    /**
     * Returns a Matrix mapping geographic coordinates to pixels in the
     * off-screen tile. The reference location defines the geographic coordinate
     * origin.
     *
     ...
     * This collection provides a registration of picked objects drawn into the
     * surface tile.
     *
    ...
    /**
     * Adds the specified picked object to this context's the collection of pick
     * candidates. This collection can be accessed by calling
     * {@link #getPickCandidates()}.
     *

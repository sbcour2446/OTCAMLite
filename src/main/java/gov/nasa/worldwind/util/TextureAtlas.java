...
/**
 * Represents a texture composed of multiple independent images. The independent
 * images are referred to as
 * <i>elements</i>, and are packed into non-overlapping sub-rectangles within
 * the texture atlas. The following NVIDIA document describes this technique: <a target="blank_"
 * href="ftp://download.nvidia.com/developer/NVTextureSuite/Atlas_Tools/Texture_Atlas_Whitepaper.pdf">Improve
 * Batching Using Texture Atlases</a>
 *
 * @author dcollins
...
public class TextureAtlas {
    ...
    /**
     * Implementation of the JOGL BackingStoreManager interface for texture
     * atlas. This is used by the JOGL {@link
     * RectanglePacker}, and delegates calls from a JOGL rectangle packer to
     * methods in this texture atlas.
     */
    protected class AtlasBackingStore implements BackingStoreManager {
         ...
         * {@inheritDoc}
         * <p>
         * Calls {@link TextureAtlas#createBackingImage(int, int)} with the
         ...
         * {@inheritDoc}
         * <p>
         * Returns <code>true</code>. The texture atlas can always attempt to
         * expand or compact.
         */
         ...
         * {@inheritDoc}
         * <p>
         * Returns <code>false</code>, indicating that the rectangle packer
         * should just expand. When configured to do so, texture atlas evicts
         * old elements in <code>additionFailed</code> if this texture atlas is
         * full and the addition would otherwise fail.
         */
         ...
         * {@inheritDoc}
         * <p>
         * If this texture atlas is configured to evicts old elements, this
         * attempts to remove the oldest one then exits, allowing the caller to
         * attempt the addition again. This throws a WWRuntimeException if this
         * texture atlas is not configured to evict old elements, or if there
         * are no more elements to evict.
         *
         * @throws WWRuntimeException if this backing store cannot fit the
         * rectangle in its layout.
         */
         ...
         * <p>
         * Calls
         * {@link TextureAtlas#beginMoveEntries(java.awt.image.BufferedImage, java.awt.image.BufferedImage)},
         ...
         * <p>
         * Calls
         * {@link TextureAtlas#endMoveEntries(java.awt.image.BufferedImage, java.awt.image.BufferedImage)},
         * casting the specified backing stores to BufferedImages.
         */
    ...
    /**
     * Represents an image element in a texture atlas. Each entry indicates the
     * element's key, the image's rectangle in the backing image, the actual
     * image's offset within that rectangle, the image's actual width and
     * height, and a timestamp indicating the last time the element was used.
     * Implements the {@link Comparable} interface by comparing the lastUsed
     * timestamp, ordered from least recently used to most recently used.
     */
    protected static class Entry implements Comparable<Entry> {
        ...
        public Rect rect;
        /**
         * Indicates the element's image X offset withing the bounding
         * rectangle. Initialized during construction.
         */
        public int imageOffsetX;
        /**
         * Indicates the element's image Y offset withing the bounding
         * rectangle. Initialized during construction.
         */
        public int imageOffsetY;
        /**
         * Indicates the element's image width. May be smaller than the bounding
         * rectangle's width. Initialized during construction.
         */
        public int imageWidth;
        /**
         * Indicates the element's image height. May be smaller than the
         * bounding rectangle's height. Initialized during construction.
         */
        ...
        /**
         * Constructs a texture atlas entry corresponding with a texture atlas
         * element with the specified key, bounding rectangle, and image offsets
         * within the bounding rectangle.
         *
         * @param key the element's key.
         * @param rect the element's bounding rectangle within the texture
         * atlas.
         * @param imageOffsetX the element's image X offset withing the bounding
         * rectangle.
         * @param imageOffsetY the element's image Y offset withing the bounding
         * rectangle.
         * @param imageWidth the element's image width. May be smaller than the
         * bounding rectangle's width.
         * @param imageHeight the element's image height. May be smaller than
        ...
        /**
         * Compares this texture atlas entry's last used timestamp to that of
         * the specified entry. This returns -1 if this entry's last used time
         * is earlier than the specified entry's, 0 if the two entries have the
         * same last used time, and 1 if this entry's last used time is later
         * than the specified entry's.
         *
         * @param that the texture atlas entry this entry is compared to.
         *
         * @return -1, 0, or 1 if this entry's last used time is earlier than,
         * the same as, or later than the specified entry's last used time.
         *
         * @throws IllegalArgumentException if the specified entry is
         * <code>null</code>.
         */
    ...
    /**
     * Indicates this texture atlas' maximum total width, in pixels. This is
     * specified during construction and is used to determine when an image is
     * too large to fit in this texture atlas.
     */
    protected int maxWidth;
    /**
     * Indicates this texture atlas' maximum total height, in pixels. This is
     * specified during construction and is used to determine when an image is
     * too large to fit in this texture atlas.
     */
    protected int maxHeight;
    /**
     * Indicates whether this texture atlas generates mip-maps for each atlas
     * element. <code>true</code> if this texture atlas generates mip-maps, and
     * <code>false</code> otherwise. Specified during construction.
     */
    protected boolean useMipMaps;
    /**
     * Indicates whether this texture atlas applies an anisotropic filter to
     * each atlas element. <code>true</code> if this texture atlas applies an
     * anisotropic filter, and <code>false</code> otherwise. This has no effect
     * if useMipMaps is <code>false</code>. Specified during construction.
     */
    protected boolean useAnisotropy;
    /**
     * Indicates whether this texture atlas evicts old elements in order to make
     * room for a new element when the atlas is full. <code>true</code> if this
     * atlas evicts elements to make room for new elements, and
     * <code>false</code> otherwise. Initially code <code>false</code>.
     */
    protected boolean evictOldElements;
    /**
     * Indicates the maximum amount of vertical fragmentation this texture atlas
     * allows before compacting its elements. Initialized to
     * DEFAULT_MAX_VERTICAL_FRAGMENTATION.
     */
    protected double maxVerticalFragmentation = DEFAULT_MAX_VERTICAL_FRAGMENTATION;
    /**
     * The JOGL rectangle packer used by this texture atlas to determine how to
     * pack the elements within this texture atlas' backing image. Initialized
     * during construction.
     */
    protected RectanglePacker rectPacker;
    /**
     * Maps element keys to their corresponding entry. This enables the texture
     * atlas to access the information about each element in constant time using
     * its key. Initialized to a new HashMap.
     */
    protected Map<Object, Entry> entryMap = new HashMap<Object, Entry>();
    /**
     * Indicates the rectangle within this texture atlas' backing image that is
     * currently out-of-sync with its corresponding OpenGL texture. The dirty
     * rectangle is <code>null</code> when this texture atlas' backing image is
     * synchronized with its OpenGL texture. Initially <code>null</code>.
     */
    protected Rectangle dirtyRect;
    /**
     * Indicates the color used to fill regions of this texture atlas that do
     * not contain a sub-image element. Initially transparent black (R=0, G=0,
     * B=0, A=0).
     */
    protected Color clearColor = new Color(0, 0, 0, 0);
    /**
     * Temporary AWT graphics instance used to move image elements during a
     * beginMovement/endMovement block. This property is assigned in
     * beginMovement, used in move, then cleared in endMovement. Initially
     * <code>null</code>.
     */
    protected Graphics2D g;
    /**
     * Indicates the current key corresponding to this texture atlas' OpenGL
     * texture in the GPU resource cache. This key is assigned to a new instance
     * whenever this texture atlas creates new backing image. Initialized to a
     * new Object.
     */
    protected Object textureKey = new Object();
    /**
     * Queue of texture keys corresponding to disposed backing images. These
     * keys are disposed during the next call to <code>bind</code>. While
     * disposed backing textures would eventually be evicted by the GPU resource
     * cache, explicitly disposing them avoids polluting the GPU resource cache
     * with orphaned textures that are used only by this texture atlas.
     */
    protected Queue<Object> disposedTextureKeys = new ArrayDeque<Object>();

    /**
     * Constructs a texture atlas with the specified initial and maximum
     * dimensions. All dimensions must be greater than zero, and the maximum
     * dimensions must be greater than or equal to the initial dimensions. The
     * constructed texture atlas generates mip-maps and applies an anisotropic
     * filter to each element.
     *
     * @param initialWidth the texture atlas' initial width, in pixels. Must be
     * greater than zero.
     * @param initialHeight the texture atlas' initial height, in pixels. Must
     * be greater than zero.
     * @param maxWidth the texture atlas' maximum width, in pixels. Must be
     * greater than or equal to initialWidth.
     * @param maxHeight the texture atlas' maximum height, in pixels. Must be
     * greater than or equal to initialHeight.
     *
     * @throws IllegalArgumentException if any of initialWidth, initialHeight,
     * maxWidth, or maxHeight are less than or equal to zero, if maxWidth is
     * less than initialWidth, or if maxHeight is less than initialHeight.
     */
     ...
     * Constructs a texture atlas with the specified initial and maximum
     * dimensions. All dimensions must be greater than zero, and the maximum
     * dimensions must be greater than or equal to the initial dimensions. This
     * constructor enables specification of whether the texture atlas generates
     * mip-maps and applies an anisotropic filter to each element.
     *
     * @param initialWidth the texture atlas' initial width, in pixels. Must be
     * greater than zero.
     * @param initialHeight the texture atlas' initial height, in pixels. Must
     ...
     * @param maxHeight the texture atlas' maximum height, in pixels. Must be
     * greater than or equal to initialHeight.
     * @param useMipMaps whether to generate mip-maps for each atlas element.
     * <code>true</code> to generate mip-maps, and <code>false</code> otherwise.
     * @param useAnisotropy whether to apply an anisotropic filter to each atlas
     * element. <code>true</code> to apply an anisotropic filter, and
     * <code>false</code> otherwise. This has no effect if useMipMaps is
     * <code>false</code>.
     *
     * @throws IllegalArgumentException if any of initialWidth, initialHeight,
     * maxWidth, or maxHeight are less than or equal to zero, if maxWidth is
    ...
    /**
     * Returns a new JOGL rectangle packer that is used by this texture atlas to
     * determine how to pack the elements within this texture atlas' backing
     * image. By default, this returns a rectangle packer with an {@link
     * AtlasBackingStore} as the backing store manager. Called during
     * construction.
     *
     * @param initialWidth this texture atlas' initial width.
     * @param initialHeight this texture atlas' initial height.
     *
     * @return a new JOGL rectangle packer with the specified initial
     * dimensions.
     */
    ...
    /**
     * Indicates whether this texture atlas generates mip-maps for each atlas
     * element. Specified during construction.
     *
     * @return <code>true</code> if this texture atlas generates mip-maps, and
    ...
    /**
     * Indicates whether this texture atlas applies an anisotropic filter to
     * each atlas element. This has no effect if useMipMaps is
     * <code>false</code>. Specified during construction.
     *
     * @return <code>true</code> if this texture atlas applies an anisotropic
    ...
    /**
     * Indicates whether this texture atlas evicts the oldest elements in order
     * to make room for a new element when the atlas is full.
     *
     * @return <code>true</code> if this atlas evicts old elements to make room
     * for new elements, and <code>false</code> otherwise.
     *
    ...
    /**
     * Specifies whether this texture atlas should evict the oldest elements in
     * order to make room for a new element when the atlas is full. When
     * disabled, calling <code>add</code> with an element that does not fit in
     * the current atlas layout causes this texture atlas to throw an exception
     * if the atlas cannot be expanded. When enabled, the oldest elements are
     * evicted until there is enough space to fit the element in the layout.
     *
     * @param evictOldElements <code>true</code> if this atlas should evict old
     * elements to make room for new elements, and <code>false</code> otherwise.
     */
     ...
     *
     * @return the number of elements in this texture atlas, or 0 if this atlas
     ...
     *
     * @return <code>true</code> if this texture atlas contains at least one
    ...
    /**
     * Adds a new element to this texture atlas with the specified key and
     * image. The image's dimensions must be less than or equal to this texture
     * atlas' maximum dimensions. If this texture atlas is not configured to
     * evict old entries, this throws an exception if the image does not fit in
     * the current atlas layout and the atlas cannot be expanded.
     * <p>
     * This adds a one pixel border around the specified image in this texture
     * atlas' backing image by copying the image's outer pixels into a border
     * surrounding the original image. This border avoids sampling pixels from
     * neighboring atlas elements when an OpenGL box filter is applied to this
     * image. This means that the atlas actually requires space for an image
     * with dimensions (width + 2, height + 2), where width and height are the
     * image's original dimensions.
     *
     * @param key an object used to reference the image.
     * @param image the image to add.
     *
     * @throws IllegalArgumentException if either the key or image is
     * <code>null</code>, or if the image dimensions are greater than this
     * texture atlas' maximum dimensions.
     * @throws WWRuntimeException if this texture atlas is too full to fit the
     * image in its layout.
     */
    ...
    /**
     * Removes the element with the specified key from this texture atlas,
     * freeing the space it occupied to be used by other elements. If this
     * texture atlas does not contain an element with the specified key, this
     * returns <code>false</code> but otherwise does nothing.
     *
     * @param key an object used to reference the element to remove.
     *
     * @return <code>true</code> if this texture atlas contained an element with
     * the specified key, and <code>false</code> otherwise.
     *
    ...
    /**
     * Removes the element corresponding to the specified entry from this
     * texture atlas, freeing the space it occupied to be used by other
     * elements.
     *
    ...
    /**
     * Indicates whether this texture atlas contains an element with the
     * specified key.
     *
     * @param key the key which the element is referenced by.
     *
     * @return <code>true</code> if this texture atlas contains an element with
     * the specified key, and <code>false</code> otherwise.
     *
     * @throws IllegalArgumentException if the key is <code>null</code>.
     */
    ...
    /**
     * Returns the image dimensions associated with an element in this texture
     * atlas. This returns <code>null</code> this texture atlas does not contain
     * the element.
     *
     * @param key the key which the element is referenced by.
     *
     * @return the image dimensions corresponding to the specified element, or
    ...
    /**
     * Returns the OpenGL texture coordinates associated with an element in this
     * texture atlas. This returns <code>null</code> if this texture atlas does
     * not contain the element.
     * <p>
     * The returned texture coordinates can change any time an element is added
     * or removed from this texture atlas, and therefore should not be cached
     * unless the caller has explicit knowledge of when this texture atlas has
     * changed.
     *
     * @param key the key which the element is referenced by.
     *
     * @return the OpenGL texture coordinates corresponding to the specified
     * element, or <code>null</code> if this texture atlas does not contain the
     * element.
     */
    ...
    /**
     * Removes all elements from this texture atlas. The backing image retains
     * its current dimensions after this call.
     */
    public void clear() {
    ...
    /**
     * Binds this texture atlas' OpenGL texture to the GLContext attached to the
     * draw context. Before binding, this updates the OpenGL texture as
     * necessary to reflect changes in this texture atlas since the last call to
     * <code>bind</code>.
     *
     * @param dc the current draw context.
     *
     * @return <code>true</code> if the texture is bound, and <code>false</code>
     * otherwise.
     *
     * @throws IllegalArgumentException if the draw context is
     * <code>null</code>.
     */
    ...
    /**
     * Creates and returns a BufferedImage with the specified dimensions to use
     * as this texture atlas' backing image. The returned image must be at least
     * as large as the specified dimensions, but may be larger. By default, this
     * always returns an image with power-of-two dimensions in order to maximize
     ...
     *
     * @param backingImage the destination backing image to fill with the clear
     * color.
     * @param x the X coordinate of the rectangle's upper-left corner, in
     * pixels.
     * @param y the Y coordinates of the rectangle's upper-left corner, in
     * pixels.
    ...
    /**
     * Draws the specified image in the backing image at the specified (x, y)
     * location. If drawBorder is <code>true</code>, this copies the image's
     * outer pixels into 1 pixel border surrounding the original image. This
     * border avoids sampling pixels from neighboring atlas elements when an
     * OpenGL box filter is applied to this image.
     *
     ...
     * @param drawBorder   <code>true</code> this copy the image's outer pixels
     * into 1 pixel border surrounding the original image, or <code>false</code>
     * to draw only the image.
     */
    ...
    /**
     * Called when the atlas is performing a full re-layout of its elements,
     * just before the layout begins. If this texture atlas' dimensions are
     * changing, the specified backing images refer to separate instances with
     * different dimensions. If this texture atlas is performing a re-layout in
     * place, the specified backing images refer to the same instance.
     *
     * @param oldBackingImage the backing image corresponding to the previous
     * layout.
    ...
    /**
     * Called when the atlas is performing a full re-layout of its elements,
     * just after the layout ends. If this texture atlas' dimensions have
     * changed, the specified backing images refer to separate instances with
     * different dimensions. If this texture atlas has performed a re-layout in
     * place, the specified backing images refer to the same instance.
     *
     * @param oldBackingImage the backing image corresponding to the previous
     * layout.
    ...
    /**
     * Called for each atlas element when the atlas is performing a full
     * re-layout of its elements. If this texture atlas' dimensions are
     * changing, the specified backing images refer to separate instances with
     * different dimensions. If this texture atlas is performing a re-layout in
     * place, the specified backing images refer to the same instance. In either
     * case, the specified rectangles correspond to the element's location in
     * the old backing image and new backing image.
     *
     * @param oldBackingImage the backing image corresponding to the previous
     * layout.
    ...
    /**
     * Marks the specified entry as used by setting its last used time to the
    ...
    /**
     * Removes the oldest entry from this texture atlas. This does nothing if
     * this texture atlas is empty.
     *
     * @return <code>true</code> if this removed an entry, and
     * <code>false</code> if there are no entries to remove.
     */
    ...
    /**
     * Returns the region of this texture atlas' backing image that is not
     * currently synchronized with the OpenGL texture.
     *
    ...
    /**
     * Marks a region of this texture atlas' backing image as needing to be
     * synchronized with the OpenGL texture. If there is already a dirty region,
     * the final dirty region is the union of the two.
     *
    ...
    /**
     * Removes any regions in this texture atlas' backing image previously
     * marked as needing to be synchronized with the OpenGL texture.
     */
     ...
     * @param dc the current draw context.
     *
     * @return this instance's OpenGL texture, or <code>null</code> if the
     * texture does not currently exist.
     */
     ...
     *
     * @param dc the current draw context.
     * @param texture this instance's OpenGL texture, or <code>null</code> to
     * specify that this texture atlas has no texture.
     */
    ...
    /**
     * Removes textures corresponding to this texture atlas' disposed backing
     * images from the draw context's GPU resource cache. While disposed backing
     * textures would eventually be evicted by the GPU resource cache,
     * explicitly removing them avoids polluting the GPU resource cache with
     * orphaned textures that are used only by this texture atlas.
     *
     * @param dc the draw context containing the GPU resource cache to remove
     * textures from.
     */
    ...
    /**
     * Synchronizes this texture atlas's backing image with its OpenGL texture,
     * creating an OpenGL texture as necessary. This attempts to minimize
     * transfer between Java and OpenGL by loading the smallest possible portion
     * of the backing image into the OpenGL texture.
     *
     * @param dc the current draw context.
     *
    ...
    /**
     * Creates an OpenGL texture by loading this texture atlas's backing image
     * into a new texture with the same dimensions.
     *
     * @param dc the current draw context.
     *
     * @return a new OpenGL texture containing the data from this texture atlas'
     * backing image.
     */
    ...
    /**
     * Loads a sub-region of this texture atlas' backing image into its OpenGL
     * texture. This does nothing and returns code <code>null</code> if this
     * texture atlas' does not have an OpenGL texture.
     *
     * @param dc the current draw context.
     * @param rect the rectangle to load.
     *
     * @return this texture atlas' OpenGL texture, or <code>null</code> if this
     * texture atlas' does not have an OpenGL texture.
     */
    ...
    /**
     * Specifies the OpenGL texture parameters associated with this texture
     * atlas' OpenGL texture. Called after updating this texture atlas' OpenGL
     * texture, when the OpenGL texture is bound to the draw context's
     * <code>GLContext</code>.
     *
     * @param dc the current draw context.
     */

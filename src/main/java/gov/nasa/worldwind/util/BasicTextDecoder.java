...
/**
 * Base class for text decoders. This decoder handles caching the decoded text,
 * but does not provide any actual decoding logic. This class is thread safe.
 *
 * @author pabercrombie
...
public class BasicTextDecoder implements TextDecoder {
    ...
    /**
     * Decode the text. Subclasses may override this method to change the
     * decoding.
     *

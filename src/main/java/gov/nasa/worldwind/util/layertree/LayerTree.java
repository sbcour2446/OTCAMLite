...
/**
 * A <code>Renderable</code> tree of
 * <code>{@link gov.nasa.worldwind.layers.Layer}</code> objects and their
 * content. By default, a <code>LayerTree</code> is created with a
 * <code>{@link LayerTreeModel}</code>, and a <code>{@link
 * gov.nasa.worldwind.util.tree.BasicTreeLayout}</code> that is configured for
 * displaying a layer tree. Callers can specify the model to use either by
 * specifying one during construction, or by calling <code>{@link
 * LayerTree#setModel(gov.nasa.worldwind.util.tree.TreeModel)}</code>. Once
 * created, callers add layers to the tree using methods on
 * <code>LayerTreeModel</code>.
 *
 * @author dcollins
...
public class LayerTree extends BasicTree {
    ...
    /**
     * Creates a new <code>LayerTree</code> with an empty
     * <code>LayerTreeModel</code> and the default screen location. The tree's
     * upper left corner is placed 20x140 pixels from the upper left screen
     * corner.
     */
    public LayerTree() {
    ...
    /**
     * Creates a new <code>LayerTree</code> with the specified
     * <code>model</code> and the default screen location. The tree's upper left
     * corner is placed 20x140 pixels from the upper left screen corner.
     *
    ...
    /**
     * Creates a new <code>LayerTree</code> with an empty
     * <code>LayerTreeModel</code> and the specified screen location.
     *
     * @param offset the screen location of the tree's upper left corner,
    ...
    /**
     * Creates a new <code>LayerTree</code> with the specified
     * <code>model</code> and the specified screen location.
     *
     * @param model the tree model to use.
     * @param offset the screen location of the tree's upper left corner,
     * relative to the screen's upper left corner.
     *
     * @throws IllegalArgumentException if <code>model</code> is
     * <code>null</code>, or if <code>offset</code> is <code>null</code>.
     */
    ...
    /**
     * Initializes this tree with the specified <code>model</code> and
     * <code>offset</code>. This configures the tree's model, its layout, and
     * expands the path to the root node. If either parameter is
     * <code>null</code> this uses a suitable default.
     *
     * @param model this tree's model to use, or <code>null</code> to create a
     * new <code>LayerTreeModel</code>.
     * @param offset the screen location of this tree's upper left corner, or
    ...
    /**
     * Returns a new <code>LayerTreeModel</code>. Called from
     * <code>initialize</code> when no model is specified.
     *

...
/**
 * A <code>KMLFeatureTreeNode</code> that represents a KML container defined by
 * a <code>{@link
...
public class KMLContainerTreeNode extends KMLFeatureTreeNode {
    ...
    /**
     * Creates a new <code>KMLContainerTreeNode</code> from the specified
     * <code>container</code>. The node's name is set to the feature's name, and
     * the node's hierarchy is populated from the container's KML features.
     *
     * @param container the KML container this node represents.
     *
     * @throws IllegalArgumentException if the <code>container</code> is
     * <code>null</code>.
     */

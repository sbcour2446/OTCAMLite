...
/**
 * A <code>LayerTreeNode</code> that represents a KML feature hierarchy defined
 * by a <code>{@link
...
public class KMLLayerTreeNode extends LayerTreeNode {
    ...
    /**
     * Indicates the KML feature hierarchy this node represents. Initialized
     * during construction.
     */
    protected KMLRoot kmlRoot;

    /**
     * Creates a new <code>KMLLayerTreeNode</code> from the specified
     * <code>layer</code> and <code>kmlRoot</code>. The node's name is set to
     * the layer's name, and the node's hierarchy is populated from the feature
     * hierarchy of the <code>KMLRoot</code>.
     *
     * @param layer the <code>Layer</code> the <code>kmlRoot</code> corresponds
     * to.
     * @param kmlRoot the KML feature hierarchy this node represents.
     *
     * @throws IllegalArgumentException if the <code>layer</code> is
     * <code>null</code>, or if <code>kmlRoot</code> is <code>null</code>.
     */
    ...
    /**
     * Specifies whether this node's layer is enabled for rendering. If the
     * KMLRoot's feature is a container (Document or Folder), this method sets
     * the visibility of that container as well as the node that represents the
     * layer.
     *
     * @param selected <code>true</code> to enable the layer, otherwise
     * <code>false</code>.
     */
    @Override
    ...
    /**
     * Adds a new <code>KMLFeatureTreeNode</code> to this node for each KML
     * feature in the <code>KMLRoot</code>.
     * <p>
     * If the <code>KMLRoot</code>'s top level feature is a
     * <code>Document</code> or <code>Folder</code>, this method ignores this
     * container and adds its children directly to this node. Creating a node
     * for the container adds an extra level to the tree node that doesn't
     * provide any meaningful grouping.
     * <p>
     * This does nothing if the <code>KMLRoot</code>'s top level feature is
     * <code>null</code>.
     */
    ...
    /**
     * Adds the a new <code>KMLFeatureTreeNode</code> created with the specified
     * <code>feature</code> to this node.
     *
     ...
     * contains this node.
     * <p>
     * This node's path is expanded if it's top level KML feature is an open KML
     * container, an open KML network link, or is any other kind of KML feature.
     * <p>
    ...
    /**
     * Indicates whether the tree path for this node must expanded. If the
     * <code>KMLRoot</code>'s feature is a KML container or a KML network link,
     * this returns whether that KML element's <code>open</code> property is

 ...
 * {@literal </restorableState>}
 * </code>
 * </pre> Callers can create a new RestorableSupport with no state content, or
...
public class RestorableSupport {
     ...
     *
     * @param documentElementName the name of the restorable state document
     * element.
     *
     * @return a new, empty RestorableSupport instance.
     *
     * @throws IllegalArgumentException if the specified element name is null or
     * empty.
     */
     ...
     * the its contents are not a well formed XML document.
     */
     ...
     * converted, this method returns null.
     *
     ...
     * document, as defined by {@link
     * gov.nasa.worldwind.util.RestorableSupport}. The <code>name</code> and
     * simple String <code>value</code> of a <code>stateObject</code> can be
     * queried or set through StateObject. This also serves as a context through
     * which nested <code>stateObjects</code> can be found or created.
     */
     ...
     * name is used as a search parameter to find a state object, and is used as
     * the tag name when a new state object is created. The default tag name is
     * "stateObject".
     *
     ...
     * name is used as a search parameter to find a state object, and is used as
     * the tag name when a new state object is created. Setting this value does
     * not retroactively set tag names for existing state objects. The default
     * tag name is "stateObject".
     *
     * @param stateObjectTagName String to be used for each state object's tag
     * name.
     *
     * @throws IllegalArgumentException If <code>stateObjectTagName</code> is
     * null.
     */
    ...
    /**
     * Returns the StateObject with the specified <code>name</code>. This
     * searches the StateObjects directly beneath the document root. If no
     * StateObject with that name exists, this method returns null.
     *
     ...
     * is not null, this method searches the StateObjects directly below the
     * specified <code>context</code>. Otherwise, this method searches the
     * StateObjects directly beneath the document root. If no StateObject with
     * that name exists, this method returns null.
     *
     * @param context StateObject context to search, or null to search the
     * document root.
     * @param name the StateObject name to search for.
     *
     * @return the StateObject instance, or null if none exists.
     *
     * @throws IllegalArgumentException If <code>name</code> is null, or if
     * <code>context</code> is not null and does not belong to this
     * RestorableSupport.
     */
     ...
     * context is not null, this method returns all the StateObjects directly
     * below the specified <code>context</code>. Otherwise, this method returns
     * all the StateObjects directly beneath the document root.
     *
     * @param context StateObject context to search, or null to search the
     * document root.
     *
     * @return an array of the StateObject instances, which has zero length if
     * none exist.
     *
     * @throws IllegalArgumentException If <code>name</code> is null, or if
     * <code>context</code> is not null and does not belong to this
     ...
     * this method returns a valid StateObject array with zero length.
     *
     * @param name the StateObject name to search for.
     *
     * @return an array of the StateObject instances, which has zero length if
     ...
     * that name exist, this method returns a valid StateObject array with zero
     * length.
     *
     * @param context StateObject context to search, or null to search the
     * document root.
     ...
     * StateObject is placed directly beneath the document root. If a
     ...
     * <code>context</code> is not null, the new StateObject is nested directly
     * beneath the specified <code>context</code>. Otherwise, the new
     * StateObject is placed directly beneath the document root. If a
     * StateObject with this name already exists, a new one is still created.
     *
     * @param context the StateObject under which the new StateObject is
     ...
     *
     * @throws IllegalArgumentException If <code>stateObject</code> is null, or
     ...
     * as a String. This method searches the StateObjects directly beneath the
     * document root. If no StateObject with that name exists, or if the value
     * of that StateObject is not a String, this method returns null.
     *
     * @param name the StateObject name to search for.
     *
    ...
    /**
     * Returns the value of the StateObject with the specified <code>name</code>
     * as a String. If context is not null, this method searches the
     * StateObjects directly below the specified <code>context</code>.
     * Otherwise, this method searches the StateObjects directly beneath the
     * document root. If no StateObject with that name exists, or if the value
     * of that StateObject is not a String, this method returns null.
     *
     * @param context StateObject context to search, or null to search the
    ...
    /**
     * Returns the value of the StateObject with the specified <code>name</code>
     * as an Integer. This method searches the StateObjects directly beneath the
     * document root. If no StateObject with that name exists, or if the value
     * of that StateObject is not an Integer, this method returns null.
     *
     * @param name the StateObject name to search for.
     *
    ...
    /**
     * Returns the value of the StateObject with the specified <code>name</code>
     * as an Integer. If context is not null, this method searches the
     * StateObjects directly below the specified <code>context</code>.
     * Otherwise, this method searches the StateObjects directly beneath the
     * document root. If no StateObject with that name exists, or if the value
     * of that StateObject is not an Integer, this method returns null.
    ...
    /**
     * Returns the value of the StateObject with the specified <code>name</code>
     * as a Double. This method searches the StateObjects directly beneath the
     * document root. If no StateObject with that name exists, or if the value
     * of that StateObject is not a Double, this method returns null.
     *
     * @param name the StateObject name to search for.
     *
    ...
    /**
     * Returns the value of the StateObject with the specified <code>name</code>
     * as a Double. If context is not null, this method searches the
     * StateObjects directly below the specified <code>context</code>.
     * Otherwise, this searches the StateObjects directly beneath the document
     * root. If no StateObject with that name exists, or if the value of that
    ...
    /**
     * Returns the value of the StateObject with the specified <code>name</code>
     * as a Long. This searches the StateObjects directly beneath the document
     * root. If no StateObject with that name exists, or if the value of that
    ...
    /**
     * Returns the value of the StateObject with the specified <code>name</code>
     * as a Long. If context is not null, this method searches the StateObjects
     * directly below the specified <code>context</code>. Otherwise, this method
     * searches the StateObjects directly beneath the document root. If no
     * StateObject with that name exists, or if the value of that StateObject is
     * not a Double, this method returns null.
     *
     * @param context StateObject context to search, or null to search the
     * document root.
     * @param name the StateObject name to search for.
    ...
    /**
     * Returns the value of the StateObject with the specified <code>name</code>
     * as a Float. This method searches the StateObjects directly beneath the
     * document root. If no StateObject with that name exists, or if the value
     * of that StateObject is not a Float, this method returns null.
     *
     * @param name the StateObject name to search for.
     *
    ...
    /**
     * Returns the value of the StateObject with the specified <code>name</code>
     * as a Float. If context is not null, this method searches the StateObjects
     * directly below the specified <code>context</code>. Otherwise, this
     * searches the StateObjects directly beneath the document root. If no
     * StateObject with that name exists, or if the value of that StateObject is
     * not a Float, this method returns null.
     *
     * @param context StateObject context to search, or null to search the
     * document root.
     * @param name the StateObject name to search for.
    ...
    /**
     * Returns the value of the StateObject as a Boolean. The Boolean value
     * returned is equivalent to passing the StateObject's String value to
    ...
    /**
     * Returns the value of the StateObject with the specified <code>name</code>
     * as a Boolean. This method searches the StateObjects directly beneath the
     * document root. If no StateObject with that name exists, this method
     * returns null. Otherwise, the Boolean value returned is equivalent to
     * passing the StateObject's String value to <code>Boolean.valueOf</code>.
     *
     * @param name the StateObject name to search for.
     *
    ...
    /**
     * Returns the value of the StateObject with the specified <code>name</code>
     * as a Boolean. If context is not null, this method searches the
     * StateObjects directly below the specified <code>context</code>.
     * Otherwise, this method searches the StateObjects directly beneath the
     * document root. If no StateObject with that name exists, this method
     * returns null. Otherwise, the Boolean value returned is equivalent to
     ...
     *
     * @param stateObject the StateObject that is converted to a List of
     * LatLons.
     *
    ...
    /**
     * Returns the value of the StateObject as a HashMap of &lt;Integer,
     * OffsetsList&gt; pairs.
     *
     * @param stateObject the StateObject that is converted to a HashMap of
     * OffsetsLists.
     *
     * @return the value of the StateObject as a HashMap of &lt;Integer,
     * OffsetsList&gt; pairs.
     *
     * @throws IllegalArgumentException If <code>stateObject</code> is null, or
     * does not belong to this RestorableSupport.
    ...
    /**
     * Returns the value of the StateObject as a HashMap of &lt;Integer,
     * Object&gt; pairs, representing the shape's imageSources.
     *
     * @param stateObject the StateObject that is converted to a HashMap of
     * imageSources.
     *
     ...
     * <code>value</code>. The new StateObject is placed beneath the document
     * root. If a StateObject with this name already exists, a new one is still
     * created.
     *
     * @param name the new StateObject's name.
     ...
     * <code>value</code>. The new StateObject is placed beneath the document
     * root. If a StateObject with this name already exists, a new one is still
     * created. If <code>escapeValue</code> is true, the text in
     * <code>value</code> is escaped in a CDATA section. Otherwise, no special
     * processing is performed on <code>value</code>. Once <code>value</code>
     * has been escaped and added, it can be extracted exactly like any other
     * String value.
     *
     * @param name the new StateObject's name.
     * @param value the new StateObject's String value.
     * @param escapeValue whether to escape the String <code>value</code> or
     * not.
     *
     * @throws IllegalArgumentException If either <code>name</code> or
     * <code>value</code> is null.
     ...
     * StateObject is nested directly beneath the specified
     * <code>context</code>. Otherwise, the new StateObject is placed directly
     * beneath the document root. If a StateObject with this name already
     * exists, a new one is still created.
     *
     * @param context the StateObject context under which the new StateObject is
     * created, or null to place it under the document root.
     * @param name the new StateObject's name.
     * @param value the new StateObject's String value.
     *
     * @throws IllegalArgumentException If either <code>name</code> or
     * <code>value</code> is null, or if <code>context</code> is not null and
     * does not belong to this RestorableSupport.
     */
     ...
     * <code>context</code>. Otherwise, the new StateObject is placed directly
     * beneath the document root. If a StateObject with this name already
     * exists, a new one is still created. If <code>escapeValue</code> is true,
     * the text in <code>value</code> is escaped in a CDATA section. Otherwise,
     * no special processing is performed on <code>value</code>. Once
     ...
     * can be restored with a call to {@link
     * #decodeColor(String)}.
     *
     ...
     * cannot be decoded, this method returns null.
     *

 ...
 * gov.nasa.worldwind.util.BufferWrapper}, without having to know the underlying
 * data type. Once created, a BufferWrapper abstracts reading and writing buffer
 * data from the underlying data type. When BufferWrapper is combined with
 * BufferFactory, a component may create and work with buffer data in a type
 * agnostic manner.
 * <p>
 * BufferFactory is itself abstract and defines the factory interface. It
 * defines several implementations as static inner classes, which serve the most
 * common data types: {@link gov.nasa.worldwind.util.BufferFactory.ByteBufferFactory},
...
public abstract class BufferFactory {
    ...
    /**
     * Constructs a new BufferFactory with the specified buffer allocation
     * policy.
     *
     * @param allocateDirect true to allocate and return BufferWrappers backed
     * by direct buffers, false to allocate and return BufferWrappers backed by
     * non-direct buffers.
     */
     ...
     * This factory allocates and returns BufferWrappers backed by direct
     * buffers.
     */
    ...
    /**
     * @return true if this factory allocates and returns BufferWrappers backed
     * by direct buffers, and false if it allocates and return BufferWrappers
     * backed by non-direct buffers.
     */
     ...
     *
     * @param size the new buffer's size, in number of underlying data type
     * units (bytes, shorts, ints, floats, or doubles).
     *
    ...
    public static class ByteBufferFactory extends BufferFactory {
        ...
        /**
         * Constructs a new ByteBufferFactory with the specified buffer
         * allocation policy.
         *
         * @param allocateDirect true to allocate and return ByteBufferWrappers
         * backed by direct buffers, false to allocate and return
         * ByteufferWrappers backed by non-direct buffers.
         */
        ...
        /**
         * Constructs a new ByteBufferFactory with the default buffer allocation
         * policy. This factory allocates and returns ByteBufferWrappers backed
         * by direct buffers.
         */
    ...
    public static class ShortBufferFactory extends BufferFactory {
        ...
        /**
         * Constructs a new ShortBufferFactory with the specified buffer
         * allocation policy.
         *
         * @param allocateDirect true to allocate and return ShortBufferWrappers
         * backed by direct buffers, false to allocate and return
        ...
        /**
         * Constructs a new ShortBufferFactory with the default buffer
         * allocation policy. This factory allocates and returns
         * ShortBufferWrappers backed by direct buffers.
         */
        public ShortBufferFactory() {
        }

        /**
         * Constructs a new ShortBufferWrapper of the specified size, backed by
         * a {@link java.nio.ShortBuffer}.
         *
    ...
    public static class IntBufferFactory extends BufferFactory {
        ...
        /**
         * Constructs a new IntBufferFactory with the specified buffer
         * allocation policy.
         *
         * @param allocateDirect true to allocate and return IntBufferWrappers
         * backed by direct buffers, false to allocate and return
        ...
        /**
         * Constructs a new IntBufferFactory with the default buffer allocation
         * policy. This factory allocates and returns IntBufferWrappers backed
         * by direct buffers.
         */
    ...
    public static class FloatBufferFactory extends BufferFactory {
        ...
        /**
         * Constructs a new FloatBufferFactory with the specified buffer
         * allocation policy.
         *
         * @param allocateDirect true to allocate and return FloatBufferWrappers
         * backed by direct buffers, false to allocate and return
        ...
        /**
         * Constructs a new FloatBufferFactory with the default buffer
         * allocation policy. This factory allocates and returns
         * FloatBufferWrappers backed by direct buffers.
         */
        public FloatBufferFactory() {
        }

        /**
         * Constructs a new FloatBufferWrapper of the specified size, backed by
         * a {@link java.nio.FloatBuffer}.
         *
    ...
    public static class DoubleBufferFactory extends BufferFactory {
        ...
        /**
         * Constructs a new DoubleBufferFactory with the specified buffer
         * allocation policy.
         *
         * @param allocateDirect true to allocate and return
         * DoubleBufferWrappers backed by direct buffers, false to allocate and
         * return DoubleBufferWrappers backed by non-direct buffers.
         */
        ...
        /**
         * Constructs a new DoubleBufferFactory with the default buffer
         * allocation policy. This factory allocates and returns
         * DoubleBufferWrappers backed by direct buffers.
         */
        public DoubleBufferFactory() {
        }

        /**
         * Constructs a new DoubleBufferWrapper of the specified size, backed by
         * a {@link java.nio.DoubleBuffer}.
         *

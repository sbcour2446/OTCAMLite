...
/**
 * Consolidates the conversion, display and formatting of geographic units such
 * as lengths in miles and areas in hectares. Applications configure a class
 * instance to the desired units, labels and display formats, then simply
 * retrieve display strings from the instance via one standard interface. All
 * input values are in meters; the class performs the necessary conversions to
...
public class UnitsFormat extends AVListImpl {
    ...
    /**
     * Construct an instance that displays length in kilometers, area in square
     * kilometers and angles in decimal degrees.
     */
    public UnitsFormat() {
    ...
    /**
     * Constructs an instance that display length and area in specified units,
     * and angles in decimal degrees.
     *
     ...
     *
     * @throws IllegalArgumentException if either <code>lengthUnits</code> or
     * <code>areaUnits</code> is null.
     */
    ...
    /**
     * Constructs an instance that display length and area in specified units,
     * and angles in a specified format.
     *
     * @param lengthUnits the desired length units. Available length units are <code>METERS, KILOMETERS, MILES,
     *                    NAUTICAL_MILES, YARDS</code> and <code>FEET</code>.
     * @param areaUnits the desired area units. Available area units are <code>SQUARE_METERS, SQUARE_KILOMETERS,
     *                    HECTARE, ACRE, SQUARE_YARD</code> and <code>SQUARE_FEET</code>.
     * @param showDMS true if the desired angle format is
     * degrees-minutes-seconds, false if the format is decimal degrees.
     *
     * @throws IllegalArgumentException if either <code>lengthUnits</code> or
     * <code>areaUnits</code> is null.
     */
    ...
    /**
     * Establishes the labels to use when displaying values other than length
     * and area. A label is a string placed before the value and its units.
     * Examples are <em>Latitude</em> 24.36, <em>UTM Zone:</em> 12, and <em>Eye
     * Altitude:</em> 500 km, where the emphasized terms are the labels.
     * Subclasses can override this method to establish labels other than the
     * defaults. The default labels are drawn from the current message
     * properties. The recognized labels are those indicated by the "LABEL_"
     * constants defined by this class or by its subclasses.
     */
    ...
    /**
     * Establishes the format declarations to use for certain values. Examples
     * are " %,12.1f %s" for lengths and " %,11.1f" for UTM northings.
     * Subclasses can override this method to establish formats other than the
     * defaults. The value types that have associated formats are indicated by
     * the "FORMAT_" constants defined by this class or by its subclasses.
     */
    ...
    /**
     * Set the label of a specified value type. See {@link #setDefaultLabels()}
     * for a description and examples of labels.
     *
     * @param labelName a key identifying the label type. Available names are
     * those indicated by the "LABEL_" constants defined by this class or by its
     * subclasses
     * @param label the label to use for the specified value type.
     *
     * @throws IllegalArgumentException if either the label or label name is
     * null.
     */
    ...
    /**
     * Set the format of a specified value type. See
     * {@link #setDefaultFormats()} for a description and examples of formats.
     *
     * @param formatName a key identifying the value type that is to have the
     * specified format. Available types are those indicated by the "FORMAT_"
     * constants defined by this class or by its subclasses
     * @param format the label to use for the specified value type.
     *
     * @throws IllegalArgumentException if either the format or format name are
     * null.
     */
     ...
     *
     * @return true if angles are displayed in degrees-minutes seconds, false if
     * they're displayed in decimal degrees.
     */
     ...
     *
     * @param showDMS true to display angles in degrees-minutes seconds, false
    ...
    /**
     * Returns the units symbol for the current length units. Examples are "m"
     * for meters and "Nm" for nautical miles.
     *
     ...
     *
     * @return the current length units. See
     * {@link #UnitsFormat(String, String, boolean)} for the list of those
     * available.
     */
    ...
    /**
     * Specifies the units in which to display length values. Units subsequently
     * formatted by the instance are converted from meters to the desired units
     * prior to formatting.
     *
     * @param lengthUnits the desired length units. See
     * {@link #UnitsFormat(String, String, boolean)} for the list of those
     * available.
     *
    ...
    /**
     * Indicates the multiplier used to convert from meters to the current
     * length units.
     *
     * @return the conversion multiplier to convert meters to the current length
     * units.
     */
    ...
    /**
     * Returns the units symbol for the current altitude units. Examples are "m"
     * for meters and "Nm" for nautical miles.
     *
     ...
     *
     * @return the current altitude units. See
     * {@link #UnitsFormat(String, String, boolean)} for the list of those
     * available.
     */
    ...
    /**
     * Specifies the units in which to display altitude values. Units
     * subsequently formatted by the instance are converted from meters to the
     * desired units prior to formatting.
     *
     * @param altitudeUnits the desired altitude units. See
     * {@link #UnitsFormat(String, String, boolean)} for the list of those
     * available.
     *
     * @throws IllegalArgumentException if <code>lengthUnits</code> is null.
     ...
     * altitude units.
     *
     * @return the conversion multiplier to convert meters to the current
     * altitude units.
     */
     ...
     *
     * @return the current area units. See
     * {@link #UnitsFormat(String, String, boolean)} for the list of those
     * available.
     */
    ...
    /**
     * Specifies the units in which to display area values. Units subsequently
     * formatted by the instance are converted from square meters to the desired
     * units prior to formatting.
     *
     * @param areaUnits the desired length units. See
     * {@link #UnitsFormat(String, String, boolean)} for the list of those
     * available.
     *
    ...
    /**
     * Indicates the multiplier used to convert from square meters to the
     * current area units.
     *
     * @return the conversion multiplier to convert square meters to the current
     * area units.
     */
    ...
    /**
     * Returns the units symbol for the current area units. Examples are
     * "m\u00b2" for square meters and "miles\u00b2" for square miles.
     *
     ...
     * Recognized systems are {@link
     * #METRIC_SYSTEM}, which uses kilometers and square kilometers, and
     * {@link #IMPERIAL_SYSTEM}, which uses miles and square miles.
     *
     * @param unitsSystem the desired units system, either
     * <code>METRIC_SYSTEM</code> or <code>IMPERIAL_SYSTEM</code>.
     *
    ...
    /**
     * Indicates the unit system of the current length units. The available
     * systems are {@link #METRIC_SYSTEM} and {@link #IMPERIAL_SYSTEM}.
     *
    ...
    /**
     * Indicates the unit system of the current area units. The available
     * systems are {@link #METRIC_SYSTEM} and {@link
     * #IMPERIAL_SYSTEM}.
     *
     ...
     * <p>
     * The value is formatted using the current {@link #LABEL_LATITUDE} and
     * angle format.
     *
     * @param angle the angle to format.
     *
     * @return a string containing the formatted angle and ending with the
     * new-line character.
     *
     ...
     * <p>
     * The value is formatted using the current {@link #LABEL_LONGITUDE} and
     * angle format.
     *
     * @param angle the angle to format.
     *
    ...
    /**
     * Format an angle of heading according to the current angle format, and
     * append a new-line character.
     * <p>
     * The value is formatted using the current {@link #LABEL_HEADING} and angle
     * format.
     *
    ...
    /**
     * Format an angle of heading in degrees according to the current angle
     * format, and append a new-line character.
     * <p>
     * The value is formatted using the current {@link #LABEL_HEADING} and
     * {@link #FORMAT_HEADING}. The default <code>FORMAT_HEADING</code> is "
     * %9.2f\u00b0".
     *
    ...
    /**
     * Format angles of latitude and longitude according to the current angle
     * format, and append a new-line character.
     * <p>
     * The values are formatted using the current
     * {@link #LABEL_LATLON_LAT}, {@link #LABEL_LATLON_LON} and angle format.
     *
     * @param latlon the angles to format.
     *
     * @return a string containing the formatted angles and ending with the
     * new-line character.
     *
    ...
    /**
     * Format angles with {@link #latLon2(gov.nasa.worldwind.geom.LatLon)} and
     * append a new-line character.
     *
     * @param latlon the angles to format.
     *
    ...
    /**
     * Format angles of latitude and longitude according to the current angle
     * format and in the form "20\u00B0N 85\u00B0S".
     *
     * @param latlon the angles to format.
     *
     * @return a string containing the formatted angles.
    ...
    /**
     * Format an angle according to the current angle format. Prepend a
     * specified label and append a new-line character.
     *
     * @param label a label to prepend to the formatted angle. May be null to
     * indicate no label.
     * @param angle the angle to format.
     *
     * @return a string containing the formatted angle prepended with the
     * specified label and ending with the new-line character.
     *
     * @throws IllegalArgumentException if the angle is null.
     */
    ...
    /**
     * Format an eye altitude according to the current eye altitude format, and
     * append a new-line character.
     * <p>
     * The value is formatted using the current
     * {@link #LABEL_EYE_ALTITUDE}, {@link #FORMAT_EYE_ALTITUDE} and length
     * format.
     *
     * @param metersAltitude the eye altitude to format, in meters.
     *
     * @return a string containing the formatted eye altitude and ending with
    ...
    /**
     * Format an angle of pitch according to the current angle format, and
     * append a new-line character.
     * <p>
     * The value is formatted using the current {@link #LABEL_PITCH} and
     * {@link #FORMAT_PITCH}. The default <code>FORMAT_PITCH</code> is "
     * %9.2f\u00b0".
     *
    ...
    /**
     * Format a UTM zone according to the current UTM zone format and append a
     * new-line character.
     * <p>
     ...
     * <p>
     * The value is formatted using the current {@link #LABEL_UTM_NORTHING} and
     * current {@link #FORMAT_UTM_NORTHING}. The default UTM northing format is
     * " %,11.1f". No units symbol is included in the formatted string because
     * UTM northing units are always meters.
     *
     ...
     * and append a new-line character.
     * <p>
     * The value is formatted using the current {@link #LABEL_UTM_EASTING} and
     * current {@link #FORMAT_UTM_EASTING}. The default UTM easting format is "
     * %,11.1f". No units symbol is included in the formatted string because UTM
     * easting units are always meters.
     *
    ...
    /**
     * Format a terrain height value according to the current configuration and
     * append a new-line character. See {@link
     ...
     * <p>
     * The value is formatted using the current
     * {@link #LABEL_TERRAIN_HEIGHT}, {@link #FORMAT_TERRAIN_HEIGHT} and length
     * units symbol. The default terrain height format is " (ve %3.1f): %,6d
     * %s", where the %3.1f specifier stands for the vertical exaggeration, the
     * %,6d specifier stands for the terrain height, and the %s specifier stands
     * for the units symbol.
     * <p>
     * Note: While the <code>FORMAT_TERRAIN_HEIGHT</code> string may be
     * specified by the application, the terrain height components are always
     * passed to the internal formatter in the order: vertical exaggeration,
     * terrain height, units symbol.
     *
     * @param metersElevation the terrain height in meters.
     * @param verticalExaggeration the vertical exaggeration to apply to the
     * terrain height.
    ...
    /**
     * Format a length according to the current length configuration. Prepend a
     * specified label and append a new-line character.
     * <p>
     * The value is formatted using the current {@link #FORMAT_LENGTH} and
     * length units symbol, and is converted to the current length units prior
     * to formatting. The default length format is " %,12.1f %s", where the %s
     * specifier stands for the units symbol.
     *
     * @param label the label to prepend to the formatted length. May be null to
     * indicate no label.
     * @param meters the length to format, in meters.
     *
     * @return the formatted length with the specified label prepended and a
     * new-line character appended.
     */
     ...
     * Prepend a specified label and append a new-line character.
     * <p>
     * The value is formatted using the current {@link #FORMAT_AREA} and area
     * units symbol, and is converted to the current area units prior to
     * formatting. The default area format is " %,12.1f %s", where the %s
     * specifier stands for the units symbol.
     *
     * @param label the label to prepend to the formatted length. May be null to
     * indicate no label.
     ...
     *
     * @return the formatted area with the specified label prepended and a
     * new-line character appended.
     */
    ...
    /**
     * Format an area value according to the current length configuration and
     * prepend a specified label.
     * <p>
     * The value is formatted using the current {@link #FORMAT_AREA} and area
     * units symbol, and is converted to the current area units prior to
     * formatting. The default area format is " %,12.1f %s", where the %s

...
/**
 * CompoundStringBuilder provides a mechanism for storing and retrieving a
 * collection of variable length strings in a single {@link StringBuilder}.
 *
 * @author dcollins
...
public class CompoundStringBuilder {
    ...
    /**
     * Constructs a CompoundStringBuilder with the specified backing
     * StringBuilder and initial capacity.
     *
     ...
     *
     * @throws IllegalArgumentException if the stringBuilder is null or if the
    ...
    /**
     * Constructs a CompoundStringBuilder with a default backing StringBuilder,
    ...
    /**
     * Appends the contents of the specified substring to the end of this
     * CompoundStringBuilder, incrementing the number of substrings by one. The
     * backing buffer grows to accomodate the sub-buffer if it does not already
     * have enough capacity to hold it.
     *
    ...
    /**
     * Clears this CompoundStringBuilder's backing StringBuilder and sets the
     * number of substrings to zero. This does not free any memory associated
     * with this CompoundStringBuilder.
     */
    public void clear() {

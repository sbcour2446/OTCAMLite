...
/**
 * BufferWrapper provides an interface for reading and writing primitive data to
 * and from data buffers, without having to know the underlying data type.
 * BufferWrapper may be backed by a primitive data buffer of any type.
 *
 * @author tag
...
public abstract class BufferWrapper {
    ...
    /**
     * Returns the length of the buffer, in units of the underlying data type
     * (e.g. bytes, shorts, ints, floats, doubles).
     *
    ...
    /**
     * Returns the OpenGL data type corresponding to the buffer's underlying
     * data type (e.g. GL_BYTE, GL_SHORT, GL_INT, GL_FLOAT, GL_DOUBLE).
     *
    ...
    /**
     * Sets the value at the specified index as a byte. The byte is cast to the
    ...
    /**
     * Sets the value at the specified index as a short. The short is cast to
    ...
    /**
     * Sets the value at the specified index as an int. The int is cast to the
     * underlying data type.
     *
     * @param index the index of the value to be returned.
    ...
    /**
     * Sets the value at the specified index as a float. The float is cast to
     * the underlying data type.
     *
     * @param index the index of the value to be returned.
    ...
    /**
     * Sets the value at the specified index as a double. The double is cast to
     * the underlying data type.
     *
     * @param index the index of the value to be returned.
    ...
    /**
     * Returns the sequence of values starting at the specified index and with
     * the specified length, cast to bytes.
     *
    ...
    /**
     * Sets the sequence of values starting at the specified index and with the
     * specified length, as bytes. The bytes are cast to the underlying data
     * type.
     *
     * @param index the buffer starting index.
     * @param array the array.
    ...
    /**
     * Returns the sequence of values starting at the specified index and with
     * the specified length, cast to shorts.
     *
     * @param index the buffer starting index.
     * @param array the array.
     * @param offset the array starting index.
    ...
    /**
     * Sets the sequence of values starting at the specified index and with the
     * specified length, as ints. The ints are cast to the underlying data type.
     *
     * @param index the buffer starting index.
     * @param array the array.
     * @param offset the array starting index.
    ...
    /**
     * Returns the sequence of values starting at the specified index and with
     * the specified length, cast to ints.
     *
     * @param index the buffer starting index.
     * @param array the array.
     * @param offset the array starting index.
    ...
    /**
     * Returns the sequence of values starting at the specified index and with
     * the specified length, cast to floats.
     *
     * @param index the buffer starting index.
     * @param array the array.
     * @param offset the array starting index.
    ...
    /**
     * Sets the sequence of values starting at the specified index and with the
     * specified length, as floats. The floats are cast to the underlying data
     * type.
     *
     * @param index the buffer starting index.
     * @param array the array.
    ...
    /**
     * Returns the sequence of values starting at the specified index and with
     * the specified length, cast to doubles.
     *
     * @param index the buffer starting index.
     * @param array the array.
     * @param offset the array starting index.
    ...
    /**
     * Sets the sequence of values starting at the specified index and with the
     * specified length, as doubles. The doubles are cast to the underlying data
     * type.
     *
     * @param index the buffer starting index.
     * @param array the array.
    ...
    /**
     * Returns a new BufferWrapper which is a subsequence of this buffer. The
     * new buffer starts with the value at the specified index, and has the
     * specified length. The two buffers share the same backing store, so
     * changes to this buffer are reflected in the new buffer, and vice versa.
     *
     ...
     * buffer. The subsequence to set starts with the value at the specified
     * index, and has length equal to the specified buffer's length.
     *
     ...
     * Sets a subsequence of this buffer with the contents of the specified
     * buffer. The subsequence to set starts with the value at the specified
     * index, and has length equal to the specified length.
     *
     * @param index the starting index to set.
     * @param buffer the buffer.
    ...
    /**
     * Returns a copy of this buffer with the specified new size. The new size
     * must be greater than or equal to this buffer's size. If the new size is
     * greater than this buffer's size, this returns a new buffer which is
     * partially filled with the contents of this buffer. The returned buffer
     * has the same backing buffer type, but its contents are independent from
     * this VecBuffer.
     *
    ...
    /**
     * Returns the buffer's backing data sture. For the standard BufferWrapper
     * types (ByteBufferWrapper, ShortBufferWrapper, IntBufferWrapper,
     * FloatBufferWrapper, and DoubleBufferWrapper), this returns the backing
     * {@link Buffer}.
     *
    ...
    //**************************************************************//
    /**
     * Returns the empty BufferWrapper. The returned BufferWrapper is immutable
     * and has no backing Buffer.
     *
    ...
    /**
     * Wraps the specified {@link ByteBuffer} with a BufferWrapper according to
     * the specified primitive dataType and byteOrder. The dataType describes
     * the primitive data type stored in the ByteBuffer: shorts, ints, floats,
     * or doubles. The byteOrder describes the ByteBuffer's byte ordering. A
     * null byteOrder indicates that the ByteBuffer's current byte ordering
     * should be used.
     *
     * @param byteBuffer the buffer to wrap.
     * @param dataType the primitive data type stored in the ByteBuffer.
     * @param byteOrder the primitive byte ordering of the ByteBuffer, or null
     * to use the ByteBuffer's current ordering.
     *
     * @return a new BufferWrapper backed by the specified byteBuffer.
     *
     * @throws IllegalArgumentException if either the byteBuffer or the data
     * type are null.
     */
    ...
    /**
     * Wraps the specified {@link ByteBuffer} with a BufferWrapper according to
     * the specified primitive dataType. The dataType describes the primitive
     * data type stored in the ByteBuffer: shorts, ints, floats, or doubles.
     * This assumes the ByteBuffer's current byte ordering.
     *
     * @param byteBuffer the buffer to wrap.
     * @param dataType the primitive data type stored in the ByteBuffer.
     *
    ...
    /**
     * Wraps the specified {@link ByteBuffer} with a BufferWrapper according to
     * the specified parameters. The {@link
     * AVKey#DATA_TYPE} parameter is required, and describes the primitive data
     * type stored in the ByteBuffer: shorts, ints, floats, or doubles. The
     * {@link AVKey#BYTE_ORDER} parameter is optional, and describes the
     ...
     * @return a new BufferWrapper backed by the specified byteBuffer.
     *
     * @throws IllegalArgumentException if either the byteBuffer or the
     * parameters are null, or if AVKey.DATA_TYPE parameter is missing.
     */

...
/**
 * Factory implementation for creating WebView instances. This implementation
 * detected the operating system, and creates an instance of WebView appropriate
 * for that system. On Windows, it creates {@link WindowsWebView}. On Mac OS, it
 * creates {@link MacWebView}. Other operating systems are not supported at this
 * time.
 *
 * @author dcollins
...
public class BasicWebViewFactory implements WebViewFactory {
    ...
    /**
     * Create a WebView for Linux. This implementation throws
     * UnsupportedOperationException. Subclasses may override this method to add
     * Linux support to the factory.
     *
     * @param frameSize The size in pixels of the WebView's window frame.
     *
     * @return WebView for Linux.
     *
     * @throws UnsupportedOperationException Linux WebView is not supported at
     * this time.
     */
    ...
    /**
     * Create a WebView for an operating system other than Windows, Mac, or
     * Linux. This implementation throws UnsupportedOperationException.
     * Subclasses may override this method to add support for another operating
     ...
     *
     * @throws UnsupportedOperationException WebView is only implemented for
     * Windows and Mac at this time.
     */

...
public class MacWebView extends AbstractWebView {
    ...
    /**
     * The address of the native WebViewWindow object. Initialized during
     * construction.
     */
    ...
    /**
     * Not implemented. MacWebView generates transparent WebView textures, so
     * setting a background color is not necessary. The texture can be drawn
     * over the desired background color.
     */
    ...
    protected class MacWebViewTexture extends WebViewTexture {
        ...
        /**
         * Indicates whether updating this <code>WebViewTexture's</code> OpenGL
         * texture has failed. When <code>true</code>, this
         * <code>WebViewTexture's</code> stops attempting to update its texture.

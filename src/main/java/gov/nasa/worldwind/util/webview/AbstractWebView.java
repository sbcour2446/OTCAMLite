...
public abstract class AbstractWebView extends WWObjectImpl implements WebView, Disposable {
    ...
    /**
     * The size of the WebView frame in pixels. Initially null, indicating the
     * default size is used.
     */
    protected Dimension frameSize;
    /**
     * The WebView's current texture representation. Lazily created in
     * {@link #getTextureRepresentation}.
     */

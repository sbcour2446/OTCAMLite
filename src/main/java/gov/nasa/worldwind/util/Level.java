...
//            0.5 * (this.tileDelta.getLatitude().getRadians() + this.tileDelta.getLongitude().getRadians());
     ...
     *
     * @return null if valid, otherwise a <code>String</code> containing a
     ...
     * @param imageFormat a string identifying the mime type of the desired
     * image format
     *
     * @return the resource URL.
     *
     * @throws java.net.MalformedURLException if the URL cannot be formed from

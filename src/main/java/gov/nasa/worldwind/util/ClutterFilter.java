...
/**
 * Provides a mechanism to track the screen region of rendered items and
 * determine whether that region overlaps with regions already rendered. Used by
 * global text decluttering.
 *
 * @author tag

...
public class GeometryBuilder {
    ...
    /**
     * Bit code indicating that the leader's location is to the right of the
     * rectangle. Used by <code>{@link
     * #computeLeaderLocationCode(float, float, float, float, float, float)}</code>.
     */
    protected static final int LEADER_LOCATION_RIGHT = 4;
    /**
     * Bit code indicating that the leader's location is to the left of the
     * rectangle. Used by <code>{@link
     * #computeLeaderLocationCode(float, float, float, float, float, float)}</code>.
     */
...
//        }
    ...
    //**************************************************************//
    /**
     * Creates a vertex buffer for a two-dimensional ellipse centered at the
     * specified location and with the specified radii. The ellipse's center is
     * placed at <code>(x, y)</code>, it has a width of
     * <code>2 * majorRadius</code>, and a height of
     * <code>2 * minorRadius</code>.
     * <p>
     * If the specified <code>slices</code> is greater than 1 this returns a
     * buffer with vertices evenly spaced along the circumference of the
     * ellipse. Otherwise this returns a buffer with one vertex.
     * <p>
     * The returned buffer contains pairs of xy coordinates representing the
     * location of each vertex in the ellipse in a counter-clockwise winding
     * order relative to the z axis. The buffer may be rendered in OpenGL as
     * either a triangle fan or a line loop.
     *
     ...
     *
     * @throws IllegalArgumentException if any of <code>majorRadius</code>,
     * <code>minorRadius</code>, or <code>slices</code> are less than zero.
     */
     ...
     * ellipse. Otherwise this returns a buffer with one vertex.
     * <p>
     * If the specified <code>leaderWidth</code> is greater than zero and the
     * location <code>(leaderX, leaderY)</code> is outside of the rectangle that
     * encloses the ellipse, the ellipse has a triangle attached to one side
     * with with its top pointing at <code>(leaderX, leaderY)</code>. Otherwise
     * this returns an ellipse with no leader and is equivalent to calling
     * <code>{@link #makeEllipse(float, float, float, float, int)}</code>. The
     * leader is attached at the center of either the top, bottom, left, or
     * right side, depending on the leader's location relative to the ellipse.
     * The leader width is limited in size by the side it is attached to. For
     * example, if the leader is attached to the ellipse's bottom, its width is
     * limited by the ellipse's major radius.
     *
     * @param x the x-coordinate of the ellipse's center.
     * @param y the y-coordinate of the ellipse's center.
     * @param majorRadius the ellipse's radius along the x axis.
     ...
     *
     * @throws IllegalArgumentException if any of <code>majorRadius</code>,
     * <code>minorRadius</code>, <code>slices</code>, or
     * <code>leaderWidth</code> are less than zero.
     */
    ...
    /**
     * Creates a vertex buffer for a two-dimensional rectangle at the specified
     * location, and with the specified size. The rectangle's lower left corner
     * is placed at <code>(x, y)</code>, and its upper right corner is placed at
     * <code>(x + width, y + height)</code>.
     * <p>
     * The returned buffer contains pairs of xy coordinates representing the
     * location of each vertex in the rectangle in a counter-clockwise winding
     * order relative to the z axis. The buffer may be rendered in OpenGL as
     * either a triangle fan or a line loop.
     *
     ...
     * <code>height</code> are less than zero.
     */
    ...
    /**
     * Creates a vertex buffer for a two-dimensional rectangle at the specified
     * location, with the specified size, and with optionally rounded corners.
     * The rectangle's lower left corner is placed at the <code>(x, y)</code>,
     * and its upper right corner is placed at
     * <code>(x + width, y + height)</code>.
     * <p>
     * If the specified <code>cornerRadius</code> and <code>cornerSlices</code>
     * are greater than 0, the rectangle's corners have a rounded appearance.
     * The radius specifies the size of a rounded corner, and the slices
     * specifies the number of segments that make a rounded corner. If either
     * <code>cornerRadius</code> or <code>cornerSlices</code> are 0, this
     * returns a rectangle with sharp corners and is equivalent to calling
     * <code>{@link #makeRectangle(float, float, float, float)}</code>. The
     * <code>cornerRadius</code> is limited by the rectangle's width and height.
     * For example, if the corner radius is 100 and the width and height are 50
     * and 100, the actual corner radius used is 25 - half of the rectangle's
     * smallest dimension.
     * <p>
     * The returned buffer contains pairs of xy coordinates representing the
     * location of each vertex in the rectangle in a counter-clockwise winding
     ...
     * @param width the rectangle's width.
     * @param height the rectangle's height.
     * @param cornerRadius the rectangle's rounded corner radius, or 0 to
     * disable rounded corners.
     * @param cornerSlices the number of slices in each rounded corner, or 0 to
     * disable rounded corners.
     *
     * @return a buffer containing the rectangle's x and y locations.
     *
     * @throws IllegalArgumentException if any of <code>width</code>,
     * <code>height</code>, <code>cornerRadius</code>, or
    ...
    /**
     * Creates a vertex buffer for a two-dimensional rectangle at the specified
     * location, with the specified size, and with an optional leader pointing
     * to the specified leader location. The rectangle's lower left corner is
     * placed at <code>(x, y)</code>, and its upper right corner is placed at
     * <code>(x + width, y + height)</code>.
     * <p>
     * If the specified <code>leaderWidth</code> is greater than zero and the
     * location <code>(leaderX, leaderY)</code> is outside of the rectangle, the
     * rectangle has a triangle attached to one side with with its top pointing
     * at <code>(leaderX, leaderY)</code>. Otherwise this returns a rectangle
     * with no leader and is equivalent to calling
     * <code>{@link #makeRectangle(float, float, float, float)}</code>. The
     * leader is attached at the center of either the top, bottom, left, or
     * right side, depending on the leader's location relative to the rectangle.
     * The leader width is limited in size by the side it is attached to. For
     * example, if the leader is attached to the rectangle's bottom, its width
     * is limited by the rectangle's width.
     * <p>
     * The returned buffer contains pairs of xy coordinates representing the
     * location of each vertex in the rectangle in a counter-clockwise winding
     * order relative to the z axis. The buffer may be rendered in OpenGL as
     ...
     *
     * @throws IllegalArgumentException if any of <code>width</code>,
     * <code>height</code>, or <code>leaderWidth</code> are less than zero.
     */
     ...
     * <code>cornerRadius</code> or <code>cornerSlices</code> are 0, this
     * returns a rectangle with sharp corners and is equivalent to calling
     * <code>{@link #makeRectangleWithLeader(float, float, float, float, float, float, float)}
     * </code>. The <code>cornerRadius</code> is limited by the rectangle's
     * width and height. For example, if the corner radius is 100 and the width
     * and height are 50 and 100, the actual corner radius used is 25 - half of
     * the rectangle's smallest dimension.
     * <p>
     * If the specified <code>leaderWidth</code> is greater than zero and the
     * location <code>(leaderX, leaderY)</code> is outside of the rectangle, the
     * rectangle has a triangle attached to one side with with its top pointing
     * at <code>(leaderX, leaderY)</code>. Otherwise this returns a rectangle
     * with no leader and is equivalent to calling
     * <code>{@link #makeRectangle(float, float, float, float, float, int)}</code>.
     * The leader is attached at the center of either the top, bottom, left, or
     * right side, depending on the leader's location relative to the rectangle.
     * The leader width is limited in size by the side it is attached to. For
     * example, if the leader is attached to the rectangle's bottom, its width
     * is limited by the rectangle's width minus any area used by the rounded
     * corners.
     * <p>
     * The returned buffer contains pairs of xy coordinates representing the
     * location of each vertex in the rectangle in a counter-clockwise winding
     ...
     *
     * @throws IllegalArgumentException if any of <code>width</code>,
     * <code>height</code>, <code>cornerRadius</code>,
     * <code>cornerSlices</code>, or <code>leaderWidth</code> are less than
     * zero.
     */
    ...
    /**
     * Adds the vertices for one rounded corner of a two-dimensional rectangular
     * to the specified <code>buffer</code>. This assumes that the first and
     * last vertices of each corner are created by the caller, so this adds only
     * the intermediate vertices. The number of intermediate vertices is equal
     * to <code>slices - 2</code>. This does nothing if <code>slices</code> is
     * one or zero.
     *
    ...
    /**
     * Returns a four bit code indicating the leader's location within the
     * specified rectangle. The rectangle's lower left corner is located at
     * <code>(x1, y1)</code> and its upper right corner is located at
     * <code>(x2, y2)</code>. The returned code includes the bit for any of
     * <code>LEADER_LOCATION_LEFT</code>, <code>LEADER_LOCATION_RIGHT</code>,
     * <code>LEADER_LOCATION_BOTTOM</code>, and
     * <code>LEADER_LOCATION_TOP</code>, depending on whether the leader is
     * located to the left, right, bottom, or top of the rectangle. If the
     * leader is inside the rectangle, this returns
     * <code>LEADER_LOCATION_INSIDE</code>.
     *
     ...
     *
     * @return a four bit code indicating the leader's location relative to the
     * rectangle.
     */

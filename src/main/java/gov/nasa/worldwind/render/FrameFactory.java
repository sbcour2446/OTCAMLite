 ...
 * <p>
 * All shapes are drawn inside a bounding rectangle whose lower left corner is
 * at the origin. Shapes with a leader use an offset point that indicate where
 * the leader triangle should point at - it usually has a negative y since the
...
public class FrameFactory {
    ...
    /**
     * Draw a shape with the specified width and height, gl mode and corner
     * radius. GL mode came be one of <code>GL.GL_TRIANGLE_FAN</code> and
     * <code>GL.LINE_STRIP</code>. Corner radius only apply to
     * <code>SHAPE_RECTANGLE</code> - set to zero for square corners.
     *
     * @param dc the current <code>DrawContext</code>.
     * @param shape the shape - can be one of <code>SHAPE_RECTANGLE</code> or
     * <code>SHAPE_ELLIPSE</code>.
     * @param width the width of the overall shape.
     * @param height the height of the shape.
     * @param glMode the GL mode - can be one of <code>GL.GL_TRIANGLE_FAN</code>
     * and <code>GL.LINE_STRIP</code>.
     * @param cornerRadius the rounded corners radius. Set to zero for square
     * corners.
     */
    ...
    /**
     * Draw a shape with the specified width and height, gl mode and corner
     * radius. The shape includes a leader triangle pointing to a specified
     * point. GL mode came be one of <code>GL.GL_TRIANGLE_FAN</code> and
     * <code>GL.LINE_STRIP</code>. Corner radius only apply to
     * <code>SHAPE_RECTANGLE</code> - set to zero for square corners.
     *
     * @param dc the current <code>DrawContext</code>.
     ...
     * @param leaderOffset the coordinates of the point to which the leader
     * leads.
    ...
    /**
     * Create a vertex buffer for a shape with the specified width, height and
     * corner radius. Corner radius only apply to <code>SHAPE_RECTANGLE</code> -
     ...
     * @param cornerRadius the rounded corners radius. Set to zero for square
     * corners.
     * @param buffer the buffer to store shape vertices, or null to allocate a
     * new buffer.
     *
    ...
    /**
     * Create a vertex buffer for a shape with the specified width, height and
     * corner radius. The shape includes a leader triangle pointing to a
     * specified point. Corner radius only apply to <code>SHAPE_RECTANGLE</code>
     * - set to zero for square corners.
     *
     * @param shape the shape - can be one of <code>SHAPE_RECTANGLE</code> or
     * <code>SHAPE_ELLIPSE</code>.
     ...
     * createShapeBuffer() methods support both <code>GL.GL_TRIANGLE_FAN</code>
     * and <code>GL.LINE_STRIP</code>.
     *
    ...
    /**
     * Draw a vertex buffer with texture coordinates in a given gl mode. Vertex
     * buffers coming from the createShapeBuffer() methods support both

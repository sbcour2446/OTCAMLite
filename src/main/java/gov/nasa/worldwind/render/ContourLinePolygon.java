...
/**
 * Renders a contour line on the terrain at a given elevation. The controur line
 * extent is bounded by a polygon defined by a list of {@link LatLon}.
 *
...
public class ContourLinePolygon extends ContourLine {
    ...
    /**
     * Get the list of {@link LatLon} that describe the current bounding
     * polygon.
     *
     * @return the list of {@link LatLon} that describe the current bounding
     * polygon.
     */
    ...
    /**
     * Set the list of {@link LatLon} that describes a closed polygon - one
     * which last position is equal to the first, used to delineate the extent
     * of the contour line.
     *
     * @param positions the list of {@link LatLon} that describe a closed
     * polygon.
     *
     ...
     * here the inclusion inside the current polygon.
     *

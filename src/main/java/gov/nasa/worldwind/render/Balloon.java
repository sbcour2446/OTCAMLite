...
/**
 * A text label that can be attached to a point on the screen, or a point on the
 * globe.
 *
 * @author pabercrombie
...
public interface Balloon extends Renderable, Highlightable, AVList {
     ...
     *
     * @param alwaysOnTop True if the balloon should always render above other
     * objects.
     */
    ...
    /**
     * Returns the delegate owner of the balloon. If non-null, the returned
     * object replaces the balloon as the pickable object returned during
     * picking. If null, the balloon itself is the pickable object returned
     * during picking.
     *
     * @return the object used as the pickable object returned during picking,
     * or null to indicate the the balloon is returned during picking.
     */
    Object getDelegateOwner();

    /**
     * Specifies the delegate owner of the balloon. If non-null, the delegate
     * owner replaces the balloon as the pickable object returned during
     * picking. If null, the balloon itself is the pickable object returned
     * during picking.
     *
     * @param owner the object to use as the pickable object returned during
     * picking, or null to return the balloon.
     */
    ...
    /**
     * Get the balloon bounding {@link java.awt.Rectangle} using OGL coordinates
     * - bottom-left corner x and y relative to the
     * {@link gov.nasa.worldwind.WorldWindow} bottom-left corner, and the
     * balloon callout width and height.
     * <p>
     * The balloon offset from it's reference point is factored in such that the
     * callout leader shape and reference point are included in the bounding
     * rectangle.
     *
     * @param dc the current DrawContext.
     *
     * @return the balloon bounding {@link java.awt.Rectangle} using OGL
    ...
    /**
     * Returns the minimum eye altitude, in meters, for which the balloon is
     * displayed.
     *
     * @return the minimum altitude, in meters, for which the balloon is
     * displayed.
     *
    ...
    /**
     * Specifies the minimum eye altitude, in meters, for which the balloon is
     * displayed.
     *
     * @param minActiveAltitude the minimum altitude, in meters, for which the
    ...
    /**
     * Returns the maximum eye altitude, in meters, for which the balloon is
     * displayed.
     *
     * @return the maximum altitude, in meters, for which the balloon is
     * displayed.
     *
     * @see #setMaxActiveAltitude(double)
     * @see #getMinActiveAltitude()
    ...
    /**
     * Specifies the maximum eye altitude, in meters, for which the balloon is
     * displayed.
     *
     * @param maxActiveAltitude the maximum altitude, in meters, for which the
     * balloon is displayed.
     *
     * @see #getMaxActiveAltitude()
     * @see #setMinActiveAltitude(double)

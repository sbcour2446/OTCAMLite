 ...
 * <p>
 * When drawn on a 2D globe, this shape uses either a {@link SurfacePolyline} or
 * {@link SurfacePolygon} to represent itself.
 */
@Deprecated
public class Polyline extends AVListImpl implements Renderable, OrderedRenderable, Movable, Restorable,
     ...
     *
     * @param followTerrain <code>true</code> to follow the terrain, otherwise
     * <code>false</code>.
     */
     ...
     * parameter. Stipple is also affected by the path's stipple factor, {@link
     ...
     * the OpenGL specification or programming guides for a description of this
     * parameter. Stipple is also affected by the path's stipple pattern, {@link
    ...
    /**
     * Sets the paths positions as latitude and longitude values at a constant
     * altitude.
     *

...
/**
 * A <code>{@link gov.nasa.worldwind.render.GlobeBalloon}</code> that displays
 * HTML, JavaScript, and Flash content using the system's native browser, and
 * who's origin is located at a position on the <code>Globe</code>.
 *
 * @author pabercrombie
...
public class GlobeBrowserBalloon extends AbstractBrowserBalloon implements GlobeBalloon {
    ...
    protected class OrderedGlobeBrowserBalloon extends OrderedBrowserBalloon {
        ...
        /**
         * The projection of this balloon's <code>placePoint</code> in the
         * viewport (on the screen). May be <code>null</code>.
         */
        protected Vec4 screenPlacePoint;
    }

    /**
     * Indicates this balloon's geographic position. The position's altitude is
     * interpreted relative to this balloon's <code>altitudeMode</code>.
     * Initialized to a non-<code>null</code> value at construction.
     */
    protected Position position;
    /**
     * Indicates how this balloon's altitude is interpreted. One of
     * <code>WorldWind.ABSOLUTE</code>,
     * <code>WorldWind.RELATIVE_TO_GROUND</code>, or
     * <code>WorldWind.CLAMP_TO_GROUND</code>. If the altitude mode is 0 or an
     * unrecognized code, this balloon assumes an altitude mode of
     * <code>WorldWind.ABSOLUTE</code>. Initially 0.
     */
    protected int altitudeMode;

    /**
     * Constructs a new <code>GlobeBrowserBalloon</code> with the specified text
     * content and position.
     *
     * @param text the balloon's initial text content.
     * @param position the balloon's initial position.
     *
     * @throws IllegalArgumentException if either <code>text</code> or
     * <code>position</code> are <code>null</code>.
     */
    ...
    /**
     * Computes and stores this balloon's model and screen coordinates. This
     * assigns balloon coordinate properties as follows:
     * <ul> <li><code>placePoint</code> - this balloon's model-coordinate point,
     * according to its altitude mode.</li>
     * <li><code>screenPlacePoint</code> - screen-space projection of the
     * <code>placePoint</code>.</li>
     * <li><code>screenOffset</code> - the balloon frame's screen-coordinate
     * offset from this balloon's <code>screenPlacePoint</code>.</li>
     * <li><code>screenRect</code> - the balloon frame's screen-coordinate
     * rectangle.</li> <li><code>screenExtent</code> - this balloon's
     * screen-coordinate bounding rectangle.</li>
     * <li><code>screenPickExtent</code> - this balloon's screen-coordinate
     * bounding rectangle, including area covered by the balloon's pickable
     * outline.</li> <li><code>webViewRect</code> - the WebView's
     * screen-coordinate content frame.</li> <li><code>eyeDistance</code> -
     * always 0.</li></ul>
     *
     ...
     * {@inheritDoc}
     * <p>
     * Overridden to return <code>false</code> if the balloon's position is
     * either behind the <code>View's</code> near clipping plane or in front of
     * the <code>View's</code> far clipping plane. Otherwise this delegates to
     * the super class' behavior.
     */
    @Override
     ...
     * {@inheritDoc}
     * <p>
     * Overridden to use this balloon's position as the picked object's
     * position.
     */
    @Override

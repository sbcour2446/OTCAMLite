...
/**
 * A general pyramid volume defined by a center position, a height, and two axis
 * lengths.
 *
 * @author ccrick
...
public class Pyramid extends RigidShape {
    ...
    /**
     * Construct a Pyramid from a specified center position, axes lengths and
     ...
     * @param verticalRadius the Pyramid's vertical radius, in meters.
     * @param eastWestRadius the Pyramid's east-west radius, in meters.
     * @param heading the Pyramid's azimuth, its rotation about its vertical
     * axis.
    ...
    /**
     * Returns the height of the Pyramid, which is just twice its vertical
     * radius.
     *
    ...
    /**
     * Specifies this Pyramid's height in meters. The height of the Pyramid is
     * just twice its vertical radius, so we just divide the height by two to
     * get the value for the verticalRadius. The height must be greater than 0.
     *
    ...
    /**
     * Specifies the width of the Pyramid's base in meters. The width of the
     * Pyramid is just twice its base's north-south and east-west radii, so we
     * just divide the width by two to get these values. The width must be
     * greater than 0.
     *
    ...
    //**************************************************************//
    /**
     * Sets the Geometry mesh for this Pyramid, either by pulling it from the
    ...
    /**
     * Generates a unit pyramid geometry, including the vertices, indices,
     * normals and texture coordinates, tessellated with the specified number of
     * divisions.
     *
     * @param subdivisions the number of times to subdivide the unit pyramid
     * geometry
     ...
     * @param subdivisions the number of times to subdivide the unit pyramid
     * geometry
     * @param meshes the Geometry list to hold the computed points, etc. for all
     * Geometries
     */
    ...
    /**
     * Renders the Pyramid, using data from the provided buffer and the given
     * parameters
     *

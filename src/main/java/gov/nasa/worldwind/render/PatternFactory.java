 ...
 * <p>
 * The <code>createPattern()</code> method draws a shape inside a usually square
 * bitmap, so that it will match if tiled.
 * </p>
 * <p>
 * Each pattern supports a <code>scale</code> factor between <code>zero</code>
 * and <code>one</code> - default is .5. With a scale of <code>zero</code> no
 * pattern will be produced. With a scale of <code>one</code> the pattern will
...
public class PatternFactory {
    ...
    /**
     * Draws a pattern using the default scale (.5), bitmap dimensions (32x32)
     * and colors (light grey over a transparent background).
     *
     * @param pattern the pattern to draw. See {@link PatternFactory} static
     * constants.
     ...
     * (.5), bitmap dimensions (32x32) and backgound color (transparent).
     *
     * @param pattern the pattern to draw. See {@link PatternFactory} static
     * constants.
    ...
    /**
     * Draws a pattern with a given <code>scale</code> using the default bitmap
     * dimensions (32x32) and colors (light grey over a transparent background).
     *
     * @param pattern the pattern to draw. See {@link PatternFactory} static
     * constants.
    ...
    /**
     * Draws a pattern with a given <code>scale</code> and <code>Color</code>
     * using the default bitmap dimensions (32x32) and backgound color
     * (transparent).
     *
     * @param pattern the pattern to draw. See {@link PatternFactory} static
     * constants.
    ...
    /**
     * Draws a pattern with a given <code>scale</code> and <code>Color</code>s
     * using the default bitmap dimensions (32x32).
     *
     * @param pattern the pattern to draw. See {@link PatternFactory} static
     * constants.
     * @param scale the scale at which the pattern should be drawn (0 to 1).
    ...
    /**
     * Draws a pattern with a given <code>scale</code>, <code>Color</code> and
     * bitmap dimensions, using the default backgound color (transparent).
     *
     * @param pattern the pattern to draw. See {@link PatternFactory} static
     * constants.
     * @param size the <code>Dimension</code> of the <code>BufferedImage</code>
     * produced.
     * @param scale the scale at which the pattern should be drawn (0 to 1).
     * @param lineColor the pattern <code>Color</code>.
     * @return the corresponding <code>BufferedImage</code>.
    ...
    /**
     * Draws a pattern with the given <code>scale</code>, <code>Color</code>s

...
public class SurfaceMultiPolygon extends AbstractSurfaceShape {
    ...
    /**
     * Constructs a new surface multi polygon with the default attributes and no
     * locations.
     */
    ...
    /**
     * Overridden to clear the multi-polygon's boundary list upon an
     * unsuccessful tessellation attempt. This ensures the multi-polygon won't
     * attempt to re-tessellate itself each frame.
     *

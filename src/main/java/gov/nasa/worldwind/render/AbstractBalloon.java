...
public abstract class AbstractBalloon extends WWObjectImpl implements Balloon {
    ...
    /**
     * Get text after it has been processed by the text decoder. Returns the
     * original text if there is no {@link
     * TextDecoder}.
     *
     * @return Decoded text.
     *
     ...
     *
     * @return Highlight attributes if the balloon is highlighted, or normal

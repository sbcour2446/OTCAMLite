 ...
 * <p>
 * The {@link MultiLineTextRenderer} (MLTR) handles wrapping, measuring and
 * drawing of multiline text strings using Sun's JOGL {@link TextRenderer}. </p>
 * <p>
 ...
 * implementation of HTML. Each type of text has its own methods though. </p>
 * <p>
 * <b>Usage:</b></p>
 * <p>
 * Instantiation:</p>
 * <p>
 * The MLTR needs a Font or a TextRenderer to be instantiated. This will be the
 * font used for text drawing, wrapping and measuring. For HTML methods this
 * font will be considered as the document default font. </p>
 * <pre>
 ...
 * it fits a given width in pixels. </p>
 * <p>
 ...
 * as it would be drawn with the current font. </p>
 * <p>
 * Note that textBounds.minX is the number of lines found and textBounds.minY is
 * the maximum line height for the font used. This value can be safely used as
 * the lineHeight argument when drawing - or can even be ommited after a
 ...
 * <li>&lt;p&gt;&lt;/p&gt;, &lt;br&gt; &lt;br /&gt;</li>
 * <li>&lt;b&gt;&lt;/b&gt;</li> <li>&lt;i&gt;&lt;/i&gt;</li>
 * <li>&lt;a href="..."&gt;&lt;/a&gt;</li> <li>&lt;font
 * color="#ffffff"&gt;&lt;/font&gt;</li> </ul> ...
 * <p>
...
public class MultiLineTextRenderer {
    ...
    /**
     * Get the current text alignment. Can be one of {@link AVKey#LEFT} the
    ...
    /**
     * Set the current text alignment. Can be one of {@link AVKey#LEFT} the
     * default, {@link AVKey#CENTER} or {@link
     * AVKey#RIGHT}.
     *
     ...
     *
     * @return the current background color used when drawing shadow or
     * outline..
     */
    ...
    /**
     * Set the character string appended at the end of text truncated during a
     * wrap operation when exceeding the given height limit.
     *
     ...
     * @param x the x position for top left corner of text rectangle.
     * @param y the y position for top left corner of the text rectangle.
     * @param effect the effect to use for the text rendering. Can be one of
    ...
    /**
     * Draw text with unique colors word bounding rectangles and add each as a
     * pickable object to the provided PickSupport instance.
     *
     * @param text the multi-line text to draw.
     * @param x the x position for top left corner of text rectangle.
     * @param y the y position for top left corner of the text rectangle.
     ...
     * @param refObject the user reference object associated with every picked
     * word.
     * @param refPosition the user reference Position associated with every
     * picked word.
     */
     ...
     * @param height if not zero, the maximum height in pixels the text can
     * occupy.
     *
    ...
    /**
     * Remove new line characters then replace BR and P tags with appropriate
     * new lines.
     *
    ...
    /**
     * Extract an attribute value from a HTML tag string. The attribute is
     * expected to be formed on the pattern: name="...". Other variants will
     * likely fail.
     *
    ...
    /**
     * Add 'new line' characters inside an html text string so that it's
     * bounding rectangle tries not to exceed the given dimension width.
     * <p>
     * If the dimension height is more than zero, the text will be truncated
     * accordingly and the continuation string will be appended to the last
     * line.
    ...
    /**
     * Draw a multi-line html text string with bounding rectangle top starting
     * at the y position. The x position is eiher the rectangle left side,
     * middle or right side depending on the current text alignement.
     *
     * @param text the multi-line text to draw
     * @param x the x position for top left corner of text rectangle
     * @param y the y position for top left corner of the text rectangle
    ...
    // -- HTML word iterator ------------------------------------
    /**
     * Iterates through words from an HTML text line. Note that returned 'words'
     * can contain html tags at any place, before, inside or after the word.
     */

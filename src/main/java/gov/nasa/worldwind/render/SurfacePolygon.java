...
public class SurfacePolygon extends AbstractSurfaceShape implements Exportable {
    ...
    /**
     * Constructs a new surface polygon with the default attributes and no
     * locations.
     */
    ...
    /**
     * Constructs a new surface polygon with the specified normal (as opposed to
     * highlight) attributes and no locations. Modifying the attribute reference
     * after calling this constructor causes this shape's appearance to change
     * accordingly.
     *
    ...
    /**
     * Constructs a new surface polygon with the default attributes and the
    ...
    /**
     * Constructs a new surface polygon with the specified normal (as opposed to
     * highlight) attributes and the specified iterable of locations. Modifying
    ...
    //**************************************************************//
    /**
     * Overridden to clear the polygon's locations iterable upon an unsuccessful
     * tessellation attempt. This ensures the polygon won't attempt to
     * re-tessellate itself each frame.
     *

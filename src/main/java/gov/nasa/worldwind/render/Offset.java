...
/**
 * Defines the relationship of an image, label or other screen-space item
 * relative to another screen-space item. An offset contains an X coordinate, a
 * Y coordinate, and for each of these a separate "units" string indicating the
 * coordinate units.
 * <p>
 * Recognized "units" values are {@link AVKey#PIXELS}, which indicates pixel
 * units relative to the lower left corner of the screen-space item,
 * {@link AVKey#FRACTION}, which indicates that the units are fractions of the
 * screen-space item's width and height, relative to its lower left corner, and
 * {@link AVKey#INSET_PIXELS}, which indicates units of pixels but with origin
 * at the screen-space item's upper right.
 * <p>
...
public class Offset {
     ...
     *
     * @param xFraction the offset's X coordinate as a fraction of the
     * containing rectangle.
     * @param yFraction the offset's Y coordinate as a fraction of the
     * containing rectangle.
     *
    ...
    /**
     * Returns the hot spot's X coordinate. See {@link #setXUnits(String)} for a
     * description of the hot spot.
     *
     ...
     * {@link #setXUnits(String)}.
     *
     * @param x the hot spot's X coordinate. May be null, in which case 0 is
    ...
    /**
     * Returns the hot spot's Y coordinate. See {@link #setYUnits(String)} for a
     * description of the hot spot.
     *
     ...
     * {@link #setYUnits(String)}.
     *
     * @param y the hot spot's Y coordinate. May be null, in which case 0 is
     * used during rendering.
     */
    ...
    /**
     * Returns the units of the offset X value. See {@link #setXUnits(String)}
     * for a description of the recognized values.
     *
    ...
    /**
     * Specifies the units of the offset X value. Recognized values are
     * {@link AVKey#PIXELS}, which indicates pixel units relative to the lower
     * left corner of the placemark image, {@link AVKey#FRACTION}, which
     * indicates the units are fractions of the placemark image width and
     * height, and {@link AVKey#INSET_PIXELS}, which indicates units of pixels
     * but with origin in the upper left.
     *
     * @param units the units of the offset X value. If null,
     * {@link AVKey#PIXELS} is used during rendering.
     */
    ...
    /**
     * Returns the units of the offset Y value. See {@link #setYUnits(String)}
     * for a description of the recognized values.
     *
    ...
    /**
     * Specifies the units of the offset Y value. Recognized values are
     * {@link AVKey#PIXELS}, which indicates pixel units relative to the lower
     * left corner of the placemark image, {@link AVKey#FRACTION}, which
     * indicates the units are fractions of the placemark image width and
     * height, and {@link AVKey#INSET_PIXELS}, which indicates units of pixels
     * but with origin in the upper left.
     *
     * @param units the units of the offset Y value. If null,
     * {@link AVKey#PIXELS} is used during rendering.
     */
    ...
    /**
     * Computes the X and Y offset specified by this offset applied to a
     * specified rectangle.
     *
     * @param width the rectangle width.
     * @param height the rectangle height.
     * @param xScale an optional scale to apply to the X coordinate of the
     * offset. May be null.
     * @param yScale an optional scale to apply to the Y coordinate of the
     * offset. May be null.
     *
     * @return the result of applying this offset to the specified rectangle and
     * incorporating the optional scales.
     */

...
public abstract class SurfaceTileRenderer implements Disposable {
    ...
    /**
     * Free internal resources held by this surface tile renderer. A GL context
    ...
    /**
     * Indicates how this SurfaceTileRenderer interprets image tile colors
     * during picking. When true, image tile RGB colors are drawn during
     * picking. When false, image tile RGB colors are replaced with the current
     * RGB color. Initially false.
     *
     * @return true if image tile RGB colors are drawn during picking, false if
     * image tile RGB colors are replaced by the current RGB color.
     */
    ...
    /**
     * Specifies how this SurfaceTileRenderer interprets image tile colors
     * during picking. When true, image tile RGB colors are drawn during
     * picking. When false, image tile RGB colors are replaced with the current
     * RGB color.
     *
     * @param useImageTilePickColors true if image tile RGB colors should be
     * drawn during picking, false if image tile RGB colors should be replaced
     * by the current RGB color.
     */

...
public interface ScreenBalloon extends Balloon {
    ...
    /**
     * Set the screen position of the balloon. This point is interpreted in a
     * coordinate system with the origin at the upper left corner of the screen.
     *
     * @param point Point in screen coordinates, with origin at upper left
     * corner.
     */

...
/**
 * Renders a contour line on the terrain at a given elevation. The contour line
 * extent can be bounded by a <code>Sector</code>.
 *
...
public class ContourLine implements Renderable {
     ...
     * performed, otherwise <code>false</code> (the default).
     */
    @SuppressWarnings({"UnusedDeclaration"})
    ...
    /**
     * Update the renderable list with appropriate renderables to display the
     * contour line.
     *
    ...
    /**
     * Filters the given intersection segments list according to the current
     * view frustum.
     *
     * @param dc the current <code>DrawContext</code>
    ...
    /**
     * Filters the given intersection segments list according to some criteria -
     * here the inclusion inside the bounding sector.
     *
     * @param dc the current <code>DrawContext</code>
     * @param list the list of <code>Intersection</code> to be filtered.
     *
    ...
    /**
     * Add a set of <code>Path</code> objects to the contour line renderable
     * list by connecting as much as possible the segments from the given
     * <code>Intersection</code> array.
     *
     * @param dc the current <code>DrawContext</code>.

...
public class FramebufferTexture implements WWTexture {
    ...
    /**
     * The density of explicit texture coordinates to specify for the
     * quadrilateral the texture's applied to.
     */
    protected int tessellationDensity;

    /**
     * The default density of texture coordinates to specify for the
     * quadrilateral the texture's applied to.
     */

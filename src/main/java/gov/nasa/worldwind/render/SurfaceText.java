...
/**
 * Renders a string of text on the surface of the globe. The text will appear
 * draped over terrain. Surface text is drawn at a constant geographic size: it
 * will appear larger when the view zooms in on the text and smaller when the
 * view zooms out.
 *
 * @author pabercrombie
...
public class SurfaceText extends AbstractSurfaceObject implements GeographicText, Movable, Draggable {
    ...
    /**
     * Default offset. The default offset centers the text on its geographic
    ...
    /**
     * Background color for the text. By default color will be generated to
     * contrast with the text color.
     */
    ...
    /**
     * Offset that specifies where to place the text in relation to it's
     * geographic position.
     */
    ...
    /**
     * Scaling factor applied to the text to maintain a constant geographic
     * size.
     */
     ...
     * {@inheritDoc}
     * <p>
     * The offset determines how the text is placed relative to this position.
     * The default offset centers the text on the position both horizontally and
     * vertically.
     *
    ...
    /**
     * Returns the text offset. The offset determines how to position the text
    ...
    /**
     * Specifies a location relative to the label position at which to align the
     * label. The label text begins at the point indicated by the offset. An
     * offset of (0, 0) aligns the left baseline of the text with the position.
     * An offset of (-0.5, -0.5) fraction aligns the center of the text with the
     * position.
     * <p>
     * A pixel based offset is interpreted based on the geographic size of the
     * text. For example, if the text rendered "normally" in two dimensions
     * would be 20 pixels tall, and the geographic text is 100 meters tall, then
     * each pixel of text corresponds to 5 meters. So an offset of 2 pixels
     * would correspond to a geographic offset of 10 meters.
     *
     * @param offset Offset that controls where to position the label relative
    ...
    /**
     * Apply a transform to the GL state to draw the text at the proper location
     * and scale.
     *
     * @param dc Current draw context.
     * @param sdc Current surface tile draw context.
    ...
    /**
     * Determine the text background color. This method returns the user
     * specified background color, or a computed default color if the user has
     * not set a background color.
     *
     * @param color text color.
     *
     * @return the user specified background color, or a default color that

...
public class DrawContextImpl extends WWObjectImpl implements DrawContext {
    ...
    /**
     * The list of objects at the pick point during the most recent pick
     * traversal. Initialized to an empty PickedObjectList.
     */
    protected PickedObjectList pickedObjects = new PickedObjectList();
    /**
     * The list of objects intersecting the pick rectangle during the most
     * recent pick traversal. Initialized to an empty PickedObjectList.
     */
    ...
    /**
     * Buffer of RGB colors used to read back the framebuffer's colors and store
     * them in client memory.
     */
    protected ByteBuffer pixelColors;
    /**
     * Set of ints used by
     * {@link #getPickColorsInRectangle(java.awt.Rectangle, int[])} to identify
     * the unique color codes in the specified rectangle. This consolidates
     * duplicate colors to a single entry. We use IntSet to achieve constant
     * time insertion, and to reduce overhead associated associated with storing
     * integer primitives in a HashSet.
     */
     ...
     * <code>null</code> to indicate that there is no pick point. Initially
     * <code>null</code>.
     */
    protected Point pickPoint = null;
    /**
     * Indicates the current pick rectangle in AWT screen coordinates, or
     * <code>null</code> to indicate that there is no pick rectangle. Initially
     * <code>null</code>.
     */
...
//    protected Map<String, GroupingFilter> groupingFilters;
    ...
    /**
     * Free internal resources held by this draw context. A GL context must be
     * current when this method is called.
     *
     * @throws com.jogamp.opengl.GLException - If an OpenGL context is not
     * current when this method is called.
     */
    public void dispose() {

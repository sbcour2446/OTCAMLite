...
public class GeographicTextRenderer {
    ...
    /**
     * Determines whether overlapping text are culled. If <code>true</code> text
     * items are sorted front to back according to their respective priority
     * rather then back to front, and will be drawn only if they do not overlap
     * an already drawn text. If <code>false</code> all text will be drawn back
     * to front whether they overlap or not.
     *
    ...
    /**
     * Set whether overlapping text should be culled. If <code>true</code> text
     * items will be sorted front to back according to their respective priority
     * rather then back to front, and will be drawn only if they do not overlap
     * an already drawn text. If <code>false</code> all text will be drawn back
     * to front whether they overlap or not.
     *
    ...
    /**
     * Get the empty margin that surrounds a text item when considering it's
     * bounding rectangle during text culling - see
     * {@link #setCullTextEnabled(boolean)}. The smaller the margin, the closer
     * text items can get before being considered as overlapping.
     *
    ...
    /**
     * Set the empty margin that surrounds a text item when considering it's
     * bounding rectangle during text culling - see
     * {@link #setCullTextEnabled(boolean)}. The smaller the margin, the closer
     * text items can get before being considered as overlapping.
     *
    ...
    /**
     * Get the effect used to decorate the text. Can be one of
     * {@link AVKey#TEXT_EFFECT_SHADOW} (default), {@link
    ...
    /**
     * Set the effect used to decorate the text. Can be one of
     * {@link AVKey#TEXT_EFFECT_SHADOW} (default), {@link
     * AVKey#TEXT_EFFECT_OUTLINE} or {@link AVKey#TEXT_EFFECT_NONE}.
     *
    ...
    /**
     * Get the minimum scale that can be applied to a text item when it gets
     * farther away from the eye than the view lookat point - screen center.
     *
     * @return the minimum scale that can be applied to a text item when it gets
     * away from the eye.
     */
    ...
    /**
     * Set the minimum scale that can be applied to a text item when it gets
     * farther away from the eye than the view lookat point - screen center. Use
     * a value less then one to have the text 'fade' away. A value of one will
     * have no effect.
     *
     * @param scale the minimum scale that can be applied to a text item when it
    ...
    /**
     * Get the maximum scale that can be applied to a text item when it gets
     * closer to the eye than the view lookat point - screen center.
     *
     * @return the maximum scale that can be applied to a text item when it
     * closer to the eye.
     */
    ...
    /**
     * Set the maximum scale that can be applied to a text item when it gets
     * closer to the eye than the view lookat point - screen center. Use a value
     * greater then one to have the text magnified in the foreground. A value of
     * one will have no effect.
     *
     * @param scale the maximum scale that can be applied to a text item when it
     * closer to the eye.
     */
    ...
    /**
     * Get the minimum opacity that can be applied to a text item when it gets
     * farther away from the eye than the view lookat point - screen center.
     *
     * @return the minimum opacity that can be applied to a text item when it
     * gets away from the eye.
     */
    ...
    /**
     * Set the minimum opacity that can be applied to a text item when it gets
     * farther away from the eye than the view lookat point - screen center. Use
     * a value less then one to have the text 'fade' away. A value of one will
     * have no effect.
     *
     * @param opacity the minimum opacity that can be applied to a text item
     * when it gets away from the eye.
     */
    ...
    /**
     * Computes the final draw point for the given rectangle lower left corner
     * and target screen point. If the returned point is <code>null</code> the
     ...
     *
     * @return the final draw point for the given rectangle lower left corner or
     * <code>null</code>.
     */
    @SuppressWarnings({"UnusedDeclaration"})

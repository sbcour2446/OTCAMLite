...
/**
 * A general cylinder volume defined by a center position, height and radius, or
...
public class Wedge extends RigidShape {
    ...
    /**
     * Constructs a Wedge from a specified center position, height, radius and
     * angle.
     *
     ...
     *
     * @throws IllegalArgumentException if the center position is null, if the
     * wedgeAngle is null or not in [0, 2*PI], or if any of the radii are not
     * greater than 0.
     */
    ...
    /**
     * Constructs a wedge from a specified center position, axes lengths and
     ...
     *
     * @throws IllegalArgumentException the centerPosition is null, or if the
     * wedgeAngle is null or not in [0, 2*PI], or if any of the radii are not
     * greater than 0.
     */
    public Wedge(Position centerPosition, Angle angle, double northSouthRadius, double verticalRadius,
    ...
    /**
     * Specifies the angle covered by the wedge. This angle must fall in [0,
     * 2*PI].
     *
     * @param angle the angle covered by the wedge. Must be in [0, 2*PI].
     *
     * @throws IllegalArgumentException if the wedgeAngle is null, or is not in
     * [0, 2*PI].
     */
    ...
    //**************************************************************//
    /**
     * Sets the Geometry mesh for this wedge, either by pulling it from the
    ...
    /**
     * Generates a unit wedge geometry, including the vertices, indices, normals
     * and texture coordinates, tessellated with the specified number of
     * divisions.
     *
     * @param subdivisions the number of times to subdivide the unit wedge
     * geometry
    ...
    /**
     * Renders the wedge, using data from the provided buffer and the given
     * parameters.
     *

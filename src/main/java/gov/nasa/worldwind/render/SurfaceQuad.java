...
public class SurfaceQuad extends AbstractSurfaceShape implements Exportable {
    ...
    /**
     * Constructs a new surface quad with the default attributes, default center
    ...
    /**
     * Constructs a new surface quad with the specified normal (as opposed to
     * highlight) attributes, default center location, default dimensions, and
    ...
    /**
     * Constructs a new surface quad with the default attributes, the specified
     ...
     *
     * @throws IllegalArgumentException if the center is null, or if the width
    ...
    /**
     * Constructs a new surface quad with the default attributes, the specified
     * center location, dimensions (in meters), and heading clockwise from
     * North.
     *
     * @param center the quad's center location.
     * @param width the quad's width, in meters.

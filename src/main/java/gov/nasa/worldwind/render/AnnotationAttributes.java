...
/**
 * {@link Annotation} attributes set. All {@link AbstractAnnotation} objects
 * start life referencing a new instance of this object.
 * <p>
 * This class also defines a static <b>default</b> attributes bundle containing
 * default values for all attributes. New <code>AnnotationAttributes</code>
 * refer this static bundle as their default values source when an attribute has
 * not been set. </p>
 * <p>
 * New <code>AnnotationAttributes</code> set have all their attributes pointing
 * to the default values until they are set by the application. Most attributes
 * refer to the default value by using minus one (<code>-1</code>) for numerics
 * and <code>null</code> for objects. </p>
 * <p>
 * The default attributes set can be changed for a non static one under the
 * application control. The process can be extended or cascaded to handle
...
public class AnnotationAttributes implements Restorable {
    ...
    /**
     * Get the callout frame shape. Can be one of
     * <code>AVKey.SHAPE_RECTANGLE</code> (default),
    ...
    /**
     * Set the callout frame shape. Can be one of
     * <code>AVKey.SHAPE_RECTANGLE</code> (default),
     * <code>AVKey.SHAPE_ELLIPSE</code> or <code>AVKey.SHAPE_NONE</code>. Set to
     * <code>null</code> to use the default shape.
     * <p>
     * Note that <code>AVKey.SHAPE_ELLIPSE</code> draws an ellipse <u>inside</u>
     * the callout bounding rectangle set by its size (see setSize()) or its
     * text bounding rectangle (see setAdjustWidthToText() and setSize() with
     * height set to zero). It is often necessary to have larger Insets
     * dimensions (see setInsets()) to avoid having the text drawn outside the
     * shape border. </p>
     *
    ...
    /**
     * Get whether the <code>Annotation</code> is highlighted and should be
     * drawn bigger - see setHighlightScale().
     *
    ...
    /**
     * Set whether the <code>Annotation</code> is highlighted and should be
     * drawn bigger - see setHighlightScale().
     *
     ...
     *
     * @return the scaling factor applied to highlighted
    ...
    /**
     * Set the scaling factor applied to highlighted <code>Annotations</code>.
     * Set to minus one (<code>-1</code>) to use the default value.
     *
     * @param highlightScale the scaling factor applied to highlighted
     * <code>Annotations</code>.
     */
     ...
     * <p>
     * If necessary, the text will be wrapped into several lines so as not to
     * exceed the callout preferred <code><b>width</b></code> (minus the
     * <code>Insets</code> <code>left</code> and <code>right</code> dimensions -
     * see {@link #setInsets(java.awt.Insets) setInsets}). However, if
     * {@link #setAdjustWidthToText(String) setAdjustWidthToText} is set to
     * AVKey.SIZE_FIT_TEXT, the final callout width will follow that of the
     * final text bounding rectangle. </p>
     * <p>
     * If necessary, the text will also be truncated so as not to exceed the
     * given <code><b>height</b></code>. A <code>zero</code> value (default)
     * will have the callout follow the final text bounding rectangle height
     * (including the <code>Insets</code> <code>top</code> and
     * <code>bottom</code>). </p> Set to <code>null</code> to use the default
     * size.
     *
    ...
    /**
     * Set the scaling factor to apply to the annotation. Default is 1. Set to
     * minus one (<code>-1</code>) to use the default value.
     *
    ...
    /**
     * Set the opacity factor to apply to the annotation. Default is 1. Set to
     * minus one (<code>-1</code>) to use the default value.
     *
    ...
    /**
     * Get the callout shape leader type. Can be one of
     * <code>AVKey.SHAPE_TRIANGLE</code> (default) or
    ...
    /**
     * Set the callout shape leader type. Can be one of
     * <code>AVKey.SHAPE_TRIANGLE</code> (default) or
     * <code>AVKey.SHAPE_NONE</code>.
     *
    ...
    /**
     * Set the callout shape leader gap width in pixels. Set this attribute to
     * minus one (<code>-1</code>) to use the default value.
     *
    ...
    /**
     * Get the callout shape rounded corners radius in pixels. A value of
     * <code>zero</code> means no rounded corners.
     *
    ...
    /**
     * Set the callout shape rounded corners radius in pixels. A value of
     * <code>zero</code> means no rounded corners. Set this attribute to minus
     * one (<code>-1</code>) to use the default value.
     *
    ...
    /**
     * Get whether the callout width should adjust to follow the wrapped text
     * bounding rectangle width, which may be smaller or larger then the
     * preferred size depending on the text. Can be one of
     * {@link AVKey#SIZE_FIXED} or {@link
     * AVKey#SIZE_FIT_TEXT}.
     *
     * @return whether the callout width is adjusted to follow the text bounding
     * rectangle width.
     */
     ...
     * bounding rectangle width which may be smaller or larger then the
     * preferred size depending on the text. Can be one of
     * {@link AVKey#SIZE_FIXED} (default) or {@link AVKey#SIZE_FIT_TEXT}.
     * Setting this attribute to <code>SIZE_FIT_TEXT</code> would have the
     * callout drawn at its exact width (see setSize()).
     *
     * @param state whether the callout width should adjust to follow the text
    ...
    /**
     * Get the callout displacement offset in pixels from the globe Position or
     * screen point at which it is associated. When the callout has a leader
     * (see setLeader(String leader)), it will lead to the original point. In
     * the actual implementation, the callout is drawn above its associated
     * point and the leader connects at the bottom of the frame, in the middle.
     * Positive X increases toward the right and positive Y in the up direction.
     *
    ...
    /**
     * Set the callout displacement offset in pixels from the globe Position or
     * screen point at which it is associated. When the callout has a leader
     * (see setLeader(String leader)), it will lead to the original point. In
     * the actual implementation, the callout is drawn above its associated
     * point and the leader connects at the bottom of the frame, in the middle.
    ...
    /**
     * Get the callout <code>Insets</code> dimensions in pixels. The text is
     * drawn inside the callout frame while keeping a distance from the callout
     * border defined in the Insets.
     *
    ...
    /**
     * Set the callout <code>Insets</code> dimensions in pixels. The text will
     * be drawn inside the callout frame while keeping a distance from the
     * callout border defined in the Insets. Set to <code>null</code> to use the
     * default Insets.
     *
    ...
    /**
     * Get the callout border line width. A value of <code>zero</code> means no
    ...
    /**
     * Set the callout border line width. A value of <code>zero</code> means no
     * border will is drawn. Set to minus one (<code>-1</code>) to use the
     * default value.
     *
    ...
    /**
     * Get the stipple factor used for the callout border line. A value of
     * <code>zero</code> (default) means no pattern is applied.
     *
    ...
    /**
     * Set the stipple factor used for the callout border line. A value of
     * <code>zero</code> (default) means no pattern will be applied. Set to
     * minus one (<code>-1</code>) to use the default value.
     *
    ...
    /**
     * Set the stipple pattern used for the callout border line. Set to
     * <code>0x0000</code> to use the default value.
     *
    ...
    /**
     * Get the <code>GL</code> antialias hint used for rendering the callout
     * border line. Can be one of {@link
     * Annotation}.ANTIALIAS_DONT_CARE, ANTIALIAS_FASTEST (default) or
     * ANTIALIAS_NICEST.
     *
     * @return the <code>GL</code> antialias hint used for rendering the callout
     * border line.
     */
    ...
    /**
     * Set the <code>GL</code> antialias hint used for rendering the callout
     * border line. Can be one of {@link
     * Annotation}.ANTIALIAS_DONT_CARE, ANTIALIAS_FASTEST (default) or
     * ANTIALIAS_NICEST. Set to minus one (<code>-1</code>) to use the default
     * value.
     *
     * @param hint the <code>GL</code> antialias hint used for rendering the
     * callout border line.
     */
    ...
    /**
     * Set the <code>Font</code> used for text rendering. Set to
    ...
    /**
     * Get the text alignement. Can be one of {@link AVKey#LEFT} (default),
     * {@link AVKey#CENTER} or {@link
     * AVKey#RIGHT}.
     *
     * @return align the text alignement. Can be one of
     * MultiLineTextRenderer.ALIGN_LEFT, ALIGN_CENTER or ALIGN_RIGHT.
     */
    ...
    /**
     * Set the text alignement. Can be one of {@link AVKey#LEFT} (default),
     * {@link AVKey#CENTER} or {@link AVKey#RIGHT}. Set to <code>null</code> to
    ...
    /**
     * Set the text <code>Color</code>. Set to <code>null</code> to use the
     * default value.
     *
    ...
    /**
     * Set the callout background <code>Color</code>. Set to <code>null</code>
    ...
    /**
     * Set the callout border <code>Color</code>. Set to <code>null</code> to
     * use the default value.
     *
    ...
    /**
     * Get the background image source. Can be a <code>String</code> providing
     * the path to a local image, a {@link
    ...
    /**
     * Set the background image source. Can be a <code>String</code> providing
     * the path to a local image or a {@link
     * java.awt.image.BufferedImage}. Set to null for no background image
     * rendering.
     *
    ...
    /**
     * Get the background image as a {@link WWTexture} for the specified draw
     * context. This returns null if the background image source returned by
     * {@link #getImageSource()} is null.
     *
     * @param dc the current draw context.
     *
     * @return the background image as a WWTexture, or null if this
     * AnnotationAttributes has no background image source.
     */
    ...
    /**
     * Set the background image scaling factor. Set to minus one
    ...
    /**
     * Set the opacity of the background image (0 to 1). Set to minus one
     * (<code>-1</code>) to use the default value.
     *
    ...
    /**
     * Get the repeat behavior or the background image. Can be one of
     * {@link Annotation}.IMAGE_REPEAT_X, IMAGE_REPEAT_Y, IMAGE_REPEAT_XY
     * (default) or IMAGE_REPEAT_NONE.
     *
    ...
    /**
     * Set the repeat behavior or the background image. Can be one of
     * {@link Annotation}.IMAGE_REPEAT_X, IMAGE_REPEAT_Y, IMAGE_REPEAT_XY
     * (default) or IMAGE_REPEAT_NONE. Set to <code>null</code> to use the
     * default value.
     *
    ...
    /**
     * Get the path to the image used for background image. Returns
     * <code>null</code> if the image source is null or a memory BufferedImage.
     *
    ...
    /**
     * Get the minimum scale that can be applied to an annotation when it gets
     * farther away from the eye than the view lookat point.
     *
     * @return the minimum scale that can be applied to an annotation when it
     * gets away from the eye
     */
    ...
    /**
     * Set the minimum scale that can be applied to an annotation when it gets
     * farther away from the eye than the view lookat point. Set to minus one
     * (<code>-1</code>) to use the default value.
     *
     * @param scale the minimum scale that can be applied to an annotation when
     * it gets away from the eye
     */
    ...
    /**
     * Get the maximum scale that can be applied to an annotation when it gets
     * closer to the eye than the view lookat point.
     *
     * @return the maximum scale that can be applied to an annotation when it
     * gets closer to the eye
     */
    ...
    /**
     * Set the maximum scale that can be applied to an annotation when it gets
     * closer to the eye than the view lookat point. Set to minus one
     * (<code>-1</code>) to use the default value.
     *
     * @param scale the maximum scale that can be applied to an annotation when
     * it gets closer to the eye
     */
    ...
    /**
     * Get the minimum opacity an annotation can have when fading away from the
     * eye (0 to 1).
     *
     * @return the minimum opacity an annotation can have when fading away from
     * the eye.
     */
    ...
    /**
     * Set the minimum opacity an annotation can have when fading away from the
     * eye (0 to 1). Set to minus one (<code>-1</code>) to use the default
     * value.
     *
     * @param opacity the minimum opacity an annotation can have when fading
     * away from the eye.
     */
    ...
    /**
     * Indicates whether one or more members of <i>this</i> remain unresolved
     * because they must be retrieved from an external source.
     *
     * @return true if there are unresolved fields, false if no fields remain
     * unresolved.
     */
    ...
    /**
     * Specifies whether one or more fields of <i>this</i> remain unresolved
     * because they must be retrieved from an external source.
     *
     * @param unresolved true if there are unresolved fields, false if no fields
     * remain unresolved.
     */
    ...
    /**
     * Returns an XML state document String describing attributes that have been
     * set by the application (attributes not pointing to their default value).
     *
    ...
    /**
     * Restores attribute values found in the specified XML state document
     * String. The document specified by <code>stateInXml</code> must be a well
     * formed XML document String, or this will throw an
     * IllegalArgumentException. Unknown structures in <code>stateInXml</code>
     * are benign, because they will simply be ignored.
     *
     * @param stateInXml an XML document String describing an
     * AnnotationAttributes.
     *
     * @throws IllegalArgumentException If <code>stateInXml</code> is null, or
     * if <code>stateInXml</code> is not a well formed XML document String.
     */
    ...
    /**
     * Save the attributes specified by <code>source</code> in the specified
     * <code>restorableSupport</code>. Only attributes that have been set by the
     * application (attributes not pointing to their default value) will be
     * saved. If <code>context</code> is not null, attributes will be saved
     * beneath it. Otherwise, they will be saved at the document root.
     *
     * @param source the AnnotationAttriubutes to save.
     * @param restorableSupport RestorableSupport to write attribute values to.
     * @param context RestorableSupport.StateObject that attributes will be
     * saved under, if not null.
     *
     * @throws IllegalArgumentException If either <code>source</code> or
     * <code>restorableSupport</code> is null.
     */
    ...
    /**
     * Restores the any attributes appearing in the specified
     * <code>restorableSupport</code>. If <code>context</code> is not null, this
     * will search for attributes beneath it. Otherwise, this will search for
     * attributes beneath the document root.
     *
     * @param restorableSupport RestorableSupport to read attribute values from.
     * @param context RestorableSupport.StateObject under which attributes will
     * be looked, if not null.
     * @param dest the AnnotationAttributes to restore.
     *
     * @throws IllegalArgumentException If either <code>restorableSupport</code>
     * or <code>dest</code> is null.
     */

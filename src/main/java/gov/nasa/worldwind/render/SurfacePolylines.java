...
/**
 * This class renders fast multiple surface polylines in one pass. It relies on
 * a {@link CompoundVecBuffer}.
 *
 * @author Dave Collins
...
public class SurfacePolylines extends AbstractSurfaceShape {
    ...
    /**
     * {@inheritDoc} Overridden to treat the polylines as open paths rather than
     * closed polygons.
     */
    @Override

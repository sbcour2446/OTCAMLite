...
public class Box extends RigidShape {
    ...
    /**
     * Construct a Box from a specified center position, axes lengths and
    ...
    //**************************************************************//
    /**
     * Sets the Geometry mesh for this Box, either by pulling it from the
    ...
    /**
     * Generates a unit box geometry, including the vertices, indices, normals
     * and texture coordinates, tessellated with the specified number of
     * divisions.
     *
     * @param subdivisions the number of times to subdivide the unit box
     * geometry
    ...
    /**
     * Renders the Box, using data from the provided buffer and the given
     * parameters.
     *

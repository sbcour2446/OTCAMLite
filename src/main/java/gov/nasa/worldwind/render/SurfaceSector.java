...
public class SurfaceSector extends AbstractSurfaceShape implements Exportable {
    ...
    /**
     * Constructs a new surface sector with the specified normal (as opposed to
     * highlight) attributes and the {@link
     * gov.nasa.worldwind.geom.Sector#EMPTY_SECTOR}. Modifying the attribute
    ...
    /**
     * Constructs a new surface sector with the specified normal (as opposed to
     * highlight) attributes and the specified sector. Modifying the attribute
     * reference after calling this constructor causes this shape's appearance
     * to change accordingly.
     *
     * @param normalAttrs the normal attributes. May be null, in which case
...
//**************************************************************//
    ...
    /**
     * Export the sector to KML as a {@code <Placemark>} element. The

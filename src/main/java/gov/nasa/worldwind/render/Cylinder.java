...
public class Cylinder extends RigidShape {
    ...
    /**
     * Constructs a Cylinder from a specified center position, height and
     * radius.
     *
    ...
    /**
     * Constructs a cylinder from a specified center position, axes lengths and
     ...
     * @param verticalRadius the cylinder's vertical radius, in meters.
     * @param eastWestRadius the cylinder's east-west radius, in meters.
     * @param heading the cylinder's azimuth, its rotation about its vertical
     * axis.
    ...
    //**************************************************************//
    /**
     * Sets the Geometry mesh for this cylinder, either by pulling it from the
    ...
    /**
     * Generates a unit cylinder geometry, including the vertices, indices,
     * normals and texture coordinates, tessellated with the specified number of
     * divisions.
     *
     * @param subdivisions the number of times to subdivide the unit cylinder
     * geometry
    ...
    /**
     * Renders the cylinder, using data from the provided buffer and the given
     * parameters.
     *

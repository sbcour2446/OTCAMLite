...
/**
 * A general cone volume defined by a center position, a height and a radius, or
...
public class Cone extends RigidShape {
    ...
    /**
     * Constructs a cone from a specified center position, axes lengths and
    ...
    //**************************************************************//
    /**
     * Sets the Geometry mesh for this cone, either by pulling it from the
    ...
    /**
     * Generates a unit cone geometry, including the vertices, indices, normals
     * and texture coordinates, tessellated with the specified number of
     * divisions.
     *
     * @param subdivisions the number of times to subdivide the unit cone
     * geometry
    ...
    /**
     * Renders the cone, using data from the provided buffer and the given
     * parameters.
     *

...
public class SurfaceSquare extends SurfaceQuad {
    ...
    /**
     * Constructs a new surface square with the default attributes, default
     * center location, default size, and default heading.
     */
    ...
    /**
     * Constructs a new surface square with the specified normal (as opposed to
     * highlight) attributes, default center location, default size, and default
     * heading. Modifying the attribute reference after calling this constructor
    ...
    /**
     * Constructs a new surface square with the default attributes, the
     * specified center location and size (in meters).
     *
     * @param center the square's center location.
     * @param size the square's width and height, in meters.
     *
     * @throws IllegalArgumentException if the center is null, or if the size is
     * negative.
     */
    ...
    /**
     * Constructs a new surface square with the default attributes, the
     * specified center location, size (in meters), and heading clockwise from
     * North.
     *
     * @param center the square's center location.
     * @param size the square's width and height, in meters.
    ...
    /**
     * Constructs a new surface square with the specified normal (as opposed to
     * highlight) attributes, the specified center location and size (in
    ...
    /**
     * Constructs a new surface square with the specified normal (as opposed to
     * highlight) attributes, the specified center location and dimensions (in
     * meters). Modifying the attribute reference after calling this constructor
     * causes this shape's appearance to change accordingly.
     *
     * @param normalAttrs the normal attributes. May be null, in which case

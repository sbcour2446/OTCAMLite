...
public class SurfaceCircle extends SurfaceEllipse {
    ...
    /**
     * Constructs a new surface circle with the default attributes, default
     * center location and default radius.
     */
    ...
    /**
     * Constructs a new surface circle with the specified normal (as opposed to
     * highlight) attributes, default center location, and default radius.
    ...
    /**
     * Constructs a new surface circle with the default attributes, the
     * specified center location and radius (in meters).
     *
     * @param center the circle's center location.
     * @param radius the circle's radius, in meters.
     *
     * @throws IllegalArgumentException if the center is null, or if the radius
     * is negative.
     */
    ...
    /**
     * Constructs a new surface circle with the default attributes, the
     * specified center location, radius (in meters), and initial number of
     * geometry intervals.
     *
     * @param center the circle's center location.
     * @param radius the circle's radius, in meters.
     ...
     * circle's geometry.
     *
     * @throws IllegalArgumentException if the center is null, if the radius is
     * negative, or if the number of intervals is less than 8.
     */
    ...
    /**
     * Constructs a new surface circle with the specified normal (as opposed to
     * highlight) attributes, the specified center location, and radius (in
    ...
    /**
     * Constructs a new surface circle with the specified normal (as opposed to
     * highlight) attributes, the specified center location, radius (in meters),
     * and initial number of geometry intervals. Modifying the attribute
     * reference after calling this constructor causes this shape's appearance

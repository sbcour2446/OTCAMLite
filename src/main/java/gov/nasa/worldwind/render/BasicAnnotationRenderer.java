...
/**
 * Basic implementation of AnnotationRenderer. Process Annotation rendering as
 * OrderedRenderable objects batch.
 *
...
public class BasicAnnotationRenderer implements AnnotationRenderer {
    ...
    /**
     * Get the final Vec4 point at which an annotation will be drawn. If the
     * annotation Position elevation is lower then the highest elevation on the
     * globe, it will be drawn above the ground using its elevation as an

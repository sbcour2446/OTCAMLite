...
public interface Annotation extends Renderable, Disposable, Restorable {
    ...
    /**
     * Draws the annotation immediately on the specified DrawContext. Rendering
     * is not be delayed by use of the DrawContext's ordered mechanism, or any
     * other delayed rendering mechanism. This is typically called by an
     * AnnotationRenderer while batch rendering. The GL should have its model
     * view set to the identity matrix.
     *
    ...
    /**
     * Draws the annotation without transforming to its screen position, or
     * applying any scaling. This Annotation is draw with the specified width,
     * height, and opacity. The GL should have its model view set to whatever
     ...
     * @param pickPosition the picked Position assigned to the Annotation, if
     * picking is enabled.
     *
     * @throws IllegalArgumentException if <code>dc</code> is null.
     */
    ...
    /**
     * Returns the minimum eye altitude, in meters, for which the annotation is
     * displayed.
     *
     * @return the minimum altitude, in meters, for which the annotation is
     * displayed.
     *
    ...
    /**
     * Specifies the minimum eye altitude, in meters, for which the annotation
     * is displayed.
     *
    ...
    /**
     * Returns the maximum eye altitude, in meters, for which the annotation is
     * displayed.
     *
     * @return the maximum altitude, in meters, for which the annotation is
     * displayed.
     *
     * @see #setMaxActiveAltitude(double)
     * @see #getMinActiveAltitude()
    ...
    /**
     * Specifies the maximum eye altitude, in meters, for which the annotation
     * is displayed.
     *

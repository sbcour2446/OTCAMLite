 ...
 * {@link gov.nasa.worldwind.render.airspaces.AirspaceAttributes} interface.
 * AirspaceAttributes was originally designed as a special purpose attribute
 * bundle for {@link Airspace} shapes, but is now redundant subclass of
 * {@link gov.nasa.worldwind.render.BasicShapeAttributes}.
 * BasicAirspaceAttributes is still supported to ensure backward compatibility
 * with earlier versions of WorldWind. Usage of methods unique to
 * AirspaceAttributes should be replaced with the equivalent methods in
 * ShapeAttributes.
 *
 * @author tag
...
public class BasicAirspaceAttributes extends BasicShapeAttributes implements AirspaceAttributes {
    ...
    /**
     * Creates a new BasicAirspaceAttributes with the default attributes. The
     * default attributes differ from BasicShapeAttributes, and are as follows:
     ...
     * <tr><td>drawOutline</td><td><code>false</code></td></tr>
    ...
    /**
     * Creates a new BasicAirspaceAttributes with the specified interior
     * material and interior opacity. All other attributes are set to the
     * default values, which differ from BasicShapeAttributes, and are as
     * follows:
     * <table> <caption style="font-weight: bold;">Default
     * Attributes</caption><tr><th>Attribute</th><th>Default Value</th></tr>
     * <tr><td>unresolved</td><td><code>true</code></td></tr>
     ...
     * gov.nasa.worldwind.render.Material#BLACK}</td></tr>
     * <tr><td>interiorOpacity</td><td>opacity</td></tr>
     * <tr><td>outlineOpacity</td><td>1.0</td></tr>
     * <tr><td>outlineWidth</td><td>1.0</td></tr>
     * <tr><td>outlineStippleFactor</td><td>0</td></tr>
     * <tr><td>outlineStipplePattern</td><td>0xF0F0</td></tr>
    ...
    /**
     * Creates a new <code>BasicAirspaceAttributes</code> configured with the
     * specified {@link gov.nasa.worldwind.render.ShapeAttributes}.
     *
     * @param attributes the attributes to configure the new
     * <code>BasicAirspaceAttributes</code> with.
     *

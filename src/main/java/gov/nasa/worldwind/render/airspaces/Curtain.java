...
/**
 * A curtain is a series of adjacent rectangular planes. The upper edges of the
 * planes are the connecting line segments between the vertices of a polyline.
 * The lower edges of the planes are parallel to the upper edges at a specified
 * altitude.
 *
 * @author tag
...
public class Curtain extends AbstractAirspace {
     ...
     *
     * @param locations a list of geographic coordinates (latitude and
     * longitude) specifying the upper edge of the shape.
     *
     * @throws IllegalArgumentException if the locations list is null or

...
/**
 * A cake consists of mutiple adjacent cylinder segments. Each cylinder is
 * defined by its center location in latitude longitude, its radius in meters,
 * and two aziumths specifying the active circumferential portion of the
 * cylinder. Cake segments are altitude-limited shapes and therefore have an
 * associated minimum and maximum altitude.
 *
 * @author tag
...
public class Cake extends AbstractAirspace {
    ...
    /**
     * An inner class of {@link Cake} defining the parameters of one of the
     * cake's cylinders.
     */
     ...
     *
     * @return the cylinders comprising the shape, or an empty list if the shape
     * contains no layers.
     */

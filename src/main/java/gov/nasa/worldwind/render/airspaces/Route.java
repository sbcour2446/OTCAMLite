...
/**
 * Creates a sequence of connected rectangular airspaces specified by a list of
 * positions. Each position but the last begins a new rectangle from that
 * position to the following position. The width of the rectangles is specified
 * by this class's width parameter.
 *
 * @author garakl
...
public class Route extends TrackAirspace {
     ...
     * {@link gov.nasa.worldwind.render.airspaces.Route}.
     */

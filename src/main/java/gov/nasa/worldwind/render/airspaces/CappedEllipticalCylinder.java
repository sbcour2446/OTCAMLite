...
/**
 * An elliptical cylinder defined by a geographic position, major and minor
 * radii in meters, and minimum and maximum altitudes.
 *
 * @author tag
 * @version $Id: CappedEllipticalCylinder.java 3424 2015-09-29 19:34:00Z
 * tgaskins $
 */
public class CappedEllipticalCylinder extends AbstractAirspace {
     ...
     *
     * @param location the geographic position (latitude and longitude) of the
     * cylinder's center.
     *
     ...
     *
     * @return the cylinder's radii, in meters. The returned array contains the
     * inner minor radius, inner major radius, outer minor radius and outer
     * major radius, in that order.
     */

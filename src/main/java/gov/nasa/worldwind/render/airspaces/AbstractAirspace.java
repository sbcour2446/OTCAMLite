...
public abstract class AbstractAirspace extends WWObjectImpl
     ...
     * #determineActiveAttributes(gov.nasa.worldwind.render.DrawContext)}. The
     * active attributes are either the normal or highlight attributes,
     * depending on this shape's highlight flag, and incorporates default
     * attributes for those not specified in the applicable attribute set.
     *
    ...
    /**
     * Returns a {@link SurfaceShape} that corresponds to this Airspace and is
     * used for drawing on 2D globes.
     *
     ...
     * used to represent this Airspace on 2D globes. Subclasses should override
     * this method if they need to update more than the attributes and the
     * delegate owner.
     *
     * @param dc the current drawing context.
    ...
    /**
     * Regenerates surface shape geometry prior to picking and rendering the 2D
     * shape used to represent this Airspace on 2D globes.
     *
     * @param dc the current drawing context.

...
public class Box extends AbstractAirspace {
     ...
     *
     * @param beginLocation geographic coordinates(latitude and longitude)
     * specifying the center of the begining edge.
     * @param endLocation geographic coordinates(latitude and longitude)
     * specifying the center of the ending edge.
     *
    ...
    /**
     * Indicates the azimuth angles for this box's four corners, relative to
     * geographic north. Angles are organized in the returned array as follows:
     * begin left, begin right, end left, end right. Null elements in any index
     * indicate that the default angle is used.
     *
    ...
    /**
     * Specifies the azimuth angles for this box's four corners, relative to
     * geographic north. Specifying a null argument indicates that the default

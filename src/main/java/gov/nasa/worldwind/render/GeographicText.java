...
public interface GeographicText {
    ...
    /**
     * Indicates whether or not the text is visible. The text will not be drawn
     * when the visibility is set to {@code
     * false}.
     *
    ...
    /**
     * Specifies whether or not the text is visible. The text will not be drawn
     * when the visibility is set to {@code
     * false}.
     *
     * @param visible {@code true} if the text should be visible. {@code false}
     * if not.
     */
    void setVisible(boolean visible);

    /**
     * Indicates the text priority. The priority can be used to implement text
     * culling.
     *
    ...
    /**
     * Specifies the text priority. The priority can be used to implement text
     * culling.
     *

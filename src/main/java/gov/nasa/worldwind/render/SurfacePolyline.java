...
public class SurfacePolyline extends AbstractSurfaceShape implements Exportable {
    ...
    /**
     * Constructs a new surface polyline with the default attributes and no
     * locations.
     */
    ...
    /**
     * Constructs a new surface polyline with the specified normal (as opposed
     * to highlight) attributes and no locations. Modifying the attribute
    ...
    /**
     * Constructs a new surface polyline with the default attributes and the
    ...
    /**
     * Constructs a new surface polyline with the specified normal (as opposed
     * to highlight) attributes and the specified iterable of locations.
    ...
    /**
     * {@inheritDoc} Overridden to treat the shape as an open path if the
    ...
    //**************************************************************//
    /**
     * Export the polyline to KML as a {@code <Placemark>} element. The

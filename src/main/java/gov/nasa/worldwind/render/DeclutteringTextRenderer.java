...
/**
 * A simplified version of {@link GeographicTextRenderer} that participates in
 * globe text decluttering. See {@link
 * ClutterFilter} for more information on decluttering.
 *
 * @author tag
 * @version $Id: DeclutteringTextRenderer.java 2392 2014-10-20 20:02:44Z
 * tgaskins $
 */
public class DeclutteringTextRenderer {
     ...
     *
     * @param dc the current draw context.
     * @param textIterable a collection of text shapes to add to the

...
/**
 * Represent a text label attached to a Point on the viewport and its rendering
 * attributes.
 *
...
public class ScreenAnnotation extends AbstractAnnotation {
    ...
    /**
     * Creates a <code>ScreenAnnotation</code> with the given text, at the given
     * viewport position.
     *
    ...
    /**
     * Creates a <code>ScreenAnnotation</code> with the given text, at the given
     * viewport position. Specifiy the <code>Font</code> to be used.
     *
     * @param text the annotation text.
     * @param position the annotation viewport position.
    ...
    /**
     * Creates a <code>ScreenAnnotation</code> with the given text, at the given
     * viewport position. Specifiy the <code>Font</code> and text
    ...
    /**
     * Creates a <code>ScreenAnnotation</code> with the given text, at the given
     * viewport position. Specify the default {@link AnnotationAttributes} set.
     *
     * @param text the annotation text.
     * @param position the annotation viewport position.
     ...
     *
     * @return the <code>Point</code> where the annotation is drawn in the
     * viewport.
     */
    ...
    /**
     * Set the <code>Point</code> where the annotation will be drawn in the
     * viewport.
     *
     * @param position the <code>Point</code> where the annotation will be drawn
     * in the viewport.
     */
     ...
     * {@link #setPosition(gov.nasa.worldwind.geom.Position)}.
     *
    ...
    /**
     * Specifies an optional geographic position that is mapped to a screen
     * position during rendering. This value overrides this object's screen
     * point and computes it anew each time this annotation is drawn.
     *
     * @param position This annotation's geographic position. May be null, in
     * which case this annotation's screen point is used directly.
     *

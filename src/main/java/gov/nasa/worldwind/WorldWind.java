...
public final class WorldWind {
    ...
    /**
     * Reinitialize WorldWind to its initial ready state. Shut down and restart
     * all WorldWind services and clear all WorldWind memory caches. Cache
     * memory will be released at the next JVM garbage collection.
     * <p>
     * Call this method to reduce WorldWind's current resource usage to its
     * initial, empty state.
     * <p>
     * The state of any open {@link WorldWindow} objects is indeterminate
     * subsequent to invocation of this method. The core WorldWindow objects
     * attempt to shut themselves down cleanly during the call, but their
     * resulting window state is undefined.
     * <p>
    ...
    /**
     * Get the scheduled task service. This service can be used to scheduled
     * tasks that execute after a delay, or execute repeatedly.
     *
    ...
    /**
     * Indicate whether WorldWind should attempt to connect to the network to
    ...
    /**
     * @param className the full name, including package names, of the component
     * to create
     *
     * @return the new component
     *
     * @throws WWRuntimeException if the <code>Object</code> could not be
     * created
     * @throws IllegalArgumentException if <code>className</code> is null or
     * zero length
     */
     ...
     * @return the new component
     *
     * @throws IllegalStateException if no name could be found which corresponds
     * to <code>classNameKey</code>

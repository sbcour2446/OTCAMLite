...
/**
 * @author dcollins
 * @version $Id: KMLSurfacePolygonImpl.java 1551 2013-08-17 18:00:09Z
 * pabercrombie $
 */
public class KMLSurfacePolygonImpl extends SurfacePolygon implements KMLRenderable {
     ...
     * Rotation is applied the first time that the image is rendered.
     */
     ...
     *
     * @param tc the current {@link KMLTraversalContext}.
     * @param overlay the {@link gov.nasa.worldwind.ogc.kml.KMLGroundOverlay} to
     * render as a polygon.
     *
     * @throws NullPointerException if the geometry is null.
     * @throws IllegalArgumentException if the parent placemark or the traversal
    ...
    /**
     * Determine and set the {@link Path} highlight attributes from the KML
     * <i>Feature</i> fields.
     *
    ...
    /**
     * Apply a rotation to the corner points of the overlay. This method is
     * called the first time the polygon is rendered, if the position is
     * specified using a rotated LatLon box.
     *

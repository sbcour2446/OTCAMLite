...
/**
 * Implements {@link AbstractXMLEventParser} for KML elements. Provides the
 * interface and implementation for retrieving support files referred to by
 * elements in the KML document.
 *
 * @author tag

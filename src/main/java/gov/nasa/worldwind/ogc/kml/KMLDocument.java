...
/**
 * Represents the KML <i>Document</i> element and provides access to its
 * contents.
 *
 * @author tag
...
public class KMLDocument extends KMLAbstractContainer {
    ...
    /**
     * Merge a list of incoming schemas with the current list. If an incoming
     * schema has the same ID as an existing one, replace the existing one,

...
public class KMLStyle extends KMLAbstractStyleSelector {
    ...
    /**
     * {@inheritDoc} Overridden to handle deprecated {@code labelColor} field.
     * The {@code labelColor} field is deprecated, and has been replaced by
     * {@code LabelStyle}. If {@code labelColor} is set this method will apply
     * the color to the {@code LabelStyle}, creating a new {@code LabelStyle} if
     * necessary.
     */
    @Override
    ...
    /**
     * Adds the sub-style fields of a specified sub-style to this one's fields

...
/**
 * Represents the KML <i>Placemark</i> element and provides access to its
 * contents.
 *
 * @author tag
...
public class KMLPlacemark extends KMLAbstractFeature {
    ...
    /**
     * Returns the {@link gov.nasa.worldwind.ogc.kml.impl.KMLRenderable}s of
     * this placemark.
     *
     * @return the placemark's renderables, or null if the placemark has no
     * renderables.
     */
     ...
     * <code>KMLPlacemark</code>. This initializes the placemark geometry if
     * necessary, prior to pre-rendering.
     *
    ...
    /**
     * Indicates whether or not an altitude mode equals one of the altitude
     * modes defined in the KML specification.
     *
     * @param altMode Altitude mode test.
     *
     * @return True if {@code altMode} is one of "clampToGround",

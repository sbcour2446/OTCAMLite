...
/**
 * The parser context for KML and KMZ docuements. Specifies the classes used to
 * parse each type of KML element.
 *
 * @author tag
...
public class KMLParserContext extends BasicXMLEventParserContext {
    ...
    /**
     * The key used to identify the coordinates parser in the parser context's
     * parser map.
     */
    protected static QName COORDINATES = new QName("Coordinates");

    /**
     * The names of elements that contain merely string data and can be parsed
     * by a generic string parser.
     */
    ...
    /**
     * The names of elements that contain merely double data and can be parsed
     * by a generic double parser.
     */
    ...
    /**
     * The names of elements that contain merely integer data and can be parsed
     * by a generic integer parser.
     */
    ...
    /**
     * The names of elements that contain merely boolean integer (0 or 1) data
     * and can be parsed by a generic boolean integer parser.
     */
    ...
    /**
     * Loads the parser map with the parser to use for each element type. The
     * parser may be changed by calling {@link

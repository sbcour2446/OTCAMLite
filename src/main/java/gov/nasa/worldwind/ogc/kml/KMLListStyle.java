...
/**
 * Represents the KML <i>ListStyle</i> element and provides access to its
 * contents.
 *
 * @author tag
...
public class KMLListStyle extends KMLAbstractSubStyle {
    ...
    /**
     * Merge a list of incoming item icons with the current list. If an incoming
     * item icon has the same ID as an existing one, replace the existing one,
     * otherwise just add the incoming one.
     *

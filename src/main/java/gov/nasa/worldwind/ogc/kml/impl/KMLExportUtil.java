...
public class KMLExportUtil {
     ...
     *
     * @throws IllegalArgumentException If {@code altitudeMode} is not a valid
     * WorldWind altitude mode.
     */
    ...
    /**
     * Export ShapeAttributes as KML Pair element in a StyleMap. This method
     * assumes that the StyleMap tag has already been written; it writes the
     * Pair tag.
     *
     ...
     *
     * @throws javax.xml.stream.XMLStreamException if exception occurs writing
     * XML.
     ...
     *
     * @param xmlWriter Writer to receive the Style element.
     * @param offset The offset to export. If {@code offset} is null, nothing is
     ...
     *
     * @param xmlWriter Writer to receive the Style element.
     * @param dimension The dimension to export. If {@code dimension} is null,
    ...
    /**
     * Export the attributes of a Size. This method assumes that the dimension
     * start tag has already been written to the stream.
     *
     * @param axes "x" or "y".
     ...
     *
     * @return The portion of {@code hexString} after the 0X. For example:
     * "0X00FF00" =&gt; "00FF00". If the string does not begin with 0X,
     * {@code hexString} is returned. The comparison is not case sensitive.
     */

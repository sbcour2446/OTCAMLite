...
/**
 * Implements the {@link KMLDoc} interface for KML files located within a
 * computer's file system.
 * <p>
 * Note: This class does not resolve references to files in KMZ archives. For
 * example, it does not resolve references like this:
...
public class KMLFile implements KMLDoc {
     ...
     *
     * @throws IOException if an error occurs attempting to create the input
     * stream.
     */
    ...
    /**
     * Returns an {@link InputStream} to a file indicated by a path relative to
     * the KML file's location.
     *
     * @param path the path of the requested file.
     *
     * @return an input stream positioned to the start of the file, or null if

...
/**
 * Executes the mapping from KML to WorldWind. Traverses a parsed KML document
 * and creates the appropriate WorldWind object to represent the KML.
 *
 * @author tag
...
public class KMLController extends WWObjectImpl implements PreRenderable, Renderable, MessageListener {
     ...
     * A KML traversal context must be initialized prior to use during
     * preRendering or rendering, to ensure that state from the previous pass
     * does not affect the current pass.
     *

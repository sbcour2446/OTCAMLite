...
public class KMLScreenImageImpl extends ScreenImage implements KMLRenderable {
    ...
    /**
     * Size value that KML uses to indicate that the native image dimension
     * should be maintained.
     */
    protected static final int KML_NATIVE_DIMENSION = -1;

    /**
     * Size value that KML uses to indicate that the image aspect ration should
     * be maintained.
     */
     ...
     * @throws IllegalArgumentException if the parent overlay or the traversal
     * context is null.
     */
    ...
    /**
     * Indicates whether or not the image source needs to be resolved. The
     * source needs to be resolved when the KMLIcon is updated.
     *
    ...
    /**
     * {@inheritDoc} Overridden to set the link expiration time based on HTTP
     * headers after the image has been retrieved.
     */
    ...
    /**
     * Get the size mode for a size parameter. The KML size tag takes a numeric
     * size attribute, but certain values of this attribute change the
     * interpretation of the tag.
     * <ul><li> A value of -1 indicates to use the native dimension.</li> <li> A
     * value of 0 indicates to maintain the aspect ratio.</li> <li> A value of n
     * sets the value of the dimension.</li></ul>
     *

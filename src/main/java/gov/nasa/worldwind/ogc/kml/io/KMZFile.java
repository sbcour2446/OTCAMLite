...
/**
 * Implements the {@link KMLDoc} interface for KMZ files located within a
 * computer's file system.
 * <p>
 * Note: This class does not yet resolve references to files in other KMZ
 * archives. For example, it does not resolve references like this:
...
public class KMZFile implements KMLDoc {
    ...
    /**
     * A mapping of the files in the KMZ file to their location in the temporary
     * directory.
     */
    protected Map<String, File> files = new HashMap<String, File>();

    /**
     * The directory to hold files copied from the KMZ file. The directory and
     * the files copied there are temporary.
     */
     ...
     *
     * @throws IOException if an error occurs while attempting to query or open
     * the file.
     ...
     *
     * @return an input stream positioned to the first KML file in the KMZ file,
     * or null if the KMZ file does not contain a KML file.
     */
    ...
    /**
     * Returns an {@link InputStream} to a specified file within the KMZ file.
     * The file's path is resolved relative to the internal root of the KMZ
     * file.
     * <p>
     * Note: This class does not yet resolve references to files in other KMZ
     * archives. For example, it does not resolve references like this:
     ...
     * @throws IOException if an error occurs while attempting to create or open
     * the input stream.
     */
    ...
    /**
     * Returns an absolute path to a specified file within the KMZ file. The
     * file's path is resolved relative to the internal root of the KMZ file.
     * <p>
     * Note: This class does not yet resolve references to files in other KMZ
     * archives. For example, it does not resolve references like this:
     * <i>../other.kmz/file.png</i>. // TODO
     *
     * @param path the path of the requested file.
     *
     * @return an absolute path to the requested file, or null if the file does
    ...
    /**
     * Copies a zip entry to a temporary file. This method should only be called
     * by a synchronized public method.
     *
     * @param entry the entry to copy.
     *
     * @return the path to the file, or null if the entry is a directory or the

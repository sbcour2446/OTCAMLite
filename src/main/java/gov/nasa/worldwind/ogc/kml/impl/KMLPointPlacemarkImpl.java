...
public class KMLPointPlacemarkImpl extends PointPlacemark implements KMLRenderable {
    ...
    /**
     * Placemark labels with a scale less than this threshold will only be drawn
     * when the placemark is highlighted. This logic supports KML files with
     * many placemarks with small labels, and drawing all the labels would be
     * too cluttered.
     */
    ...
    /**
     * {@inheritDoc} Overridden to set the expiration time of the placemark's
     * icon based on the HTTP headers of the linked resource.
     */
    ...
    /**
     * Draw the label if the label scale is greater than the label scale
     * threshold, if the image scale is zero (only the text is rendered, there
     * is no image), or if the placemark is highlighted.
     *
    ...
    /**
     * Determine and set the {@link PointPlacemark} attributes from the KML
     * <i>Feature</i> fields.
     *
     * @param attrType the type of attributes, either
     * {@link KMLConstants#NORMAL} or {@link KMLConstants#HIGHLIGHT}.
     *
     * @return The new attributes, or null if there are no attributes defined.
     * Returns a partially empty attributes bundle marked unresolved if any of
     * placemark KML styles are unresolved.
     */
    ...
    /**
     * Get the initial attributes for this feature. These attributes will be
     * changed to reflect the feature's style.
     *
     * @param attrType {@link KMLConstants#NORMAL} or
    ...
    /**
     * Get the label scale threshold. The placemark label will be drawn if the
     * label scale is greater than or equal to this threshold, or if the
    ...
    /**
     * Set the label scale threshold. The placemark label will be drawn if the
     * label scale is greater or equal to than this threshold, or if the
     * placemark is highlighted.
     *

...
/**
 * Represents the KML <i>BalloonStyle</i> element and provides access to its
 * contents.
 *
 * @author tag
...
public class KMLBalloonStyle extends KMLAbstractSubStyle {
    ...
    /**
     * Specifies this <code>KMLBalloonStyle</code>'s background color as a
     * hexadecimal string in the form: aabbggrr (deprecated). The
     * <code>color</code> style attribute was Deprecated in KML 2.1 and replaced
     * by <code>bgColor</code>.
     *
    ...
    /**
     * Specifies this <code>KMLBalloonStyle</code>'s background color as a
     * hexadecimal string in the form: aabbggrr. This is the preferred attribute
     * for encoding a balloon's background color since KML 2.1.
     *
     * @return the background color as a hexadecimal string.
     */
    ...
    /**
     * Does the style have at least one BalloonStyle field set? This method
     * tests for the existence of the BalloonStyle content fields (text,
     * displayMode, bgColor, etc).
     *
     * @return True if at least one of the BalloonStyle fields is set (text,
     * displayMode, bgColor, etc).
     */

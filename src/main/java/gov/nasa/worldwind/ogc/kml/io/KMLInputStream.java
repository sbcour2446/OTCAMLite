...
/**
 * Implements the {@link KMLDoc} interface for KML files read directly from
 * input streams.
 *
 * @author tag
...
public class KMLInputStream implements KMLDoc {
     ...
     * @param uri the URI of this KML document. This URI is used to resolve
     * relative references. May be {@code
     *                     null}.
     *
     ...
     * @param path the path of the requested file.
     *
     * @return a URL to the requested file, or {@code null} if the document does
     * not have a base URI.
     */

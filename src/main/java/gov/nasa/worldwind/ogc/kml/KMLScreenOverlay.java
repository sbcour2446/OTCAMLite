...
/**
 * Represents the KML <i>ScreenOverlay</i> element and provides access to its
 * contents.
 *
 * @author tag
...
public class KMLScreenOverlay extends KMLAbstractOverlay {
     ...
     * <code>KMLScreenOverlay</code>. This initializes the screen overlay

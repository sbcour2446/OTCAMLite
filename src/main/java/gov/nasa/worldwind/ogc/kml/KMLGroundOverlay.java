...
/**
 * Represents the KML <i>GroundOverlay</i> element and provides access to its
 * contents.
 *
 * @author tag
...
public class KMLGroundOverlay extends KMLAbstractOverlay implements KMLRenderable {
     ...
     * <code>KMLGroundOverlay</code>. This initializes the ground overlay
    ...
    /**
     * Get the renderable that represents the screen overlay. The renderable is
     * created the first time that the overlay is rendered. Until then, the
     * method will return null.
     *
     * @return The renderable, or null if the renderable has not been created
     * yet.
     */
     ...
     * {@code LatLonBox} or {@code gx:LatLonQuad}. If the overlay includes a
     * {@code LatLonBox} element, this method returns the corners of the sector
     * defined by the {@code
     * LatLonBox}. Otherwise, if the overlay contains a {@code gx:LatLonQuad},
     * this method returns the positions defined by the quad.
     *
     * @return A list of the positions that define the corner points of the
     * overlay.
     */

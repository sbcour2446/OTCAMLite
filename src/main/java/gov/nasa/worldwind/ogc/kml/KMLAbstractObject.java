...
/**
 * The abstract base class for most KML classes. Provides parsing and access to
 * the <i>id</i> and <i>targetId</i> fields of KML elements.
 *
 * @author tag
...
public abstract class KMLAbstractObject extends AbstractXMLEventParser implements MessageListener {
     ...
     *
     * @return the id of this object, or null if it's not specified in the
     * element.
     */
    public String getId() {
     ...
     *
     * @return the targetId of this object, or null if it's not specified in the
     * element.
     */

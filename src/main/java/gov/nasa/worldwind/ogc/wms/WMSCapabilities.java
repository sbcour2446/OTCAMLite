...
public class WMSCapabilities extends OGCCapabilities {
     ...
     * @throws gov.nasa.worldwind.exception.WWRuntimeException if an error
     * occurs retrieving the document.
     */
     ...
     *
     * @param docSource the XML source. May be a filename, file, stream or other
     * type allowed by {@link
    ...
    /**
     * Checks the WMS layer capabilities for a LastUpdate entry, either an
     * explicit element by that name or a layer keyword.
     *
     * @param layerCaps The layer's capabilities taken from the server's
     * capabilities document.
     *
     * @return A string representation of the epoch time for the last update
     * string, if any, otherwise null.
     */
     ...
     *
     * @param lastUpdateString The string containing the LastUpdate string in
     * the format "LastUpdate=yyyy-MM-dd'T'HH:mm:ssZ"
     *
     * @return A string representation of the epoch time for the last update
     * string, of null if the string can't be parsed as a date.
     */
    ...
    /**
     * Indicates whether the layers corresponding to a specified list of layer
     * names support a specified coordinate system. If any of the named layers
     * are not in this capabilities document, false is returned.
     *
     * @param layerNames The names of the layers to check.
     * @param coordSys The coordinate system to search for, e.g., "EPSG:4326".
     *
     * @return true if all the layers support the specified coordinate system,
     * otherwise false.
     *
     * @throws IllegalArgumentException if the layer names array is null or
     * empty or the specified coordinate system is null or the empty string.
     */

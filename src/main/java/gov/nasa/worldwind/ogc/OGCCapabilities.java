...
abstract public class OGCCapabilities extends AbstractXMLEventParser {
    ...
    /**
     * Returns the default namespace URI. Must be overridden by subclasses to
     * provide a specific URI. The default namespace is used to match XML
     * elements found in the default namespace of the XML stream.
     *
    ...
    /**
     * Determines whether a specified element name is the root element name of
     * the schema.
     *
    ...
    /**
     * Starts document parsing. This method initiates parsing of the XML
     * document and returns when the full capabilities document has been parsed.
     *

...
/**
 * Represents the COLLADA <i>Unit</i> element and provides access to its
 * contents.
 *
 * @author pabercrombie
...
public class ColladaUnit extends ColladaAbstractObject {
    ...
    /**
     * Indicates the value of the "meter" attribute of the unit. This attribute
     * is a scaling factor that converts length units in the COLLADA document to
     * meters (1.0 for meters, 1000 for kilometers, etc.) See COLLADA spec pg.
     * 5-18.
     *

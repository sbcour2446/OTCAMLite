 ...
 * The <i>p</i> element is a sort of indirect index that determines how
 * vertices, normals, and texture coordinates are read from the <i>input</i>s.
 * This tutorial is helpful for understanding how the <i>p</i> element relates
 * to COLLADA geometry: <a

...
/**
 * Represents the COLLADA <i>technique_common</i> element and provides access to
 * its contents.
 *
 * @author pabercrombie
 * @version $Id: ColladaTechniqueCommon.java 654 2012-06-25 04:15:52Z
 * pabercrombie $
 */
public class ColladaTechniqueCommon extends ColladaAbstractObject {
     ...
     *
     * @return List of materials. May return an empty list, but never returns
     * null.
     */

...
/**
 * Represents the COLLADA <i>bind_vertex_input</i> element and provides access
 * to its contents.
 *
 * @author pabercrombie
 * @version $Id: ColladaBindVertexInput.java 654 2012-06-25 04:15:52Z
 * pabercrombie $
 */
public class ColladaBindVertexInput extends ColladaAbstractObject {
     ...
     *
     * @return The value of the <i>semantic</i> field, or null if the field is
     * not set.
     */
     ...
     *
     * @return The value of the <i>input_semantic</i> field, or null if the
     * field is not set.
     */

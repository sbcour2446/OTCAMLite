...
/**
 * Represents the COLLADA <i>technique</i> element and provides access to its
 * contents.
 *
 * @author pabercrombie
...
public class ColladaTechnique extends ColladaAbstractParamContainer {
    ...
    /**
     * Indicates the shader contained by the technique. Supported shaders are
     * <i>lambert</i> and <i>phong</i>.
     *
     * @return The shader for this technique, or null if the shader is not set,
     * or is not supported.
     */

...
/**
 * Executes the mapping from COLLADA to WorldWind. Traverses a parsed COLLADA
 * document and creates the appropriate WorldWind object to represent the
 * COLLADA model.
 *
 * @author pabercrombie
...
public class ColladaController implements Renderable, PreRenderable {
    ...
    /**
     * Specifies a traversal context to use while rendering the COLLADA
     * document.
     *
    ...
    /**
     * Initializes this COLLADA controller's traversal context to its default
     * state. A COLLADA traversal context must be initialized prior to use
     * during preRendering or rendering, to ensure that state from the previous
     * pass does not affect the current pass.
     *

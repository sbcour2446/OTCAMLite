...
/**
 * Represents the COLLADA <i>accessor</i> element and provides access to its
 * contents.
 *
 * @author pabercrombie
...
public class ColladaAccessor extends ColladaAbstractObject {
    ...
    /**
     * Indicates the number of elements that this accessor can read. An element
     * is a tuple whose length depends on the number of accessor parameters. For
     * example, if the accessor has three float parameters, than an element is
     * three floats, and this method returns the number of float triplets.
     *
    ...
    /**
     * Indicates the offset into the source data at which the accessor starts
     * reading. Returns zero if this attribute has not been set.
     *
    ...
    /**
     * Indicates the number of tokens in the source data to advance between
     * elements.
     *
     * @return Offset at which the accessor starts reading.
     */
    ...
    /**
     * Indicates the number of tokens that the accessor can read. For example,
     * if the accessor reads floats, then this method returns the number of
     * floats that the accessor can read.
     *
    ...
    /**
     * Copies this accessor's content to a buffer. This method begins writing
     * data at the buffer's current position, and continues until the accessor
     * is out of data.
     *
     * @return Array of floats. May return null if the data source is not
     * available.
     */

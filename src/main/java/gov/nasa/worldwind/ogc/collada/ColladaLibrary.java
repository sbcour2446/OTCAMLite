 ...
 * This class can be used for any library element (library_nodes,
 * library_effects, etc.) by specifying a generic parameter that defines the
 * parser for the elements in the library. For example new
 * ColladaLibrary&lt;ColladaNode&gt;(ns) creates a library of ColladaNodes.
 *
 * @author pabercrombie
...
public class ColladaLibrary<T> extends ColladaAbstractObject {
    ...
    /**
     * Local name of the elements in the library. This is determined from the
     * name of the library element. For example, if the library element is
     * "library_nodes" then the element name is "node".
     */
     ...
     *
     * @return Elements in the library. Returns an empty list if the library is
     * empty.
     */

...
/**
 * Shape to render a COLLADA line or triangle mesh. An instance of this shape
 * can render any number of {@link
 * ColladaLines} or {@link ColladaTriangles}, but a single instance cannot
 * render both lines and triangles. New instances are created by {@link #createTriangleMesh(java.util.List, gov.nasa.worldwind.ogc.collada.ColladaBindMaterial)
...
public class ColladaMeshShape extends AbstractGeneralShape {
     ...
     *
     * @param geometries Geometries to render. All geometries must be of the
     * same type (either {@link ColladaTriangles} or {@link ColladaLines}.
     */
     ...
     * @param geometry Geometry for which to find material.
     *
     * @return Material for the specified geometry, or null if the material
     * cannot be resolved.
     */
    ...
    /**
     * Indicates the semantic that identifies texture coordinates. This may be
     * specified for each material using a
     * <i>bind_vertex_input</i> element.
     *
     * @param geometry Geometry for which to find semantic.
     *
     * @return The semantic string that identifies the texture coordinates, or
     * null if the geometry does not define the semantic.
     */
    ...
    /**
     * Indicates the source (file path or URL) of the texture applied to a
     * geometry.
     *
    ...
    /**
     * Indicates the reference string for an image. The image reference
     * identifies an <i>image</i> element in this, or another COLLADA file. For
     * example, "#myImage".
     *
     ...
     *
     * @return Effect applied to the specified geometry, or null if no effect is
     * defined, or the effect is not available.
     */

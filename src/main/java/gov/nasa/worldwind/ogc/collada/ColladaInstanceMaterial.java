...
/**
 * Represents the COLLADA <i>instance_material</i> element and provides access
 * to its contents.
 *
 * @author pabercrombie
 * @version $Id: ColladaInstanceMaterial.java 654 2012-06-25 04:15:52Z
 * pabercrombie $
 */
public class ColladaInstanceMaterial extends ColladaAbstractInstance<ColladaMaterial> {
    ...
    /**
     * Instance_material uses a "target" attribute instead of the "url"
     * attribute used by other instance elements.
     */
    @Override

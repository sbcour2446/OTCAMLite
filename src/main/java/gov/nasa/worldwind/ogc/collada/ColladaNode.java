...
/**
 * Represents the COLLADA <i>node</i> element and provides access to its
 * contents.
 *
 * @author pabercrombie
...
public class ColladaNode extends ColladaAbstractObject implements ColladaRenderable {
    ...
    /**
     * Children of this node. Children may be ColladaNode (direct child of this
     * node) or ColladaInstanceNode (reference to a node elsewhere in the
    ...
    /**
     * Indicates the children of this node. Children may be other node elements
     * contained directly within this node, or other nodes referenced indirectly
     * by a instance_node element.
     *
     ...
     *
     * @return The matrix specified in this node. Returns the identity matrix if
     * the node does not specify a matrix.
     */

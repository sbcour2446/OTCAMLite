...
/**
 * Represents the COLLADA <i>effect</i> element and provides access to its
 * contents.
 *
 * @author pabercrombie
...
public class ColladaEffect extends ColladaAbstractParamContainer {
     ...
     *
     * @return The value of the <i>profile_COMMON</i> field, or null if the
     * field is not set.
     */
    ...
    /**
     * Indicates the <i>texture</i> specified by this <i>effect</i>. The texture
     * is specified by the <i>diffuse</i>
     * field of the shader specified by the <i>profile_COMMON</i> element.
     *
     * @return The texture specified by this effect, or null if the texture
     * cannot be resolved.
     */
    ...
    /**
     * Indicates the material specified by this effect. Material is specified by
     * the shader in the <i>profile_COMMON</i>
     * element.
     *
     * @return The material for this effect, or null if the material cannot be
     * resolved.
     */

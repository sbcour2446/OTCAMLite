...
/**
 * Represents the COLLADA <i>instance_visual_scene</i> element and provides
 * access to its contents.
 *
 * @author pabercrombie
 * @version $Id: ColladaInstanceVisualScene.java 1696 2013-10-31 18:46:55Z
 * tgaskins $
 */
public class ColladaInstanceVisualScene extends ColladaAbstractInstance<ColladaVisualScene> implements ColladaRenderable {
    ...
    /**
     * {@inheritDoc} Renders the target of the instance pointer, if the target
     * can be resolved.
     */

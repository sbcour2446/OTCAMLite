...
/**
 * An elevation model to map another elevation model's depths to a constant
 * value, usually 0. It's typically used to produce flat oceans when using an
 * elevation model containing bathymetry. This elevation model filters
 * elevations returned from the source elevation model and sets all elevations
 * less than a specified threshold (0 by default) to that threshold. All
 * elevations returned by the source elevation model are filtered, including the
 * source model's extreme elevations.
 *
 * @author tag
 * @version $Id: BathymetryFilterElevationModel.java 2014 2014-05-20 19:46:55Z
 * tgaskins $
 */
public class BathymetryFilterElevationModel extends AbstractElevationModel {
    ...
    /**
     * Constructs an elevation model that filters the elevations from a
     * specified elevation model.
     *
     ...
     *
     * @param threshold the desired threshold. Elevations less than this value
     * are set to this value prior to being return by any method returning one
     * or more elevations.
     */
     ...
     *
     * @return the input elevation if it is greater than or equal to the
     * threshold elevation, otherwise the threshold elevation.
     */

...
public class WMSBasicElevationModel extends BasicElevationModel {
    ...
    //**************************************************************//
    /**
     * Parses WMSBasicElevationModel configuration parameters from a specified
     * WMS Capabilities source. This writes output as key-value pairs to params.
     ...
     * <tr><td>{@link AVKey#ELEVATION_MAX}</td><td>WMS layer's maximum extreme
     * elevation</td><td>Double</td></tr>
     * <tr><td>{@link AVKey#ELEVATION_MIN}</td><td>WMS layer's minimum extreme
     * elevation</td><td>Double</td></tr>
     * <tr><td>{@link AVKey#DATA_TYPE}</td><td>Translate WMS layer's image
     * format to a matching data type</td><td>String</td></tr> </table> This
     * also parses common WMS layer parameters by invoking {@link DataConfigurationUtils#getWMSLayerConfigParams(gov.nasa.worldwind.ogc.wms.WMSCapabilities,
     * String[], gov.nasa.worldwind.avlist.AVList)}.
     *
     * @param caps the WMS Capabilities source to parse for
     * WMSBasicElevationModel configuration parameters.
     * @param formatOrderPreference an ordered array of preferred image formats,
     ...
     *
     * @throws IllegalArgumentException if either the document or params are
     * null, or if params does not contain the required key-value pairs.
     * @throws gov.nasa.worldwind.exception.WWRuntimeException if the
     * Capabilities document does not contain any of the required information.
     */
    ...
    /**
     * Appends WMS basic elevation model configuration elements to the
     * superclass configuration document.
     *
     * @param params configuration parameters describing this WMS basic
     * elevation model.
     *

...
public class WCSElevationModel extends BasicElevationModel {
     ...
     *
     * @param restorableStateInXml XML string in WorldWind restorable state
     * format.
     *
    ...
    /**
     * Appends WCS elevation model configuration elements to the superclass
     * configuration document.
     *
     * @param params configuration parameters describing this WCS basic
     * elevation model.
     *

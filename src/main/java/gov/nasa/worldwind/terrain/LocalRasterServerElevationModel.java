...
/**
 * Implements an {@link gov.nasa.worldwind.globes.ElevationModel} for a local
 * dataset accessed via a local raster server ({@link RasterServer}).
 *
 * @author tag
 * @version $Id: LocalRasterServerElevationModel.java 1171 2013-02-11 21:45:02Z
 * dcollins $
 */
public class LocalRasterServerElevationModel extends BasicElevationModel {

    /**
     * Constructs an elevation model from a list of parameters describing the
     * elevation model.
     * <p>
     ...
     * @throws IllegalStateException if the required parameters are missing from
     * the parameter list.
     */
     ...
     * <p>
     * Either the specified XML document or parameter list must contain values
     * for DATASET_NAME and DATA_CACHE_NAME.
     * <p>
     * TODO: Enumerate the other required and optional parameters.
     *
     * @param dom the XML document describing the dataset.
     * @param params a list of parameters that each override a parameter of the
     * same name in the XML document, or that augment the definition there.
     *
     * @throws IllegalArgumentException if the XML document reference is null.
     * @throws IllegalStateException if the required parameters are missing from
     * the XML document or the parameter list.
     */
     ...
     * <p>
     * Either the specified XML element or parameter list must contain values
     * for DATASET_NAME and DATA_CACHE_NAME.
     * <p>
     * TODO: Enumerate the other required and optional parameters.
     *
     ...
     * @throws IllegalArgumentException if the XML document reference is null.
     * @throws IllegalStateException if the required parameters are missing from
     * the XML element or the parameter list.
     */
     ...
     * {@link #getRestorableState()} on another instance of this class.
     *
     * @param restorableStateInXml a string containing the restorable state.
     *
     * @throws IllegalArgumentException if the restorable state is null or
     * cannot be interpreted.
     * @throws IllegalStateException if the restorable state does not contain
     * values for DATASET_NAME and DATA_CACHE_NAME.
     */

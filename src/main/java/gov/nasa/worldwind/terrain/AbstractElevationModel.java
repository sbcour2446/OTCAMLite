...
abstract public class AbstractElevationModel extends WWObjectImpl implements ElevationModel {
    ...
    //**************************************************************//
    /**
     * Returns true if a specified DOM document is an ElevationModel
     * configuration document, and false otherwise.
     *
     * @param domElement the DOM document in question.
     *
     * @return true if the document is an ElevationModel configuration document;
     * false otherwise.
     *
    ...
    /**
     * Appends elevation model configuration parameters as elements to the
     ...
     * AVKey#DETAIL_HINT}</td><td>DataDetailHint</td><td>Double</td></tr>
     * </table>
     *
     * @param params the key-value pairs which define the elevation model
     * configuration parameters.
     * @param context the XML document root on which to append elevation model
    ...
    /**
     * Parses elevation model configuration parameters from the specified DOM
     ...
     * ignored. Supported parameters are: <table>
     ...
     * </table>
     *
     * @param domElement the XML document root to parse for elevation model
     * configuration elements.
     * @param params the output key-value pairs which recieve the elevation
     * model configuration parameters. A null reference is permitted.
     *

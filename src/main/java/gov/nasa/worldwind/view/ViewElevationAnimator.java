...
/**
 * An {@link gov.nasa.worldwind.animation.Animator} for elevation values.
 * Calculates a mid-zoom value that gives the effect of flying up and them back
 * down again.
 *
 * @author jym
...
public class ViewElevationAnimator extends DoubleAnimator {
    ...
    /**
     * Create the animator. If the altitude mode is relative to surface
     * elevation, the ending elevation will be re-calculated as the animation
     * runs to ensure that the final elevation is based on the most accurate
     * elevation data available.
     *
     * @param globe Globe used to evaluate altitude mode and determine if
     * mid-zoom is necessary. May be null.
     ...
     *                         {@link WorldWind#RELATIVE_TO_GROUND}, or {@link WorldWind#ABSOLUTE}.
     * Altitude mode is not used if {@code globe} is null.
    ...
    /**
     * determines whether this Animator is using midZoom. The mid-point zoom is
     * an interpolated value between minimum(the lesser of beginZoom and
     * endZoom, and maximum zoom (3* the radius of the globe).
     *
    ...
    /**
     * Set the animator's end zoom level. Setting the end zoom does not change
     * the mid-zoom.
     *
    ...
    /**
     * Determines if the animation will use mid-zoom. Mid-zoom animation is used
     * if the difference between the beginZoom and endZoom values is less than
     * the difference between the midZoom value and the larger of the beginZoom
     * or endZoom values.
     *

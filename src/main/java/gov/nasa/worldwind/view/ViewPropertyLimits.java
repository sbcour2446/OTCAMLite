...
/**
 * ViewPropertyLimits defines a restriction on the viewing parameters of a
 * {@link View}.
 *
 * @author jym
...
public interface ViewPropertyLimits {
    ...
    /**
     * Sets the minimum and maximum angles which will limit a view's heading
     * property.
     *
    ...
    /**
     * Sets the minimum and maximum angles which will limit a view's pitch
     * property.
     *
    ...
    /**
     * Sets the minimum and maximum angles which will limit a view's roll
     * property.
     *
    ...
    /**
     * Returns a position clamped to the eye location limits and the eye
     * elevation limits specified by this limit object. This method does not
     * modify the specified view's properties, but may use the view as a context
     * for determining how to apply the limits.
     *
     * @param view the view associated with the center position and the property
     * limits.
    ...
    /**
     * Returns an angle clamped to the heading limits specified by this limit
     * object. This method does not modify the specified view's properties, but
     * may use the view as a context for determining how to apply the limits.
     *
     * @param view the view associated with the heading angle and the property
     * limits.
    ...
    /**
     * Returns an angle clamped to the pitch limits specified by this limit
     * object. This method does not modify the specified view's properties, but
     * may use the view as a context for determining how to apply the limits.
     *
     * @param view the view associated with the pitch angle and the property
     * limits.
     * @param angle angle to clamp to the allowed range.
     *
     * @return The clamped angle.
    ...
    /**
     * Returns an angle clamped to the roll limits specified by this limit
     * object. This method does not modify the specified view's properties, but
     * may use the view as a context for determining how to apply the limits.
     *
     * @param view the view associated with the roll angle and the property
     * limits.
     * @param angle angle to clamp to the allowed range.
     *
     * @return The clamped angle.

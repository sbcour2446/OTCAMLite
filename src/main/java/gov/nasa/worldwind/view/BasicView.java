...
/**
 * A base class from which {@link View} implementations can be derived.
 * Currently {@link
 * gov.nasa.worldwind.view.firstperson.BasicFlyView} and
 * {@link gov.nasa.worldwind.view.orbit.BasicOrbitView} are both derived from
 * {@link BasicView} {@link BasicView} models the view in terms of a geographic
 * position, and a pitch, heading, and roll. It provides a mapping from that
 * geocentric view model to a 3D graphics modelview matrix. BasicView also
 * manages the projection matrix via a {@link Frustum}.
 * <p>
...
public class BasicView extends WWObjectImpl implements View {
    ...
    /**
     * The views's default worst-case depth resolution, in meters. May be
     * specified in the WorldWind configuration file as the
     * <code>gov.nasa.worldwind.avkey.DepthResolution</code> property. The
     * default if not specified in the configuration is 3.0 meters.
     */
    ...
    /**
     * Returns the most up-to-date forward vector. Unlike
     * {@link #getForwardVector()}, this method will return the View's immediate
     * forward vector.
     *

...
public class BasicOrbitViewLimits extends BasicViewPropertyLimits implements OrbitViewLimits {
    ...
    /**
     * Clamp center location angles and elevation to the range specified in a
     * limit object.
     *
     ...
     * @throws IllegalArgumentException if any argument is null.
     * @deprecated Use
     * {@link #limitCenterPosition(gov.nasa.worldwind.View, gov.nasa.worldwind.geom.Position)}
     * instead.
     */
    @Deprecated
     ...
     *
     * @throws IllegalArgumentException if any argument is null.
     * @deprecated Use {@link #limitZoom(gov.nasa.worldwind.View, double)}
     * instead.
     */
    @Deprecated

...
/**
 * OrbitViewLimits extends the ViewPropertyLimits interface to include
 * restrictions on the viewing parameters of an {@link OrbitView}.
 *
 * @author dcollins
...
public interface OrbitViewLimits extends ViewPropertyLimits {
    ...
    /**
     * Returns the Sector which limits the orbit view center latitude and
     * longitude.
     *
    ...
    /**
     * Sets the Sector which will limit the orbit view center latitude and
     * longitude.
     *
    ...
    /**
     * Returns the minimum and maximum values for the orbit view center
     * elevation.
     *
    ...
    /**
     * Sets the minimum and maximum values which will limit the orbit view
     * center elevation.
     *
    ...
    /**
     * Sets the minimum and maximum values which will limit the orbit view zoom
     * property.
     *
    ...
    /**
     * Returns a position clamped to the center location limits and center
    ...
    /**
     * Returns a distance clamped to the zoom limits specified by this limit
     ...
     *
     * @param view the view associated with the zoom distance and the property
     * limits.

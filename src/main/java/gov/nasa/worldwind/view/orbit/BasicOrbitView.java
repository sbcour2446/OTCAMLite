...
public class BasicOrbitView extends BasicView implements OrbitView {
    ...
    /**
     * Returns the <code>OrbitViewLimits</code> that apply to this
     * <code>OrbitView</code>. Incoming parameters to the methods
     * setCenterPosition, setHeading, setPitch, or setZoom are be limited by the
     * parameters defined in this <code>OrbitViewLimits</code>.
     *
     * @return the <code>OrbitViewLimits</code> that apply to this
     * <code>OrbitView</code>
     */
    ...
    /**
     * Sets the <code>OrbitViewLimits</code> that will apply to this
     * <code>OrbitView</code>. Incoming parameters to the methods
     * setCenterPosition, setHeading, setPitch, or setZoom will be limited by
     * the parameters defined in <code>viewLimits</code>.
     *
     * @param viewLimits the <code>OrbitViewLimits</code> that will apply to
     * this <code>OrbitView</code>.
     *
    ...
    /**
     * Alerts the BasicOrbitView that the view requires the point of rotation
     * for heading and pitch changes to be recalculated.
     *
     * @param b true if the point of rotation needs recalculation, false if it
     * does not.
     */
     ...
     * {@link #focusOnViewportCenter}. Focusing on the viewport center requires
     * a non-null {@link gov.nasa.worldwind.globes.Globe}, a non-null {@link
    ...
    /**
     * Sets the point of rotation for heading and pitch changes to the surface
     * position at the viewport center.
     */
    ...
    /**
     * Restores state values from previous versions of the BasicObitView state
     ...
     * are restored in {@link #doRestoreState(gov.nasa.worldwind.util.RestorableSupport,

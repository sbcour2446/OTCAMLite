...
public class PlaceNameLayer extends AbstractLayer implements BulkRetrievable {
    ...
    /**
     * @param placeNameServiceSet the set of PlaceNameService objects that
     * PlaceNameLayer will render.
     *
     * @throws IllegalArgumentException if
     * {@link gov.nasa.worldwind.layers.placename.PlaceNameServiceSet} is null
     */
     ...
     * @return not in use
     *
     * @deprecated This flag no longer has any effect. Placenames participate in
     * global decluttering.
     */
    @Deprecated
...
//        return placeNameService.getExtent(dc).intersects(dc.getView().getFrustumInModelCoordinates());
    ...
    // *** Bulk download ***
    /**
     * Start a new {@link BulkRetrievalThread} that downloads all placenames for
     ...
     * been started, construct a {@link PlaceNameLayerBulkDownloader}.
     * <p>
     ...
     *
     * @return the {@link PlaceNameLayerBulkDownloader} that executes the
     * retrieval.
     *
    ...
    /**
     * Start a new {@link BulkRetrievalThread} that downloads all placenames for
     * a given sector and resolution to a specified file store.
     * <p>
     * This method creates and starts a thread to perform the download. A
     * reference to the thread is returned. To create a downloader that has not
     * been started, construct a {@link PlaceNameLayerBulkDownloader}.
    ...
    /**
     * Get the estimated size in bytes of the placenames not in the WorldWind
    ...
    /**
     * Get the estimated size in bytes of the placenames not in a specified file

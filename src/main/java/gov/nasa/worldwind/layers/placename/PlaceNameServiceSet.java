...
public class PlaceNameServiceSet extends WWObjectImpl implements AVList {
     ...
     * @param replace {@code true} if the service may replace an equivalent
     * service already in the set. {@code
     *                         false} if the service may not replace a service already in the set.
     *
     * @return {@code true} if the service was added to the service set, or if
     * the service replaced an existing item in the service set. Returns
     * {@code false} if the set was not changed.
     *

...
public class PlaceNameService {
     ...
     * <code>column</code> is less than zero
     */
     ...
     * {@link gov.nasa.worldwind.geom.Sector} is null
     */
     ...
     *
     * @throws IllegalArgumentException if
     * {@link gov.nasa.worldwind.render.DrawContext} is null
     */
    ...
    /**
     * @param maxDisplayDistance maximum distance to display labels for this
     * service
     *
     * @throws IllegalArgumentException if <code>maxDisplayDistance</code> is
     * less than the current minimum display distance
     */
    ...
    /**
     * @param minDisplayDistance minimum distance to display labels for this
     * service
     *
     * @throws IllegalArgumentException if <code>minDisplayDistance</code> is
     * less than the current maximum display distance
     */
    ...
    /**
     * Determines if this
     * {@link gov.nasa.worldwind.layers.placename.PlaceNameService} constructor
     * arguments are valid.
     *
     * @return null if valid, otherwise a string message containing a

...
/**
 * Downloads placenames not currently available in the WorldWind file cache or a
 * specified {@link FileStore}. The class derives from {@link Thread} and is
 * meant to operate in its own thread.
 * <p>
 * The sector and resolution associated with the downloader are specified during
 * construction and are final.
 *
 * @author tag
 * @version $Id: PlaceNameLayerBulkDownloader.java 1171 2013-02-11 21:45:02Z
 * dcollins $
 */
public class PlaceNameLayerBulkDownloader extends BulkRetrievalThread {
    ...
    /**
     * Constructs a downloader to retrieve placenames not currently available in
    ...
    /**
     * Constructs a downloader to retrieve placenames not currently available in
     * a specified file store and places it there.
     * <p>
     * The thread returned is not started during construction, the caller must
     * start the thread.
     *

...
public class CrosshairLayer extends AbstractLayer {
    ...
    /**
     * Sets the crosshair icon's image location. The layer first searches for
     ...
     * displayed size of the crosshair icon. This scale factor is used only when
     ...
     * height is adjusted to maintain the crosshair image's native aspect ratio.
     *
    ...
    /**
     * Sets the scale factor defining the displayed size of the crosshair icon
    ...
    /**
     * Sets the behavior the layer uses to size the crosshair icon when the
     ...
     * crosshair-to-viewport scale and by the icon's image file size scaled by
     * the current icon scale. If the value is AVKey.RESIZE_SHRINK_ONLY (the
    ...
    /**
     * Get the crosshair location inside the viewport. If this location is null,
     * the crosshair is drawn in the viewport center.
     *
    ...
    /**
     * Set the crosshair location inside the viewport. If this location is null,
     * the crosshair will be drawn in the viewport center.
     *

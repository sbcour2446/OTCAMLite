...
/**
 * Holds a collection of Renderables and manages local caching of them. Provides
 * searching for Renderables by sector, location or name.
 * <p>
 * NOTE: This class is experimental and not fully implemented. You should not
 * use it now.
 *
 * @author tag
...
public class CachedRenderableLayer extends AbstractLayer {
     ...
     *
     * @throws IllegalArgumentException if the coverage sector is null or the
     * number of levels is less than 1;
     */
     ...
     *
     * @throws IllegalArgumentException if the item is null or does not
     * implement {@link gov.nasa.worldwind.render.GeographicExtent}.
    ...
    /**
     * Adds a named Renderable to the layer. The Renderable can subsequently
     * participate in a name search of the layer.
     *
     * @param item the Renderable to add.
     * @param name a name for the Renderable. May be null, in which case the
     * item has no name.
     *
     * @throws IllegalArgumentException if the item is null or does not
     * implement {@link gov.nasa.worldwind.render.GeographicExtent}.
     ...
     *
     * @param name the name of the Renderable to remove. If null, no Renderable
     * is removed.
     *
     ...
     *
     * @return the Collection of Renderables within or intersecting the boundary
     * of the sector.
     *
     ...
     *
     * @param name the name to search for. If null, no search is performed and
     * null is returned.
     *
     * @return the Renderable of the given name, or null if no Renderable with
     * the name is in the layer.
     */
    ...
    /**
     * Disposes any Renderables implementing @{link Dispose} and removes all
     * Renderables from the layer.
     */
    public void dispose() {

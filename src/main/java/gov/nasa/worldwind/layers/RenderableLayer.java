...
public class RenderableLayer extends AbstractLayer {
    ...
    /**
     * Adds the specified <code>renderable</code> to the end of this layer's
     ...
     * removed in {@link #removeRenderable(gov.nasa.worldwind.render.Renderable)},
     ...
     * a call to <code>setRenderables</code>.
     */
    ...
    /**
     * Inserts the specified <code>renderable</code> at the specified
     * <code>index</code> in this layer's internal collection. If this layer's
     * internal collection has been overridden with a call to {@link
     ...
     *
     * @throws IllegalArgumentException If <code>renderable</code> is null, if
     * the <code>index</code> is less than zero, or if the <code>index</code> is
     * greater than the number of renderables in this layer.
     * @throws IllegalStateException If a custom Iterable has been specified by
     * a call to <code>setRenderables</code>.
     */
     ...
     * <code>renderable</code> are removed in {@link #removeRenderable(gov.nasa.worldwind.render.Renderable)},
     * {@link #removeAllRenderables()}, or {@link #dispose()}.
     *
     ...
     * {@link #addRenderable(gov.nasa.worldwind.render.Renderable)} or {@link
     ...
     * #setRenderables(Iterable)}, this will returns a reference to that
     * Iterable. If the caller passed <code>setRenderables</code> a null
     * parameter, or if <code>setRenderables</code> has not been called, this
     * returns a view of this layer's internal collection of Renderables.
     *
     ...
     * Renderables, and will prevent any modification to its contents via <code>addRenderable,
     ...
     *
     * @param renderableIterable Iterable to use instead of this layer's

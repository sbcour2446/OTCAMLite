 ...
 * <p>
 * Note : based on a spherical globe.<br> Issue : Ellipsoidal globe doesnt match
 * the spherical atmosphere everywhere.
 *
...
public class SkyGradientLayer extends AbstractLayer {
     ...
     * @param gradientBias determines how fast the sky goes from the horizon
     * color to the zenith color. A value of <code>1</code> with produce a
     * balanced gradient, a value greater then <code>1</code> will have the
     * zenith color dominate and a value less then <code>1</code> will have the
     * opposite effect.
     */

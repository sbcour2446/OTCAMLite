...
public abstract class AbstractLayer extends WWObjectImpl implements Layer {
     ...
     *
     * @throws IllegalArgumentException if <code>dc</code> is null, or
     * <code>dc</code>'s <code>Globe</code> or <code>View</code> is null
     */
    ...
    //**************************************************************//
    /**
     * Returns true if a specified DOM document is a Layer configuration
     * document, and false otherwise.
     *
     * @param domElement the DOM document in question.
     *
     * @return true if the document is a Layer configuration document; false
     * otherwise.
     *
    ...
    /**
     * Appends layer configuration parameters as elements to the specified
     * context. This appends elements for the following parameters: <table>
     * <caption style="font-weight: bold;">Append Elements</caption>
     ...
     * </table>
     *
     * @param params the key-value pairs which define the layer configuration
     * parameters.
     * @param context the XML document root on which to append layer
     ...
     *
     * @param domElement the XML document root to parse for layer configuration
     * elements.
     * @param params the output key-value pairs which recieve the layer

...
/**
 * AirspaceLayer manages a list of airspaces for rendering and picking.
 * AirspaceLayer was originally designed as a special purpose layer for
 * {@link Airspace} shapes, but is now a redundant with {@link RenderableLayer}.
 * Usage of AirspaceLayer should be replaced with RenderableLayer. Most methods
 * on AirspaceLayer can be replaced with the equivalent methods of Airspace or
 * RenderableLayer. The methods that are no longer supported are documented as
 * such.
 *
 * @author dcollins
...
public class AirspaceLayer extends AbstractLayer {
    ...
    /**
     * Adds the specified <code>airspace</code> to this layer's internal
     * collection. If this layer's internal collection has been overridden with
     * a call to {@link #setAirspaces(Iterable)}, this will throw an exception.
     *
     * @param airspace the airspace to add.
     *
     * @throws IllegalArgumentException if the airspace is null.
     * @throws IllegalStateException if a custom Iterable has been specified by
     * a call to setRenderables.
     * @deprecated Use {@link RenderableLayer} and
     * {@link RenderableLayer#addRenderable(gov.nasa.worldwind.render.Renderable)}
     * instead.
     */
    @Deprecated
    ...
    /**
     * Adds the contents of the specified <code>airspaces</code> to this layer's
     * internal collection. If this layer's internal collection has been
     * overridden with a call to {@link #setAirspaces(Iterable)}, this will
     * throw an exception.
     *
     ...
     * a call to setRenderables.
     * @deprecated Use {@link RenderableLayer} and
     * {@link RenderableLayer#addRenderables(Iterable)} instead.
     */
    @Deprecated
    ...
    /**
     * Removes the specified <code>airspace</code> from this layer's internal
     ...
     * a call to setRenderables.
     * @deprecated Use {@link RenderableLayer} and
     * {@link RenderableLayer#removeRenderable(gov.nasa.worldwind.render.Renderable)}
     * instead.
     */
    @Deprecated
    ...
    /**
     * Clears the contents of this layer's internal Airspace collection. If this
     * layer's internal collection has been overridden with a call to
     * {@link #setAirspaces(Iterable)}, this will throw an exception.
     *
     * @throws IllegalStateException If a custom Iterable has been specified by
     * a call to <code>setAirspaces</code>.
     * @deprecated Use {@link RenderableLayer} and
     * {@link RenderableLayer#removeAllRenderables()} instead.
     */
    @Deprecated
    ...
    /**
     * Returns the Iterable of Airspaces currently in use by this layer. If the
     * caller has specified a custom Iterable via
     * {@link #setAirspaces(Iterable)}, this will returns a reference to that
     * Iterable. If the caller passed <code>setAirspaces</code> a null
     * parameter, or if <code>setAirspaces</code> has not been called, this
     * returns a view of this layer's internal collection of Airspaces.
     *
     * @return Iterable of currently active Airspaces.
     *
     * @deprecated Use {@link RenderableLayer} and
     * {@link RenderableLayer#getRenderables()} instead.
     */
    @Deprecated
     ...
     * specified a custom Iterable via {@link
     * #setAirspaces(Iterable)}, this will returns a reference to that Iterable.
     * If the caller passed <code>setAirspaces</code> a null parameter, or if
     ...
     * <code>airspaceIterable</code>. This layer will maintain a reference to
     * <code>airspaceIterable</code> strictly for picking and rendering. This
     * layer will not modify the Iterable reference. However, this will clear
     * the internal collection of Airspaces, and will prevent any modification
     * to its contents via
     * <code>addAirspace, addAirspaces, or removeAirspaces</code>.
     * <p>
     * If the specified <code>airspaceIterable</code> is null, this layer will
     * revert to maintaining its internal collection.
     *
     * @param airspaceIterable Iterable to use instead of this layer's internal
     * collection, or null to use this layer's
     *
     * @deprecated Use {@link RenderableLayer} and
     * {@link RenderableLayer#setRenderables(Iterable)} instead.
     */
    @Deprecated
     ...
     *
     * @deprecated Use
     * {@link gov.nasa.worldwind.render.ShapeAttributes#isEnableAntialiasing()}
     * on each Airspace instance in the layer.
     */
    @Deprecated
     ...
     *
     * @deprecated Use
     * {@link gov.nasa.worldwind.render.ShapeAttributes#setEnableAntialiasing(boolean)}
     * on each Airspace instance in the layer.
     */
    @Deprecated
     ...
     * @return false
     *
     * @deprecated Control over airspace blending is no longer supported.
     * Airspaces implicitly blend themselves with other objects in the scene.
     */
    @Deprecated
     ...
     *
     * @deprecated Use
     * {@link gov.nasa.worldwind.render.airspaces.Airspace#isEnableDepthOffset()}
     * on each Airspace instance in the layer.
     */
    @Deprecated
     ...
     *
     * @deprecated Use
     * {@link gov.nasa.worldwind.render.airspaces.Airspace#setEnableDepthOffset(boolean)}
     * on each Airspace instance in the layer.
     */
    @Deprecated
     ...
     *
     * @deprecated Use
     * {@link gov.nasa.worldwind.render.ShapeAttributes#isEnableLighting()} on
     * each Airspace instance in the layer.
     */
    @Deprecated
     ...
     * @return false
     *
     * @deprecated Control over drawing Airspace in wireframe mode is no longer
     * supported.
     */
    @Deprecated
     ...
     * @return 0
     *
     * @deprecated Control over Airspace depth offset is no longer supported.
     * See {@link
     ...
     *
     * @deprecated Control over Airspace depth factor is no longer supported.
     * See {@link
     *             gov.nasa.worldwind.render.airspaces.Airspace#setEnableDepthOffset(boolean)}.
     */
    @Deprecated
     ...
     *
     * @deprecated Use
     * {@link gov.nasa.worldwind.render.airspaces.Airspace#isEnableBatchRendering()}
     * on each Airspace instance in the layer.
     */
    @Deprecated
     ...
     *
     * @deprecated Use
     * {@link gov.nasa.worldwind.render.airspaces.Airspace#setEnableBatchRendering(boolean)}
     * on each Airspace instance in the layer.
     */
    @Deprecated
     ...
     *
     * @deprecated Use
     * {@link gov.nasa.worldwind.render.airspaces.Airspace#isEnableBatchPicking()}
     * on each Airspace instance in the layer.
     */
    @Deprecated
     ...
     *
     * @deprecated Use
     * {@link gov.nasa.worldwind.render.airspaces.Airspace#setEnableBatchPicking(boolean)}
     * on each Airspace instance in the layer.
     */
    @Deprecated

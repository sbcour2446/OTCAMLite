...
public class CompassLayer extends AbstractLayer {
    ...
    /**
     * Sets the compass icon's image location. The layer first searches for this
     * location in the current Java classpath. If not found then the specified
     * path is assumed to refer to the local file system. found there then the
     *
     ...
     * displayed size of the compass icon. This scale factor is used only when
     ...
     * height is adjusted to maintain the compass image's native aspect ratio.
     *
    ...
    /**
     * Sets the scale factor defining the displayed size of the compass icon
     ...
     * {@link #setCompassToViewportScale(double)} and the current viewport size.
     * <p>
    ...
    /**
     * Sets the behavior the layer uses to size the compass icon when the
     ...
     * enlarges. The relative size is determined by the current
     * compass-to-viewport scale and by the icon's image file size scaled by the
     ...
     *
     * @param borderWidth the number of pixels to offset the compass icon from
    ...
    /**
     * Sets the relative viewport location to display the compass icon. Can be
     * one of AVKey.NORTHEAST (the default), AVKey.NORTHWEST, AVKey.SOUTHEAST,
     * or AVKey.SOUTHWEST. These indicate the corner of the viewport to place
     * the icon.
     *
    ...
    /**
     * Specifies the screen location of the compass image, relative to the
     * image's center. May be null. If this value is non-null, it overrides the
     * position specified by {@link #setPosition(String)}. The location is
     * specified in pixels. The origin is the window's lower left corner.
     * Positive X values are to the right of the origin, positive Y values are
     * upwards from the origin. The final image location will be affected by the
     * currently specified location offset if a non-null location offset has
     * been specified (see {@link
     ...
     *
     * @param locationOffset the number of pixels to shift the compass image

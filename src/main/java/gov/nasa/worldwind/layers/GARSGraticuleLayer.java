...
/**
 * Displays the geographic Global Area Reference System (GARS) graticule. The
 * graticule has four levels. The first level displays lines of latitude and
 * longitude. The second level displays 30 minute square grid cells. The third
 * level displays 15 minute grid cells. The fourth and final level displays 5
 * minute grid cells.
 *
...
public class GARSGraticuleLayer extends AbstractGraticuleLayer {
    ...
    /**
     * Indicates the eye altitudes in meters below which each level should be
     * displayed.
     */
     ...
     * {@link gov.nasa.worldwind.geom.Angle#ANGLE_FORMAT_DD} or
     * {@link gov.nasa.worldwind.geom.Angle#ANGLE_FORMAT_DMS}.
     *
     ...
     * gov.nasa.worldwind.geom.Angle#ANGLE_FORMAT_DD}, {@link gov.nasa.worldwind.geom.Angle#ANGLE_FORMAT_DMS}
     * of {@link
     ...
     *
     * @param altitude the eye altitude in meters below which the 30 minute grid
     * is displayed.
     */
     ...
     *
     * @return the eye altitude in meters below which the 30 minute grid is
     * displayed.
     */
     ...
     *
     * @param altitude the eye altitude in meters below which the 15 minute grid
     * is displayed.
     */
     ...
     *
     * @return the eye altitude in meters below which the 15 minute grid is
     * displayed.
     */
     ...
     *
     * @param altitude the eye altitude in meters below which the 5 minute grid
     * is displayed.
     */
     ...
     *
     * @return the eye altitude in meters below which the 5 minute grid is
     * displayed.
     */

...
public class LayerList extends CopyOnWriteArrayList<Layer> implements WWObject {
    ...
    /**
     * Aggregate the contents of a group of layer lists into a single one. All
     * layers are placed in the first designated list and removed from the
     * subsequent lists.
     *
     * @param lists an array containing the lists to aggregate. All members of
     * the second and subsequent lists in the array are added to the first list
     * in the array.
     *
     * @return the aggregated list.
     *
     * @throws IllegalArgumentException if the layer-lists array is null or
     * empty.
     */

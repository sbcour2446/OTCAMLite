...
public class MGRSGraticuleLayer extends UTMBaseGraticuleLayer {
    ...
    /**
     * Creates a new <code>MGRSGraticuleLayer</code>, with default graticule
     * attributes.
     */
    ...
    /**
     * Returns the maxiumum resolution graticule that will be rendered, or null
     * if no graticules will be rendered. By default, all graticules are
     * rendered, and this will return GRATICULE_1M.
     *
     ...
     *
     * @param graticuleType one of GRATICULE_UTM, GRATICULE_UTM_GRID,
     * GRATICULE_100000M, GRATICULE_10000M, GRATICULE_1000M, GRATICULE_100M,
     * GRATICULE_10M, or GRATICULE_1M.
     *
     ...
     * GRATICULE_10M, or GRATICULE_1M.
     *
     * @throws IllegalArgumentException if<code>color</code> is null, if
     * <code>graticuleType</code> is null, or if <code>graticuleType</code> is
     * not a valid type.
     */
     ...
     * GRATICULE_10M, or GRATICULE_1M
     *
     * @throws IllegalArgumentException if <code>lineStyle</code> is null, if
     * <code>graticuleType</code> is null, or if <code>graticuleType</code> is
     * not a valid type.
     */
     ...
     *
     * @param lineStyle the line rendering style. One of LINE_STYLE_PLAIN,
    ...
    /**
     * Sets whether the specified graticule labels will be rendered. If true,
     * the graticule labels will be rendered. Otherwise, the graticule labels
     * will not be rendered, but other graticules will not be affected.
     *
     * @param drawLabels true to render graticule labels; false to disable
     * rendering.
     * @param graticuleType one of GRATICULE_UTM, GRATICULE_UTM_GRID,
     * GRATICULE_100000M, GRATICULE_10000M, GRATICULE_1000M, GRATICULE_100M,
     * GRATICULE_10M, or GRATICULE_1M.
    ...
    /**
     * Sets whether all graticule labels will be rendered. If true, all
     * graticule labels will be rendered. Otherwise, all graticule labels will
     * not be rendered.
     *
     * @param drawLabels true to render all graticule labels; false to disable
     * rendering.
     */
     ...
     * GRATICULE_10M, or GRATICULE_1M.
     *
     * @throws IllegalArgumentException if<code>font</code> is null, if
     * <code>graticuleType</code> is null, or if <code>graticuleType</code> is
     * not a valid type.
     */

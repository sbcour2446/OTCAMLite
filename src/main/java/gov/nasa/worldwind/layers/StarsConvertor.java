...
/**
 * Converts a star background based on a subset of ESA Hipparcos catalog to
 * ByteBuffer.
 *
...
public class StarsConvertor {
     ...
     *
     * @return ByteBuffer with interleaved color and vertex positions as floats
    ...
    /**
     * Converts position in spherical coordinates (lat/lon/radius) to cartesian
     * (XYZ) coordinates.
     *

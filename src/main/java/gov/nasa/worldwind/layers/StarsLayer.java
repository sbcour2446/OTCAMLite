...
public class StarsLayer extends RenderableLayer {
    ...
    /**
     * Constructs a stars layer using the default stars file, which may be
    ...
    /**
     * Constructs a stars layer using a specified stars file and star-field
     * radius.
     *
     * @param starsFileName the full path the star file.
     * @param radius the radius of the stars sphere. May be null, in which case
     * the radius in the stars file is used.
     */
    ...
    /**
     * Called by constructors to save the stars file name, the stars field
     * radius and the layer's minimum active altitude.
     *
     * @param starsFileName the full path the star file.
     * @param radius the radius of the stars sphere. May be null, in which case
     * the radius in the stars file is used.

...
public class AbstractGraticuleLayer extends AbstractLayer {
    ...
    /**
     * Solid line rendering style. This style specifies that a line will be
     * drawn without any breaks. <br>
    ...
    /**
     * Dashed line rendering style. This style specifies that a line will be
     * drawn as a series of long strokes, with space in between. <br>
     * <pre><code>- - - - -</code></pre>
    ...
    /**
     * Dotted line rendering style. This style specifies that a line will be
     * drawn as a series of evenly spaced "square" dots. <br>
     ...
     *
     * @param drawGraticule true to render graticule lines; false to disable
     * rendering.
     * @param key the rendering parameters key.
     *
     * @throws IllegalArgumentException <code>key</code> is null.
     ...
     *
     * @param lineStyle rendering style of the graticule lines. One of
     * LINE_STYLE_PLAIN, LINE_STYLE_DASHED, or LINE_STYLE_DOTTED.
     * @param key the rendering parameters key.
     *
     * @throws IllegalArgumentException if <code>lineStyle</code> or
     * <code>key</code> is null.
     */
     ...
     * @param key the rendering parameters key.
     *
     * @throws IllegalArgumentException if <code>font</code> or <code>key</code>
     * is null.
     */
    ...
    /**
     * Determines whether the grid should be updated. It returns true if: <ul>
     * <li>the eye has moved more than 1% of its altitude above ground <li>the
     * view FOV, heading or pitch have changed more than 1 degree <li>vertical
    ...
    /**
     * Computes the intersection point position between a great circle segment
     * and a meridian.
     *
     ...
     *
     * @return the intersection <code>Position</code> or null if there was no
     * intersection found.
     */

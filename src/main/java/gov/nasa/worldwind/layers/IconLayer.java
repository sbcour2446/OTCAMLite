...
/**
 * The <code>IconLayer</code> class manages a collection of
 * {@link gov.nasa.worldwind.render.WWIcon} objects for rendering and picking.
 * <code>IconLayer</code> delegates to its internal
 * {@link gov.nasa.worldwind.render.IconRenderer} for rendering and picking
 * operations.
 *
 * @author tag
...
public class IconLayer extends AbstractLayer {
     ...
     * If this layer's internal collection has been overridden with a call to
     ...
     * of Icons. The view has no definitive order and may contain duplicate
     * entries.
     *
     ...
     *
     * @param regionCulling true if region culling is performed, otherwise
     * false.
     */
     ...
     * #setIcons}, this will returns a reference to that Iterable. If the caller
     * passed <code>setIcons</code> a null parameter, or if
     * <code>setIcons</code> has not been called, this returns a view of this
     * layer's internal collection of Icons, culled to eliminate those outside
     * the current sector geometry.
     *
     ...
     *
     * @param iconIterable Iterable to use instead of this layer's internal
     * collection, or null to use this layer's internal collection.
     */
     ...
     * <code>IconRenderer</code>.
     *
     * @param pedestal <code>Pedestal</code> to be used by this layers internal
     * <code>IconRenderer</code>.
     */
     ...
     *
     * @param horizonClippingEnabled <code>true</code> if horizon clipping
     ...
     * performed.
     *
     * @param viewClippingEnabled <code>true</code> if view clipping should be
     ...
     *
     * @param pickFrustumClippingEnabled <code>true</code> if picking clipping
     * should be performed, otherwise <code>false</code>.
     */
     ...
     * <code>false</code> if they're treated as offsets from the terrain.
     */
     ...
     *
     * @param alwaysUseAbsoluteElevation <code>true</code> to treat icon
     * elevations as absolute, <code>false</code> to treat them as offsets from
     * the terrain.
     */
     ...
     * is true.
     *
     * @param allowBatchPicking true if batch picking is allowed, otherwise
     * false.
     */

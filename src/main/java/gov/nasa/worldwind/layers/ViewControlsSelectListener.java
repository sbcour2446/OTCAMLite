 ...
 * @version $Id: ViewControlsSelectListener.java 1876 2014-03-19 17:13:30Z
 * tgaskins $
...
public class ViewControlsSelectListener implements SelectListener {
     ...
     *
     * @param wwd the <code>WorldWindow</code> the specified layer is associated
     * with.
    ...
    /**
     * Set the panning distance factor. Doubling this value will double the
     * panning speed. Negating it will reverse the panning direction. Default
     * value is .6.
     *
    ...
    /**
     * Set the zoom distance factor. Doubling this value will double the zooming
     * speed. Negating it will reverse the zooming direction. Default value is
     * .8.
     *
    ...
    /**
     * Set the heading increment value in decimal degrees. Doubling this value
     * will double the heading change speed. Negating it will reverse the
     * heading change direction. Default value is 1 degree.
     *
    ...
    /**
     * Set the pitch increment value in decimal degrees. Doubling this value
     * will double the pitch change speed. Must be positive. Default value is 1
     * degree.
     *
    ...
    /**
     * Set the field of view increment factor. At each iteration the current
     * field of view will be multiplied or divided by this value. Must be
     * greater then or equal to one. Default value is 1.05.
     *
    ...
    /**
     * Set the vertical exaggeration increment. At each iteration the current
     * vertical exaggeration will be increased or decreased by this amount. Must
     * be greater than or equal to zero. Default value is 0.1.
     *
     ...
     * @param pitch view pitch angle from the surface normal at the center
     * point.
     *

...
/**
 * This layer displays onscreen view controls. Controls are available for pan,
 * zoom, heading, pitch, tilt, field-of-view and vertical exaggeration. Each of
 * the controls can be enabled or disabled independently.
 * <p>
 * An instance of this class depends on an instance of
 * {@link ViewControlsSelectListener} to control it. The select listener must be
 * registered as such via
 * {@link gov.nasa.worldwind.WorldWindow#addSelectListener(gov.nasa.worldwind.event.SelectListener)}.
 * <p>
 * <code>ViewControlsLayer</code> instances are not sharable among
 * <code>WorldWindow</code>s.
 *
...
public class ViewControlsLayer extends RenderableLayer {
     ...
     *
     * @param borderWidth the number of pixels to offset the view controls from
     ...
     * one of {@link AVKey#NORTHEAST}, {@link
     * AVKey#NORTHWEST}, {@link AVKey#SOUTHEAST}, or {@link AVKey#SOUTHWEST}
     * (the default). These indicate the corner of the viewport to place view
     * controls.
     *
     * @param position the desired view controls position, in screen
     * coordinates.
     */
     ...
     * <p>
     * Returns null if the object is not a view control associated with this
     * layer. </p>
     */

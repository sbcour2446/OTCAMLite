...
/**
 * Implements <code>WWObject</code> functionality. Meant to be either subclassed
 * or aggregated by classes implementing <code>WWObject</code>.
 *
 * @author Tom Gaskins
...
public class WWObjectImpl extends AVListImpl implements WWObject {
    ...
    /**
     * The property change listener for <em>this</em> instance. Receives
     * property change notifications that this instance has registered with
     * other property change notifiers.
     *

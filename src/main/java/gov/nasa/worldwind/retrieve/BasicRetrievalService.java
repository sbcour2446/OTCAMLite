...
public final class BasicRetrievalService extends WWObjectImpl
    ...
    private static class RetrievalTask extends FutureTask<Retriever>
         ...
         *
         * @return 0 if task priorities are equal, -1 if priority of this is
         * less than that, 1 otherwise
         *
    ...
    private class RetrievalExecutor extends ThreadPoolExecutor {
         ...
         *
         * @throws IllegalArgumentException if either <code>thread</code> or
         * <code>runnable</code> is null
         */
        ...
        /**
         * @param runnable the <code>Retriever</code> running on the thread
         * @param throwable an exception thrown during retrieval, will be null
     ...
     * cancel the request.
     *
     * @throws IllegalArgumentException if <code>retriever</code> is null or has
     * no name
     */
    ...
    /**
     * @param retriever the retriever to run
     * @param priority the secondary priority of the retriever, or negative if
     * it is to be the primary priority
     *
     * @return a future object that can be used to query the request status of
     * cancel the request.
     *

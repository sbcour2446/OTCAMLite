...
public interface RetrievalService extends WWObject {
     ...
     * {@link javax.net.ssl.SSLHandshakeException} is thrown during resource
     * retrieval.
     *
     * @param listener to listener to invoke, or null if no listener is to be
     * invoked.
     */
     ...
     * {@link javax.net.ssl.SSLHandshakeException}s are thrown during resource
     * retrieval.
     *
     * @return the exception listener, or null if no listener has been
     * specified.
     */

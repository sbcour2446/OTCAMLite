...
public abstract class BulkRetrievalThread extends Thread {
    ...
    /**
     * Construct a thread that attempts to download to a specified
     * {@link FileStore} a retrievable's data for a given {@link Sector} and
     * resolution.
     * <p>
     ...
     *
     * @throws IllegalArgumentException if either the retrievable, sector or
     * file store are null, or the resolution is less than or equal to zero.
     */
...
//        }
    ...
    /**
     * Get a {@link Progress} instance providing information about this task
     * progress.
     *
     * @return a {@link Progress} instance providing information about this task
     * progress.
     */

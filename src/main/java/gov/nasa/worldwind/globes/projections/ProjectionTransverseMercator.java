...
/**
 * Provides a Transverse Mercator ellipsoidal projection using the WGS84
 * ellipsoid. The projection's central meridian may be specified and defaults to
 * the Prime Meridian (0 longitude). By default, the projection computes values
 * for 30 degrees either side of the central meridian. This may be changed via
 * the {@link
 * #setWidth(gov.nasa.worldwind.geom.Angle)} method, but the projection may fail
 * for large widths.
 * <p>
 * The projection limits are modified to reflect the central meridian and the
 * width, however the projection limits are clamped to a minimum of -180 degrees
 * and a maximum of +180 degrees. It's therefore not possible to display a band
 * whose central meridian is plus or minus 180.
 *
 * @author tag
 * @version $Id: ProjectionTransverseMercator.java 2393 2014-10-20 20:21:55Z
 * tgaskins $
 */
public class ProjectionTransverseMercator extends AbstractGeographicProjection {
    ...
    /**
     * Creates a projection whose central meridian is the Prime Meridian and
     * central latitude is 0.
     */
    ...
    /**
     * Creates a projection with a specified central meridian and a central
     * latitude of 0.
     *
    ...
    /**
     * Creates a projection with a specified central meridian and central
     * latitude.
     *
     * @param centralMeridian The projection's central meridian.
     ...
     *
     * @param centralMeridian This projection's central meridian. The default is
     * 0.
     */
     ...
     *
     * @param centralLatitude This projection's central latitude. The default is
     * 0.
     */
    ...
    /**
     * Indicates the region in which positions are mapped. The default is 30
     * degrees either side of this projection's central meridian.
     *
    ...
    /**
     * Specifies the region in which positions are mapped. The default is 30
     * degrees either side of this projection's central meridian.
     *

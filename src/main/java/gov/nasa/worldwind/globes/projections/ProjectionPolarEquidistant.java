 ...
 *
 * @author tag
 * @version $Id: ProjectionPolarEquidistant.java 2277 2014-08-28 21:19:37Z
 * dcollins $
 */
public class ProjectionPolarEquidistant extends AbstractGeographicProjection {
    ...
    /**
     * Creates a projection centered on the specified pole, which can be either
     * {@link AVKey#NORTH} or {@link
     * AVKey#SOUTH}.
     *
     * @param pole The pole to center on, either {@link AVKey#NORTH} or
     * {@link AVKey#SOUTH}.
     *
     ...
     *
     * @return The pole on which this projection is centered, either
     * {@link AVKey#NORTH} or {@link AVKey#SOUTH}.
     */

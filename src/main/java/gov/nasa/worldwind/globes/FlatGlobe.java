...
/**
 * Defines a globe represented as a projection onto a plane. The projection type
 * is modifiable. The default projection is Mercator. New projections may be
 * added by extending this class and overriding {@link
 ...
 * <p>
 * This globe uses a Cartesian coordinate system in the world plane is located
 * at the origin and has UNIT-Z as normal. The Y axis points to the north pole.
 * The Z axis points up. The X axis completes a right-handed coordinate system,
 * and points east. Latitude and longitude zero are at the origin on y and x
 * respectively. Sea level is at z = zero.
 *
...
public class FlatGlobe extends EllipsoidalGlobe implements Globe2D {
     ...
     * projection. Also known as the geographic projection, the equirectangular
     * projection, or the Plate Carree projection.
     */
    public final static String PROJECTION_LAT_LON = "gov.nasa.worldwind.globes.projectionLatLon";
    /**
     * <a href="http://en.wikipedia.org/wiki/Mercator_projection" target="_blank">Mercator</a>
     * projection.
     */
    public final static String PROJECTION_MERCATOR = "gov.nasa.worldwind.globes.projectionMercator";
    /**
     * <a href="http://en.wikipedia.org/wiki/Sinusoidal_projection" target="_blank">Sinusoidal</a>
     * projection.
     */
    ...
    /**
     * Create a new globe. The globe will use the Mercator projection. The
     * projection can be changed using {@link
    ...
    /**
     * Indicates the projection used to project the globe onto a plane. The
    ...
    /**
     * Maps a position to a flat world Cartesian coordinates. The world plane is
     * located at the origin and has UNIT-Z as normal. The Y axis points to the
     * north pole. The Z axis points up. The X axis completes a right-handed
     * coordinate system, and points east. Latitude and longitude zero are at
     * the origin on y and x respectively. Sea level is at z = zero.
     *

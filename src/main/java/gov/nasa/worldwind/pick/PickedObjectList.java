...
public class PickedObjectList extends ArrayList<PickedObject> {
    ...
    /**
     * Returns a list of all picked objects in this list who's onTop flag is set
     * to true. This returns <code>null</code> if this list is empty, or does
     ...
     * list who's onTop flag is set to true. This returns <code>null</code> if
     * this list is empty, or does not contain any picked objects marked as on
     * top.
     *

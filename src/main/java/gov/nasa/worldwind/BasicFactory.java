...
public class BasicFactory implements Factory {
    ...
    /**
     * Static method to create an object from a factory and configuration
     * source.
     *
     * @param factoryKey the key identifying the factory in
     * {@link Configuration}.
     * @param configSource the configuration source. May be any of the types
     * listed for {@link
     *                     #createFromConfigSource(Object, gov.nasa.worldwind.avlist.AVList)}
     *
     * @return a new instance of the requested object.
     *
     * @throws IllegalArgumentException if the factory key is null, or if the
     * configuration source is null or an empty string.
     */
    ...
    /**
     * Static method to create an object from a factory, a configuration source,
     * and an optional configuration parameter list.
     *
     * @param factoryKey the key identifying the factory in
     * {@link Configuration}.
     * @param configSource the configuration source. May be any of the types
     * listed for {@link
     *                     #createFromConfigSource(Object, gov.nasa.worldwind.avlist.AVList)}
     * @param params key-value parameters to override or supplement the
     * information provided in the specified configuration source. May be null.
     *
     * @return a new instance of the requested object.
     *
     * @throws IllegalArgumentException if the factory key is null, or if the
    ...
    /**
     * Creates an object from a general configuration source. The source can be
     * one of the following: <ul> <li>{@link
     * java.net.URL}</li> <li>{@link java.io.File}</li>
     * <li>{@link java.io.InputStream}</li> <li>{@link Element}</li>
     * <li>{@link gov.nasa.worldwind.ogc.OGCCapabilities}</li>
     * <li>{@link gov.nasa.worldwind.ogc.wcs.wcs100.WCS100Capabilities}</li>
     * <li>{@link String} holding a file name, a name of a resource on the
     ...
     *
     * @throws IllegalArgumentException if the configuration source is null or
     * an empty string.
    ...
    /**
     * Create an object such as a layer or elevation model given a local OGC
     * capabilities document containing named layer descriptions.
     *
     * @param capsFileName the path to the capabilities file. The file must be
     * either an absolute path or a relative path available on the classpath.
     * The file contents must be a valid OGC capabilities document.
     * @param params a list of configuration properties. These properties
     * override any specified in the capabilities document. The list should
     * contain the {@link AVKey#LAYER_NAMES} property for services that define
     * layer, indicating which named layers described in the capabilities
     * document to create. If this argumet is null or contains no layers, the
     * first named layer is used.
     *
     * @return the requested object.
     *
     * @throws IllegalArgumentException if the file name is null or empty.
     * @throws IllegalStateException if the capabilites document contains no
     * named layer definitions.
     * @throws WWRuntimeException if an error occurs while opening, reading or
     * parsing the capabilities document. The exception indicating the source of
     * the failure is included as the {@link
    ...
    /**
     * Implemented by subclasses to perform the actual object creation. This
     ...
     * override any specified in the capabilities document. The list should
     * contain the {@link AVKey#LAYER_NAMES} property for services that define
     * layers, indicating which named layers described in the capabilities
     * document to create. If this argumet is null or contains no layers, the
     * first named layer is used.
     *
     * @return the requested object.
     ...
     * @param caps the capabilities document.
     * @param params a list of configuration properties. These properties
     * override any specified in the capabilities document.
     *
     * @return the requested object.
     */

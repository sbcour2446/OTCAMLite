 ...
 * Through the globe it also indirectly includes the elevation model and the
 * surface geometry tessellator. A default model is defined in
...
public class BasicModel extends WWObjectImpl implements Model {
    ...
    /**
     * Create the layer list from the old-style properties list of layer class
     * names.
     *
     ...
     *
     * @deprecated Use {@link #createLayersFromElement(org.w3c.dom.Element)}
     * instead.
     */
    @Deprecated

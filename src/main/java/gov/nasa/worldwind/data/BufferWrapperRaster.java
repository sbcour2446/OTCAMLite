...
public class BufferWrapperRaster extends AbstractDataRaster implements Cacheable, Disposable {
    ...
    /**
     * Returns a two-element array containing this raster's extreme scalar
     * values, ignoring any values marked as missing-data. This returns null if
     * this raster contains no values, or if it contains only values marked as
     * missing-data.
     *
     * @return a two-element array containing this raster's extreme values, or
     * null if none exist. Entry 0 contains the minimum value; entry 1 contains
     * the maximum value.
     */
     ...
     * Called from <code>doGetSubRaster</code> to create the sub-raster instance
     * before populating its contents. This does not place any restrictions on
     * the specified <code>width</code>, <code>height</code>,
     * <code>sector</code> or <code>params</code>.
     * <p>
     * This returns a
     * <code>{@link gov.nasa.worldwind.util.BufferWrapper.ByteBufferWrapper}</code>,
     * a subclass of BufferWrapperRaster backed by a ByteBuffer.
     *
     ...
     *
     * @return a new sub-raster initialized with the specified
     * <code>width</code>, <code>height</code>, <code>sector</code> and
     * <code>params</code>.
     */

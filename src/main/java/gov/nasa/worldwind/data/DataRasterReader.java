...
public interface DataRasterReader extends AVList {
    ...
    /**
     * Indicates whether this reader can read a specified data source. The
     ...
     * @param params parameters required by certain reader implementations. May
     * be null for most readers.
     *
    ...
    /**
     * Reads and returns the DataRaster instances from a data source. The source
     * may be one of the following: The source may be one of the following:
     * <ul>
     * <li>{@link java.io.File}</li>
     * <li>{@link String}</li>
     * <li>{@link java.io.InputStream}</li>
     ...
     * @param params parameters required by certain reader implementations. May
     * be null for most readers. If non-null, the metadata is added to this
     * list, and the list reference is the return value of this method.
     *
     * @return the list of metadata read from the data source. The list is empty
     * if the data source has no metadata.
     *
    ...
    /**
     * Reads and returns the metadata from a data source. The source may be one
     * of the following:
     * <ul>
     * <li>{@link java.io.File}</li>
     * <li>{@link String}</li>
    ...
    /**
     * Indicates whether a data source is imagery. TODO: Identify when
     * parameters must be passed. The source may be one of the following:
     * <ul>
     * <li>{@link java.io.File}</li>
     * <li>{@link String}</li>
     * <li>{@link java.io.InputStream}</li>
    ...
    /**
     * Indicates whether a data source is elevation data. TODO: Identify when
     ...
     * @param source the source to examine.
     * @param params parameters required by certain reader implementations. May
     * be null for most readers. TODO: Identify when parameters must be passed.
     *

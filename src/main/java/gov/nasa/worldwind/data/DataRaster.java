...
public interface DataRaster extends AVList, Disposable {
    ...
    /**
     * Returns a portion of this raster as another raster. Input values are the
     * desired width and height of the return sub-raster, and the sector to copy
     * from this raster to the sub-raster. The returned raster conforms to
     * EPSG:4326 even if this raster does not.
     *
     * @param params a list of parameters that specify the width, height and
     * sector of the region to return. Specify these values using {@link gov.nasa.worldwind.avlist.AVKey#WIDTH}, {@link
     *               gov.nasa.worldwind.avlist.AVKey#HEIGHT} and
     * {@link gov.nasa.worldwind.avlist.AVKey#SECTOR}.
     *
     * @return the requested raster, or null if the raster could not be created.
     *
     * @throws IllegalArgumentException if the specified parameter list is
     * missing the width, height or sector keys or any of those values are
     * invalid.
     */
    DataRaster getSubRaster(AVList params);

    /**
     * Returns a portion of this raster as another raster. The returned raster
     * conforms to EPSG:4326 even if this raster does not.
     *
     ...
     * @return the requested raster, or null if the raster could not be created.
     *
     * @throws IllegalArgumentException if the sector is null or the width,
     * height or sector are invalid.
     */

...
public class TiledElevationProducer extends TiledRasterProducer {
    ...
    /**
     * Overridden to initialize this producer's extreme elevations prior to
     * creating and installing elevation tiles.
     *
    ...
    /**
     * Overridden to compute the extreme elevations prior to installing a tile
     * in the filesystem.
     *
    ...
    /**
     * Returns an ElevationModel configuration document which describes the
     * tiled elevation data produced by this TiledElevationProducer. The
     * document's contents are based on the configuration document for a basic
     * ElevationModel, except this document describes an offline dataset. This
     * returns null if the parameter list is null, or if the configuration
     * document cannot be created for any reason.
     *
     * @param params the parameters which describe an ElevationModel
     * configuration document's contents.
     *

...
/**
 * Implements a {@link gov.nasa.worldwind.data.DataRasterReaderFactory} with a
 * default list of readers. The list includes the following readers:
 * <pre>
 ...
 * </pre>
 * <p>
 * To specify a different factory, set the
 * {@link gov.nasa.worldwind.avlist.AVKey#DATA_RASTER_READER_FACTORY_CLASS_NAME}
 * value in {@link gov.nasa.worldwind.Configuration}, either directly or via the
 * WorldWind configuration file. To add readers to the default set, create a
 * subclass of this class, override {@link #findReaderFor(Object,
 * gov.nasa.worldwind.avlist.AVList)}, and specify the new class to the
 * configuration.
 *
 * @author tag
 * @version $Id: BasicDataRasterReaderFactory.java 1511 2013-07-17 17:34:00Z
 * dcollins $
 */

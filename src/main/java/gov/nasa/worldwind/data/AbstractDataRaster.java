...
//                throw new IllegalArgumentException(message);
    ...
    /**
     * Reads the specified region of interest (ROI) with given extent, width,
     * and height, and type
     *
     * @param params Required parameters are:
     * <p>
     * AVKey.HEIGHT as Integer, specifies a height of the desired ROI
     * AVKey.WIDTH as Integer, specifies a width of the desired ROI AVKey.SECTOR
     * as Sector, specifies an extent of the desired ROI
     * <p>
     ...
     *
     * @return DataRaster (BufferedImageRaster for imagery or
     * ByteBufferDataRaster for elevations)
     */
